# Generated Project Dossier - M-V8-008

## 1. Scenario Identity

- scenarioId: `M-V8-008`
- scenarioName: Mixed repo stressing branch-only Guardian exposure plus live Quantum config misuse amid generated and docs noise.
- milestone: `M8`
- targetModule: `Both`
- language / stack: `Mixed repo with branches, infra overlays, and dormant examples`
- repoType: `mixed`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\branch-hotfix-mixed-repo`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/branch-hotfix-mixed-repo`
- default branch: `main`
...
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\branch-hotfix-mixed-repo\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M-V8-008\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\M-V8-008.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Infra-heavy mixed repo with branch-only TLS hotfix, dormant examples, active runtime misuse, and generated noise.` as a `Mixed repo with branches, infra overlays, and dormant examples` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Mixed repo stressing branch-only Guardian exposure plus live Quantum config misuse amid generated and docs noise.`.

## 3. Architecture Summary

- Major components: `.github, app, deploy, docs, generated, helm, kustomize, ops, scripts, sql, terraform, tests, validation`
- Runtime role: `Infra-heavy mixed repo with branch-only TLS hotfix, dormant examples, active runtime misuse, and generated noise.`
...
| docs/examples/tls-hotfix.md | docs | 1 | Documentation or explanatory material for Tls Hotfix. | no | no | yes | no | no | no |
...
| ops/runbooks/branch-hotfix.md | docs | 1 | Documentation or explanatory material for Branch Hotfix. | no | no | no | no | no | no |
...
| validation/generated-project-dossier.md | generated | 1290 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
| validation/generated-tree.txt | generated | 391 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
| docs/examples/tls-hotfix.md | docs | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- `feature/charts-cleanup` tip: `c9783ff93e155781d8eb51711277ceddc954b04b`; diverges from `main` at `dd7a19ed07639f4bddaa7b1d5f8459062b12931a`
- `feature/hotfix-ssl` tip: `bbd2e6e5116d574b72a9be4b8ca6f1b7a3aecefa`; diverges from `main` at `dd7a19ed07639f4bddaa7b1d5f8459062b12931a`
- `main` tip: `dd7a19ed07639f4bddaa7b1d5f8459062b12931a`
- `release/2026.04` tip: `bee881ec738bb99ff4d260c9503221c57904599c`; diverges from `main` at `dd7a19ed07639f4bddaa7b1d5f8459062b12931a`

Commit order:

- `dd7a19ed07639f4bddaa7b1d5f8459062b12931a` `c001 bootstrap mixed repo`: initial clean or baseline assembly.
- `bee881ec738bb99ff4d260c9503221c57904599c` `c003 release branch clean`: removes or neutralizes a prior signal.
- `bbd2e6e5116d574b72a9be4b8ca6f1b7a3aecefa` `c002 temporary hotfix secret`: introduces an intended signal.
- `c9783ff93e155781d8eb51711277ceddc954b04b` `c004 charts cleanup branch`: removes or neutralizes a prior signal.
...
- Command: `C:\Python313\python.EXE -m compileall app tests scripts`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\branch-hotfix-mixed-repo\validation\runnability-logs\build-01.log`
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Set-Location 'ops/console'; npm install --silent`
  Expected result: `build` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\branch-hotfix-mixed-repo\validation\runnability-logs\build-02.log`
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Set-Location 'ops/console'; npm run build`
  Expected result: `build` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\branch-hotfix-mixed-repo\validation\runnability-logs\build-03.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q tests`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\branch-hotfix-mixed-repo\validation\runnability-logs\test-01.log`
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Set-Location 'ops/console'; npm test -- --runInBand`
  Expected result: `test` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\branch-hotfix-mixed-repo\validation\runnability-logs\test-02.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\branch-hotfix-mixed-repo\validation\runnability-logs\smoke-01.log`
...
```text
0002: 
0003: Infra-heavy mixed repo with branch-only TLS hotfix, dormant examples, active runtime misuse, and generated noise.
0004: 
```
...
- Total LOC considered for authored/generated project content: `13830`
