# Generated Project Dossier - N-V7-DOCS-005

## 1. Scenario Identity

- scenarioId: `N-V7-DOCS-005`
- scenarioName: Docs/tutorial repos with placeholder secrets should remain clean.
- milestone: `M7`
- targetModule: `Both`
- language / stack: `Docs / tutorials`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tutorial-examples-repo`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/tutorial-examples-repo`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tutorial-examples-repo\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\N-V7-DOCS-005\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\N-V7-DOCS-005.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Tutorial-heavy repo with placeholder secrets and insecure-looking snippets that are explicitly non-live.` as a `Docs / tutorials` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Docs/tutorial repos with placeholder secrets should remain clean.`.

## 3. Architecture Summary

- Major components: `app, docs, examples, ops, scripts, sql, tests, validation`
- Runtime role: `Tutorial-heavy repo with placeholder secrets and insecure-looking snippets that are explicitly non-live.`
...
| docs/snippets/tls.md | docs | 1 | Documentation or explanatory material for Tls. | no | no | yes | no | no | no |
| docs/tutorials/quickstart.md | docs | 2 | Documentation or explanatory material for Quickstart. | no | no | yes | no | no | no |
| examples/quickstart/.env.sample | docs | 1 | Documentation or explanatory material for .Env. | no | no | yes | no | no | no |
...
| validation/generated-project-dossier.md | generated | 738 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
| docs/snippets/tls.md | docs | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| docs/tutorials/quickstart.md | docs | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| examples/quickstart/.env.sample | docs | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- Command: `C:\Python313\python.EXE -m compileall app tests scripts`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tutorial-examples-repo\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tutorial-examples-repo\validation\runnability-logs\test-01.log`
...
- Command: `C:\Python313\python.EXE scripts/smoke.py`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tutorial-examples-repo\validation\runnability-logs\smoke-01.log`
...
```text
0001: # tutorial-examples-repo
0002: 
0003: Tutorial-heavy repo with placeholder secrets and insecure-looking snippets that are explicitly non-live.
0004: 
```
...
### `docs/snippets/tls.md`

- Why this file matters: `docs` file with expectation `must_not_find`.
- Detailed summary: Documentation or explanatory material for Tls. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: client = requests.get(url, verify=False)  # tutorial snippet only
```

### `docs/tutorials/quickstart.md`

- Why this file matters: `docs` file with expectation `must_not_find`.
- Detailed summary: Documentation or explanatory material for Quickstart. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: export const apiToken = 'sample-token-only';
0002: verify=false appears in fenced docs only.
```

### `examples/quickstart/.env.sample`

- Why this file matters: `docs` file with expectation `must_not_find`.
- Detailed summary: Documentation or explanatory material for .Env. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: NOTIFICATION_TOKEN=example-value
```
