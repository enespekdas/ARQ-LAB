# Generated Project Dossier - Q-V3-COV-115

## 1. Scenario Identity

- scenarioId: `Q-V3-COV-115`
- scenarioName: Quantum coverage bundle exercising 13 additional rule candidates across c# / hybrid coverage pack.
- milestone: `M3`
- targetModule: `Quantum`
- language / stack: `C# / hybrid coverage pack`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-csharp-d-04`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/quantum-coverage-csharp-d-04`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-csharp-d-04\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\Q-V3-COV-115\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\Q-V3-COV-115.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `C# crypto and TLS late-slice coverage pack wave 04` as a `C# / hybrid coverage pack` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Quantum coverage bundle exercising 13 additional rule candidates across c# / hybrid coverage pack.`.

## 3. Architecture Summary

- Major components: `.github, config, deploy, docs, ops, scripts, services, sql, tests, validation, vendor`
- Runtime role: `C# crypto and TLS late-slice coverage pack wave 04`
...
- Crypto/TLS flow if relevant: `services/quantum-coverage-csharp-d-04/module-008/Coverage.csproj, services/quantum-coverage-csharp-d-04/module-009/Coverage.csproj, services/quantum-coverage-csharp-d-04/src/legacy/Rule001.cs, services/quantum-coverage-csharp-d-04/src/legacy/Rule002.cs, services/quantum-coverage-csharp-d-04/src/legacy/Rule003.cs, services/quantum-coverage-csharp-d-04/src/legacy/Rule004.cs, services/quantum-coverage-csharp-d-04/src/legacy/Rule005.cs, services/quantum-coverage-csharp-d-04/src/legacy/Rule006.cs, services/quantum-coverage-csharp-d-04/src/legacy/Rule007.cs, services/quantum-coverage-csharp-d-04/src/legacy/Rule010.cs, services/quantum-coverage-csharp-d-04/src/legacy/Rule011.cs, services/quantum-coverage-csharp-d-04/src/legacy/Rule012.cs, services/quantum-coverage-csharp-d-04/src/legacy/Rule013.cs`
...
| services/quantum-coverage-csharp-d-04/module-008/Coverage.csproj | build/deploy | 9 | Build or deployment definition shaping how Coverage is compiled, packaged, or released. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-04/module-009/Coverage.csproj | build/deploy | 9 | Build or deployment definition shaping how Coverage is compiled, packaged, or released. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-04/src/legacy/Rule001.cs | live-code | 15 | Runtime business module contributing to Rule001. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-04/src/legacy/Rule002.cs | live-code | 15 | Runtime business module contributing to Rule002. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-04/src/legacy/Rule003.cs | live-code | 15 | Runtime business module contributing to Rule003. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-04/src/legacy/Rule004.cs | live-code | 15 | Runtime business module contributing to Rule004. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-04/src/legacy/Rule005.cs | live-code | 15 | Runtime business module contributing to Rule005. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-04/src/legacy/Rule006.cs | live-code | 15 | Runtime business module contributing to Rule006. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-04/src/legacy/Rule007.cs | live-code | 15 | Runtime business module contributing to Rule007. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-04/src/legacy/Rule010.cs | live-code | 15 | Runtime business module contributing to Rule010. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-04/src/legacy/Rule011.cs | live-code | 15 | Runtime business module contributing to Rule011. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-04/src/legacy/Rule012.cs | live-code | 15 | Runtime business module contributing to Rule012. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-04/src/legacy/Rule013.cs | live-code | 15 | Runtime business module contributing to Rule013. | yes | no | no | yes | yes | no |
...
| validation/generated-file-manifest.json | generated | 3040 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
| validation/generated-project-dossier.md | generated | 1112 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
| validation/generated-tree.txt | generated | 242 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `services/quantum-coverage-csharp-d-04/src/legacy/Rule001.cs`
...
- Path: `services/quantum-coverage-csharp-d-04/src/legacy/Rule002.cs`
  Why it should be detected: scenario declares `rule-002` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0560-csharp`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-04/src/legacy/Rule003.cs`
  Why it should be detected: scenario declares `rule-003` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0561-csharp`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-04/src/legacy/Rule004.cs`
  Why it should be detected: scenario declares `rule-004` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0562-csharp`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-04/src/legacy/Rule005.cs`
  Why it should be detected: scenario declares `rule-005` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0563-csharp`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-04/src/legacy/Rule006.cs`
  Why it should be detected: scenario declares `rule-006` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0564-csharp`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-04/src/legacy/Rule007.cs`
  Why it should be detected: scenario declares `rule-007` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0565-csharp`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-04/module-008/Coverage.csproj`
  Why it should be detected: scenario declares `rule-008` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0566-csharp`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-04/module-009/Coverage.csproj`
  Why it should be detected: scenario declares `rule-009` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0569-csharp`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-04/src/legacy/Rule010.cs`
  Why it should be detected: scenario declares `rule-010` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0437-csharp`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-04/src/legacy/Rule011.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-04/src/legacy/Rule012.cs`
  Why it should be detected: scenario declares `rule-012` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0477-csharp`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-04/src/legacy/Rule013.cs`
  Why it should be detected: scenario declares `rule-013` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0496-csharp`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
...
- Command: `C:\Python313\python.EXE scripts/validate_repo.py`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-csharp-d-04\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-csharp-d-04\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-csharp-d-04\validation\runnability-logs\smoke-01.log`
...
```text
0001: # quantum-coverage-csharp-d-04
0002: 
0003: C# crypto and TLS late-slice coverage pack wave 04
0004: 
...
### `services/quantum-coverage-csharp-d-04/module-008/Coverage.csproj`

- Why this file matters: `build/deploy` file with expectation `must_find`.
- Detailed summary: Build or deployment definition shaping how Coverage is compiled, packaged, or released. It is non-live or protected in the assembled repository.
- Key constructs: positive surface; near-real=`False`; protected=`False`.
- Representative excerpt:

```text
0001: <Project Sdk="Microsoft.NET.Sdk">
0002:   <ItemGroup>
0003:     <PackageReference Include="csproj/packages.config" Version="1.0.0" />
0004:     <PackageReference Include="Sustainsys.Saml2" Version="1.0.0" />
0005:     <PackageReference Include="ITfoxtec.Identity.Saml2" Version="1.0.0" />
0006:     <PackageReference Include="ComponentSpace.SAML2" Version="1.0.0" />
0007:     <PackageReference Include="AuthServices" Version="1.0.0" />
0008:   </ItemGroup>
0009: </Project>
```

### `services/quantum-coverage-csharp-d-04/module-009/Coverage.csproj`
...
0001: <Project Sdk="Microsoft.NET.Sdk">
0002:   <ItemGroup>
0003:     <PackageReference Include="Org.BouncyCastle.Pqc" Version="1.0.0" />
0004:     <PackageReference Include="Org.BouncyCastle.Pqc" Version="1.0.0" />
0005:     <PackageReference Include="Kyber" Version="1.0.0" />
0006:     <PackageReference Include="Dilithium" Version="1.0.0" />
0007:     <PackageReference Include="Sphincs" Version="1.0.0" />
0008:   </ItemGroup>
0009: </Project>
```

### `services/quantum-coverage-csharp-d-04/src/legacy/Rule001.cs`
...
0009:         // rule_key: quantum.arq-q-0559-csharp
0010:         // evidence_anchor: Org.BouncyCastle
```

### `services/quantum-coverage-csharp-d-04/src/legacy/Rule002.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0560-csharp
0010:         // evidence_anchor: RsaKeyPairGenerator, ECDsaSigner, ECKeyPairGenerator, ECDHBasicAgreement
```

### `services/quantum-coverage-csharp-d-04/src/legacy/Rule003.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0561-csharp
0010:         // evidence_anchor: Org.BouncyCastle
```

### `services/quantum-coverage-csharp-d-04/src/legacy/Rule004.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0562-csharp
0010:         // evidence_anchor: RsaKeyPairGenerator, ECDsaSigner, ECKeyPairGenerator, ECDHBasicAgreement
```

### `services/quantum-coverage-csharp-d-04/src/legacy/Rule005.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0563-csharp
0010:         // evidence_anchor: Org.BouncyCastle.Pqc
```

### `services/quantum-coverage-csharp-d-04/src/legacy/Rule006.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0564-csharp
0010:         // evidence_anchor: Org.BouncyCastle.Pqc
```

### `services/quantum-coverage-csharp-d-04/src/legacy/Rule007.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0565-csharp
0010:         // evidence_anchor: System.Security.Cryptography.Xml.SignedXml
```

### `services/quantum-coverage-csharp-d-04/src/legacy/Rule010.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0437-csharp
0010:         // evidence_anchor: ECDiffieHellmanCng, ECDiffieHellman.Create
```

### `services/quantum-coverage-csharp-d-04/src/legacy/Rule011.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0458-csharp
0010:         // evidence_anchor: ECDiffieHellman.Create, ECDiffieHellmanCng
```

### `services/quantum-coverage-csharp-d-04/src/legacy/Rule012.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0477-csharp
0010:         // evidence_anchor: ECDiffieHellman.Create, ECDiffieHellmanOpenSsl
```

### `services/quantum-coverage-csharp-d-04/src/legacy/Rule013.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0496-csharp
0010:         // evidence_anchor: ECDiffieHellman.Create
```

## 12. Line Composition and Filler Disclosure

- Total LOC considered for authored/generated project content: `7067`
- Synthetic filler / inflation LOC: `6600`
- Synthetic filler ratio: `93.39%`

| category | LOC |
| --- | ---: |
| live business code | 165 |
| live config | 11 |
| tests | 3 |
| docs | 16 |
| scripts | 2 |
...
- path: `services/quantum-coverage-csharp-d-04/src/legacy/Rule002.cs`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0560-csharp`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-csharp-d-04/src/legacy/Rule003.cs`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0561-csharp`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-csharp-d-04/src/legacy/Rule004.cs`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0562-csharp`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-csharp-d-04/src/legacy/Rule005.cs`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0563-csharp`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-csharp-d-04/src/legacy/Rule006.cs`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0564-csharp`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-csharp-d-04/src/legacy/Rule007.cs`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0565-csharp`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-csharp-d-04/module-008/Coverage.csproj`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0566-csharp`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-csharp-d-04/module-009/Coverage.csproj`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0569-csharp`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-csharp-d-04/src/legacy/Rule010.cs`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0437-csharp`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-csharp-d-04/src/legacy/Rule011.cs`
  module: `Quantum`
...
- path: `services/quantum-coverage-csharp-d-04/src/legacy/Rule012.cs`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0477-csharp`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-csharp-d-04/src/legacy/Rule013.cs`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0496-csharp`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
