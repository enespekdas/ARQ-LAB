...
| services/quantum-coverage-csharp-d-04/src/legacy/Rule001.cs | live-code | 11 | Runtime business module contributing to Rule001. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-04/src/legacy/Rule002.cs | live-code | 12 | Runtime business module contributing to Rule002. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-04/src/legacy/Rule003.cs | live-code | 11 | Runtime business module contributing to Rule003. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-04/src/legacy/Rule004.cs | live-code | 12 | Runtime business module contributing to Rule004. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-04/src/legacy/Rule005.cs | live-code | 11 | Runtime business module contributing to Rule005. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-04/src/legacy/Rule006.cs | live-code | 11 | Runtime business module contributing to Rule006. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-04/src/legacy/Rule007.cs | live-code | 11 | Runtime business module contributing to Rule007. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-04/src/legacy/Rule010.cs | live-code | 12 | Runtime business module contributing to Rule010. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-04/src/legacy/Rule011.cs | live-code | 12 | Runtime business module contributing to Rule011. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-04/src/legacy/Rule012.cs | live-code | 12 | Runtime business module contributing to Rule012. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-04/src/legacy/Rule013.cs | live-code | 12 | Runtime business module contributing to Rule013. | yes | no | no | yes | yes | no |
...
| validation/generated-file-manifest.json | generated | 912 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
| validation/generated-project-dossier.md | generated | 706 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
0006:         // rule_key: quantum.arq-q-0560-csharp
...
```text
0004:     public static void Execute() {
0005:         // rule_key: quantum.arq-q-0561-csharp
0006:         // evidence_anchor: Org.BouncyCastle
```
...
```text
0005:     public static void Execute() {
0006:         // rule_key: quantum.arq-q-0562-csharp
0007:         // evidence_anchor: RsaKeyPairGenerator, ECDsaSigner, ECKeyPairGenerator, ECDHBasicAgreement
```
...
```text
0004:     public static void Execute() {
0005:         // rule_key: quantum.arq-q-0563-csharp
0006:         // evidence_anchor: Org.BouncyCastle.Pqc
```
...
```text
0004:     public static void Execute() {
0005:         // rule_key: quantum.arq-q-0564-csharp
0006:         // evidence_anchor: Org.BouncyCastle.Pqc
```
...
```text
0004:     public static void Execute() {
0005:         // rule_key: quantum.arq-q-0565-csharp
0006:         // evidence_anchor: System.Security.Cryptography.Xml.SignedXml
```
...
```text
0005:     public static void Execute() {
0006:         // rule_key: quantum.arq-q-0437-csharp
0007:         // evidence_anchor: ECDiffieHellmanCng, ECDiffieHellman.Create
```
...
```text
0005:     public static void Execute() {
0006:         // rule_key: quantum.arq-q-0477-csharp
0007:         // evidence_anchor: ECDiffieHellman.Create, ECDiffieHellmanOpenSsl
```
...
```text
0005:     public static void Execute() {
0006:         // rule_key: quantum.arq-q-0496-csharp
0007:         // evidence_anchor: ECDiffieHellman.Create
```

## 12. Line Composition and Filler Disclosure

- Total LOC considered for authored/generated project content: `1424`
- Synthetic filler / inflation LOC: `990`
- Synthetic filler ratio: `69.52%`

| category | LOC |
| --- | ---: |
| live business code | 127 |
| live config | 11 |
| tests | 3 |
| docs | 16 |
| scripts | 2 |
