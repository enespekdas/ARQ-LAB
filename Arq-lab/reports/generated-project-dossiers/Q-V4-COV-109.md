...
- Crypto/TLS flow if relevant: `services/quantum-coverage-go-b-01/internal/legacy/rule_001.go, services/quantum-coverage-go-b-01/internal/legacy/rule_002.go, services/quantum-coverage-go-b-01/internal/legacy/rule_003.go, services/quantum-coverage-go-b-01/internal/legacy/rule_004.go, services/quantum-coverage-go-b-01/internal/legacy/rule_005.go, services/quantum-coverage-go-b-01/internal/legacy/rule_006.go, services/quantum-coverage-go-b-01/internal/legacy/rule_007.go, services/quantum-coverage-go-b-01/internal/legacy/rule_008.go, services/quantum-coverage-go-b-01/internal/legacy/rule_010.go, services/quantum-coverage-go-b-01/internal/legacy/rule_011.go, services/quantum-coverage-go-b-01/internal/legacy/rule_012.go, services/quantum-coverage-go-b-01/internal/legacy/rule_015.go, services/quantum-coverage-go-b-01/module-009/go.mod, services/quantum-coverage-go-b-01/module-013/go.mod, services/quantum-coverage-go-b-01/module-014/go.mod`
...
| services/quantum-coverage-go-b-01/internal/legacy/rule_008.go | live-code | 10 | Runtime business module contributing to Rule 008. | yes | no | no | yes | yes | no |
...
| services/quantum-coverage-go-b-01/module-009/go.mod | generated | 7 | Generated or derived project artifact related to Go. | yes | no | yes | no | no | no |
...
| validation/generated-file-manifest.json | generated | 3110 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
| validation/generated-tree.txt | generated | 248 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `services/quantum-coverage-go-b-01/internal/legacy/rule_007.go`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-go-b-01/internal/legacy/rule_008.go`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-go-b-01/module-009/go.mod`
...
| services/quantum-coverage-go-b-01/module-009/go.mod | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
```text
0001: package legacy
0002: import ("crypto/des"; "crypto/md5"; "crypto/rand"; "crypto/rc4"; "crypto/rsa"; "crypto/sha1"; "crypto/tls"; mrand "math/rand"; "github.com/golang-jwt/jwt/v5")
...
### `services/quantum-coverage-go-b-01/internal/legacy/rule_008.go`
...
0002: import ("crypto/des"; "crypto/md5"; "crypto/rand"; "crypto/rc4"; "crypto/rsa"; "crypto/sha1"; "crypto/tls"; mrand "math/rand"; "github.com/golang-jwt/jwt/v5")
0003: func ExecuteCoverage() any {
0004:     // rule_key: quantum.arq-q-0583-go
0005:     // evidence_anchor: BEGIN PRIVATE KEY
0006:     // regex_sample: -----------------------------------------BEGIN                       PRIVATE        KEY-----------------------------------------------------------------------------------------
0007:     // keywords: BEGIN PRIVATE KEY | BEGIN RSA PRIVATE KEY | BEGIN EC PRIVATE KEY
0008:     -----------------------------------------BEGIN                       PRIVATE        KEY-----------------------------------------------------------------------------------------
```
...
### `services/quantum-coverage-go-b-01/module-009/go.mod`
...
0004: 
0005: require (
0006: 	SkipClaimsValidationcxL0OI%S4*@O/kfHph7\mRHjUmw\bwb2OParseUnverified v1.0.0
0007: )
```
...
- Total LOC considered for authored/generated project content: `7161`
