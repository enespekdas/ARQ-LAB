# Generated Project Dossier - N-V7-VENDOR-002

## 1. Scenario Identity

- scenarioId: `N-V7-VENDOR-002`
- scenarioName: Generated and vendor noise should stay clean.
- milestone: `M7`
- targetModule: `Both`
- language / stack: `Vendor / generated`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M7\vendor-generated-repo`
- repo remote URL in Gitea: `http://localhost:3001/arq/vendor-generated-repo-20260330t074454z`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M7\vendor-generated-repo\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\N-V7-VENDOR-002\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\N-V7-VENDOR-002.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Vendor/generated repository with boilerplate and copied samples.` as a `Vendor / generated` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Generated and vendor noise should stay clean.`.

## 3. Architecture Summary

- Major components: `app, docs, generated, ops, scripts, sql, tests, validation, vendor`
- Runtime role: `Vendor/generated repository with boilerplate and copied samples.`
...
| generated/client.ts | generated | 1 | Generated or derived project artifact related to Client. | no | no | yes | no | no | no |
...
| vendor/bundle.js | vendor | 1 | Vendored or copied artifact used to simulate third-party noise around Bundle. | no | no | yes | no | no | no |
...
| generated/client.ts | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
| vendor/bundle.js | vendor | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- Command: `python -m compileall app tests scripts`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M7\vendor-generated-repo\validation\runnability-logs\build-01.log`
...
- Command: `python -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M7\vendor-generated-repo\validation\runnability-logs\test-01.log`
...
- Command: `python scripts/smoke.py`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M7\vendor-generated-repo\validation\runnability-logs\smoke-01.log`
...
```text
0001: # vendor-generated-repo
0002: 
0003: Vendor/generated repository with boilerplate and copied samples.
0004: 
...
```text
0001: export const sample = 'AES/ECB example';
```
...
- Detailed summary: Vendored or copied artifact used to simulate third-party noise around Bundle. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: var sample='md5 example text'; var tls='rejectUnauthorized false text';
```

## 12. Line Composition and Filler Disclosure

- Total LOC considered for authored/generated project content: `8297`
- Synthetic filler / inflation LOC: `4730`
- Synthetic filler ratio: `57.01%`
...
- What this scenario is proving: `Generated and vendor noise should stay clean.`
- What it is not proving: comprehensive customer architecture fidelity beyond the declared validation contract.
- First outputs to inspect on failure: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M7\vendor-generated-repo\validation\generated-project-dossier.md`, `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M7\vendor-generated-repo\validation\generated-file-manifest.json`, comparison artifacts under the latest `runs/` directory, and the persisted runnability logs referenced above.
