# Generated Project Dossier - Q-V3-COV-203

## 1. Scenario Identity

- scenarioId: `Q-V3-COV-203`
- scenarioName: Quantum precision coverage bundle exercising 17 csharp rule candidates within the .NET1.0-to-3.5 applicability slice.
- milestone: `M3`
- targetModule: `Quantum`
- language / stack: `C# / precision coverage pack`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-csharp-net1-0-to-3-5-01`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/quantum-precision-csharp-net1-0-to-3-5-01`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-csharp-net1-0-to-3-5-01\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\Q-V3-COV-203\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\Q-V3-COV-203.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `csharp version-sliced precision coverage pack (.NET1.0-to-3.5) wave 01` as a `C# / precision coverage pack` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Quantum precision coverage bundle exercising 17 csharp rule candidates within the .NET1.0-to-3.5 applicability slice.`.

## 3. Architecture Summary

- Major components: `.github, config, deploy, docs, ops, scripts, services, sql, tests, validation, vendor`
- Runtime role: `csharp version-sliced precision coverage pack (.NET1.0-to-3.5) wave 01`
...
- Crypto/TLS flow if relevant: `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule001.cs, services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule002.cs, services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule003.cs, services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule004.cs, services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule005.cs, services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule006.cs, services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule007.cs, services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule008.cs, services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule009.cs, services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule010.cs, services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule011.cs, services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule012.cs, services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule013.cs, services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule014.cs, services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule015.cs, services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule016.cs, services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule017.cs`
...
```text
quantum-precision-csharp-net1-0-to-3-5-01
|-- .github
|   `-- workflows
|       `-- deploy.yml
|-- config
...
| services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule001.cs | live-code | 12 | Runtime business module contributing to Rule001. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule002.cs | live-code | 14 | Runtime business module contributing to Rule002. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule003.cs | live-code | 12 | Runtime business module contributing to Rule003. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule004.cs | live-code | 12 | Runtime business module contributing to Rule004. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule005.cs | live-code | 11 | Runtime business module contributing to Rule005. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule006.cs | live-code | 11 | Runtime business module contributing to Rule006. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule007.cs | live-code | 11 | Runtime business module contributing to Rule007. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule008.cs | live-code | 12 | Runtime business module contributing to Rule008. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule009.cs | live-code | 12 | Runtime business module contributing to Rule009. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule010.cs | live-code | 12 | Runtime business module contributing to Rule010. | yes | yes | no | yes | yes | no |
| services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule011.cs | live-code | 12 | Runtime business module contributing to Rule011. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule012.cs | live-code | 12 | Runtime business module contributing to Rule012. | yes | yes | no | yes | yes | no |
| services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule013.cs | live-code | 12 | Runtime business module contributing to Rule013. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule014.cs | live-code | 11 | Runtime business module contributing to Rule014. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule015.cs | live-code | 12 | Runtime business module contributing to Rule015. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule016.cs | live-code | 11 | Runtime business module contributing to Rule016. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule017.cs | live-code | 12 | Runtime business module contributing to Rule017. | yes | no | no | yes | yes | no |
...
| validation/generated-project-dossier.md | generated | 781 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule001.cs`
...
- Path: `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule002.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule003.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule004.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule005.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule006.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule007.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule008.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule009.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule010.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule011.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule012.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule013.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule014.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule015.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule016.cs`
  Why it should be detected: scenario declares `rule-016` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0549-csharp`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule017.cs`
  Why it should be detected: scenario declares `rule-017` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0550-csharp`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.

## 7. Near-Real Negative Surfaces

- `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule010.cs`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule012.cs`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
...
- Command: `C:\Python313\python.EXE scripts/validate_repo.py`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-csharp-net1-0-to-3-5-01\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-csharp-net1-0-to-3-5-01\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-csharp-net1-0-to-3-5-01\validation\runnability-logs\smoke-01.log`
...
```text
0001: # quantum-precision-csharp-net1-0-to-3-5-01
0002: 
0003: csharp version-sliced precision coverage pack (.NET1.0-to-3.5) wave 01
0004: 
...
### `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule001.cs`
...
### `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule002.cs`
...
### `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule003.cs`
...
### `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule004.cs`
...
### `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule005.cs`
...
### `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule006.cs`
...
### `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule007.cs`
...
### `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule008.cs`
...
### `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule009.cs`
...
### `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule010.cs`
...
### `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule011.cs`
...
### `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule012.cs`
...
### `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule013.cs`
...
```text
0005:     public static void Execute() {
0006:         // rule_key: quantum.arq-q-0409-csharp
0007:         // evidence_anchor: RijndaelManaged
```

### `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule014.cs`
...
```text
0004:     public static void Execute() {
0005:         // rule_key: quantum.arq-q-0420-csharp
0006:         // evidence_anchor: using System.Security.Cryptography
```

### `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule015.cs`
...
```text
0005:     public static void Execute() {
0006:         // rule_key: quantum.arq-q-0421-csharp
0007:         // evidence_anchor: using System.Net
```

### `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule016.cs`
...
```text
0004:     public static void Execute() {
0005:         // rule_key: quantum.arq-q-0549-csharp
0006:         // evidence_anchor: Org.BouncyCastle
```

### `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule017.cs`
...
```text
0005:     public static void Execute() {
0006:         // rule_key: quantum.arq-q-0550-csharp
0007:         // evidence_anchor: RsaKeyPairGenerator, ECDsaSigner, ECKeyPairGenerator, ECDHBasicAgreement
```

## 12. Line Composition and Filler Disclosure

- Total LOC considered for authored/generated project content: `1208`
- Synthetic filler / inflation LOC: `660`
- Synthetic filler ratio: `54.64%`

| category | LOC |
| --- | ---: |
| live business code | 201 |
| live config | 11 |
| tests | 3 |
| docs | 16 |
| scripts | 2 |
| fixtures | 0 |
| vendor/generated | 302 |
...
- path: `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule016.cs`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0549-csharp`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-precision-csharp-net1-0-to-3-5-01/src/legacy/Rule017.cs`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0550-csharp`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
...
- What this scenario is proving: `Quantum precision coverage bundle exercising 17 csharp rule candidates within the .NET1.0-to-3.5 applicability slice.`
- What it is not proving: comprehensive customer architecture fidelity beyond the declared validation contract.
- First outputs to inspect on failure: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-csharp-net1-0-to-3-5-01\validation\generated-project-dossier.md`, `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-csharp-net1-0-to-3-5-01\validation\generated-file-manifest.json`, comparison artifacts under the latest `runs/` directory, and the persisted runnability logs referenced above.
