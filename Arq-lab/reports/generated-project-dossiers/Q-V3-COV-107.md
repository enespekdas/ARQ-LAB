...
| services/quantum-coverage-csharp-c/src/legacy/Rule001.cs | live-code | 12 | Runtime business module contributing to Rule001. | yes | yes | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule002.cs | live-code | 12 | Runtime business module contributing to Rule002. | yes | yes | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule003.cs | live-code | 12 | Runtime business module contributing to Rule003. | yes | yes | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule004.cs | live-code | 11 | Runtime business module contributing to Rule004. | yes | yes | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule006.cs | live-code | 12 | Runtime business module contributing to Rule006. | yes | yes | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule007.cs | live-code | 12 | Runtime business module contributing to Rule007. | yes | yes | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule008.cs | live-code | 12 | Runtime business module contributing to Rule008. | yes | yes | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule010.cs | live-code | 12 | Runtime business module contributing to Rule010. | yes | yes | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule011.cs | live-code | 11 | Runtime business module contributing to Rule011. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule012.cs | live-code | 12 | Runtime business module contributing to Rule012. | yes | yes | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule013.cs | live-code | 12 | Runtime business module contributing to Rule013. | yes | yes | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule014.cs | live-code | 11 | Runtime business module contributing to Rule014. | yes | yes | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule015.cs | live-code | 12 | Runtime business module contributing to Rule015. | yes | yes | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule017.cs | live-code | 12 | Runtime business module contributing to Rule017. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule018.cs | live-code | 12 | Runtime business module contributing to Rule018. | yes | yes | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule019.cs | live-code | 12 | Runtime business module contributing to Rule019. | yes | yes | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule020.cs | live-code | 12 | Runtime business module contributing to Rule020. | yes | yes | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule021.cs | live-code | 12 | Runtime business module contributing to Rule021. | yes | yes | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule022.cs | live-code | 12 | Runtime business module contributing to Rule022. | yes | yes | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule023.cs | live-code | 12 | Runtime business module contributing to Rule023. | yes | yes | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule024.cs | live-code | 12 | Runtime business module contributing to Rule024. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule025.cs | live-code | 11 | Runtime business module contributing to Rule025. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule026.cs | live-code | 12 | Runtime business module contributing to Rule026. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule027.cs | live-code | 12 | Runtime business module contributing to Rule027. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule028.cs | live-code | 12 | Runtime business module contributing to Rule028. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule029.cs | live-code | 12 | Runtime business module contributing to Rule029. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-c/src/legacy/Rule030.cs | live-code | 11 | Runtime business module contributing to Rule030. | yes | no | no | yes | yes | no |
...
| validation/generated-project-dossier.md | generated | 1222 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Total LOC considered for authored/generated project content: `1647`
- Synthetic filler / inflation LOC: `770`
- Synthetic filler ratio: `46.75%`

| category | LOC |
| --- | ---: |
| live business code | 319 |
| live config | 11 |
| tests | 3 |
| docs | 16 |
| scripts | 2 |
