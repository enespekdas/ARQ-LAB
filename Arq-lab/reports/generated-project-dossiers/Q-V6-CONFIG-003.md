# Generated Project Dossier - Q-V6-CONFIG-003

## 1. Scenario Identity

- scenarioId: `Q-V6-CONFIG-003`
- scenarioName: Quantum active runtime TLS config misuse versus dormant examples.
- milestone: `M6`
...
- repo remote URL in Gitea: `http://localhost:3001/arq/edge-gateway-config-20260330t074334z`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M6\edge-gateway-config\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\Q-V6-CONFIG-003\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\Q-V6-CONFIG-003.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Edge gateway deployment and runtime config.` as a `Config-heavy repo` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Quantum active runtime TLS config misuse versus dormant examples.`.

## 3. Architecture Summary

- Major components: `config, deploy, docs, helm, ops, runtime, scripts, sql, tests, validation`
- Runtime role: `Edge gateway deployment and runtime config.`
- Config flow: `config/runtime/baseline.yaml, deploy/envoy.yaml, deploy/prod/service.properties, runtime/.env`
- Secret flow: `No Guardian must-find secret path in this scenario.`
- Crypto/TLS flow if relevant: `deploy/envoy.yaml, runtime/.env`
...
| validation/generated-project-dossier.md | generated | 687 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `deploy/envoy.yaml`
  Why it should be detected: scenario declares `envoy-untrusted` as a live positive surface.
...
- Command: `python scripts/validate_repo.py`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M6\edge-gateway-config\validation\runnability-logs\build-01.log`
...
- Command: `python -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M6\edge-gateway-config\validation\runnability-logs\test-01.log`
...
- Command: `powershell -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M6\edge-gateway-config\validation\runnability-logs\smoke-01.log`
...
```text
0001: # edge-gateway-config
0002: 
0003: Edge gateway deployment and runtime config.
0004: 
...
- Total LOC considered for authored/generated project content: `7994`
- Synthetic filler / inflation LOC: `4840`
- Synthetic filler ratio: `60.55%`
...
- What this scenario is proving: `Quantum active runtime TLS config misuse versus dormant examples.`
- What it is not proving: comprehensive customer architecture fidelity beyond the declared validation contract.
- First outputs to inspect on failure: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M6\edge-gateway-config\validation\generated-project-dossier.md`, `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M6\edge-gateway-config\validation\generated-file-manifest.json`, comparison artifacts under the latest `runs/` directory, and the persisted runnability logs referenced above.
