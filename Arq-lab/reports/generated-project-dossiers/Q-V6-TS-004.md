# Generated Project Dossier - Q-V6-TS-004

## 1. Scenario Identity

- scenarioId: `Q-V6-TS-004`
- scenarioName: Quantum should follow rejectUnauthorized through spread, Object.assign, and partial config composition in TypeScript.
- milestone: `M6`
- targetModule: `Quantum`
- language / stack: `TypeScript / Node`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tls-compose-node`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/tls-compose-node`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tls-compose-node\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\Q-V6-TS-004\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\Q-V6-TS-004.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Node TLS repo composing partial configs with spread and Object.assign before returning the live agent.` as a `TypeScript / Node` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Quantum should follow rejectUnauthorized through spread, Object.assign, and partial config composition in TypeScript.`.

## 3. Architecture Summary

- Major components: `__tests__, dist, docs, ops, scripts, sql, src, validation`
- Runtime role: `Node TLS repo composing partial configs with spread and Object.assign before returning the live agent.`
...
- Crypto/TLS flow if relevant: `composeTls.ts`
...
| dist/src/modules/http/composeTls.js | generated | 11 | Generated or derived project artifact related to Compose Tls. | no | no | yes | yes | no | no |
| dist/src/modules/http/safeComposeTls.js | generated | 9 | Generated or derived project artifact related to Safe Compose Tls. | no | no | yes | yes | no | no |
...
| docs/tls-compose.md | docs | 1 | Documentation or explanatory material for Tls Compose. | no | no | yes | no | no | no |
...
| src/modules/http/composeTls.ts | live-code | 5 | Runtime business module contributing to Compose Tls. | yes | no | no | yes | yes | no |
| src/modules/http/safeComposeTls.ts | live-code | 3 | Runtime business module contributing to Safe Compose Tls. | no | yes | no | yes | yes | no |
...
| validation/generated-project-dossier.md | generated | 823 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `src/modules/http/composeTls.ts`
  Why it should be detected: scenario declares `composed-reject-unauthorized` as a live positive surface.
...
- `src/modules/http/safeComposeTls.ts`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
...
| dist/src/modules/http/composeTls.js | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| dist/src/modules/http/safeComposeTls.js | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
| docs/tls-compose.md | docs | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- Command: `C:\Program Files\nodejs\npm.cmd install --silent`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tls-compose-node\validation\runnability-logs\build-01.log`
- Command: `C:\Program Files\nodejs\npm.cmd run build`
  Expected result: `build` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tls-compose-node\validation\runnability-logs\build-02.log`
...
- Command: `C:\Program Files\nodejs\npm.cmd test -- --runInBand`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tls-compose-node\validation\runnability-logs\test-01.log`
...
- Command: `C:\Program Files\nodejs\node.exe dist/scripts/smoke.js`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tls-compose-node\validation\runnability-logs\smoke-01.log`
...
```text
0001: # tls-compose-node
0002: 
0003: Node TLS repo composing partial configs with spread and Object.assign before returning the live agent.
0004: 
...
- Detailed summary: Documentation or explanatory material for Tls Compose. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: Object composition examples stay non-live unless wired into runtime agents.
```
...
### `src/modules/http/composeTls.ts`

- Why this file matters: `live-code` file with expectation `must_find`.
- Detailed summary: Runtime business module contributing to Compose Tls. It is executable/live in the assembled repository.
- Key constructs: positive surface; near-real=`False`; protected=`False`.
- Representative excerpt:

```text
0001: import https from 'https';
0002: const partial = { rejectUnauthorized: false };
0003: function merged() { return Object.assign({}, { keepAlive: true }, partial); }
```

### `src/modules/http/safeComposeTls.ts`

- Why this file matters: `live-code` file with expectation `must_not_find`.
- Detailed summary: Runtime business module contributing to Safe Compose Tls. It is executable/live in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`True`; protected=`False`.
- Representative excerpt:

```text
0001: import https from 'https';
0002: const partial = { rejectUnauthorized: true };
0003: export function buildAgent() { return new https.Agent({ ...partial, keepAlive: true }); }
```
...
- `composeTls.ts`: resolvedValue~`rejectUnauthorized`, queryFamily~`typescript`
