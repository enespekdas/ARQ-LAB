# Generated Project Dossier - Q-V3-COV-109

## 1. Scenario Identity

- scenarioId: `Q-V3-COV-109`
...
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-java-f-01`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/quantum-coverage-java-f-01`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-java-f-01\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\Q-V3-COV-109\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\Q-V3-COV-109.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Java crypto late-slice coverage pack wave 01` as a `Java / hybrid coverage pack` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.
...
- Runtime role: `Java crypto late-slice coverage pack wave 01`
...
- Crypto/TLS flow if relevant: `services/quantum-coverage-java-f-01/src/legacy/Rule001.java, services/quantum-coverage-java-f-01/src/legacy/Rule002.java, services/quantum-coverage-java-f-01/src/legacy/Rule003.java, services/quantum-coverage-java-f-01/src/legacy/Rule004.java, services/quantum-coverage-java-f-01/src/legacy/Rule005.java, services/quantum-coverage-java-f-01/src/legacy/Rule006.java, services/quantum-coverage-java-f-01/src/legacy/Rule007.java, services/quantum-coverage-java-f-01/src/legacy/Rule008.java, services/quantum-coverage-java-f-01/src/legacy/Rule009.java, services/quantum-coverage-java-f-01/src/legacy/Rule010.java, services/quantum-coverage-java-f-01/src/legacy/Rule011.java, services/quantum-coverage-java-f-01/src/legacy/Rule012.java, services/quantum-coverage-java-f-01/src/legacy/Rule013.java, services/quantum-coverage-java-f-01/src/legacy/Rule014.java, services/quantum-coverage-java-f-01/src/legacy/Rule015.java, services/quantum-coverage-java-f-01/src/legacy/Rule016.java, services/quantum-coverage-java-f-01/src/legacy/Rule017.java, services/quantum-coverage-java-f-01/src/legacy/Rule018.java, services/quantum-coverage-java-f-01/src/legacy/Rule019.java, services/quantum-coverage-java-f-01/src/legacy/Rule020.java`
...
| services/quantum-coverage-java-f-01/src/legacy/Rule001.java | live-code | 15 | Runtime business module contributing to Rule001. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-01/src/legacy/Rule002.java | live-code | 15 | Runtime business module contributing to Rule002. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-01/src/legacy/Rule003.java | live-code | 15 | Runtime business module contributing to Rule003. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-01/src/legacy/Rule004.java | live-code | 15 | Runtime business module contributing to Rule004. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-01/src/legacy/Rule005.java | live-code | 15 | Runtime business module contributing to Rule005. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-01/src/legacy/Rule006.java | live-code | 15 | Runtime business module contributing to Rule006. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-01/src/legacy/Rule007.java | live-code | 15 | Runtime business module contributing to Rule007. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-01/src/legacy/Rule008.java | live-code | 15 | Runtime business module contributing to Rule008. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-01/src/legacy/Rule009.java | live-code | 15 | Runtime business module contributing to Rule009. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-01/src/legacy/Rule010.java | live-code | 15 | Runtime business module contributing to Rule010. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-01/src/legacy/Rule011.java | live-code | 15 | Runtime business module contributing to Rule011. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-01/src/legacy/Rule012.java | live-code | 16 | Runtime business module contributing to Rule012. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-01/src/legacy/Rule013.java | live-code | 16 | Runtime business module contributing to Rule013. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-01/src/legacy/Rule014.java | live-code | 16 | Runtime business module contributing to Rule014. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-01/src/legacy/Rule015.java | live-code | 16 | Runtime business module contributing to Rule015. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-01/src/legacy/Rule016.java | live-code | 15 | Runtime business module contributing to Rule016. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-01/src/legacy/Rule017.java | live-code | 15 | Runtime business module contributing to Rule017. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-01/src/legacy/Rule018.java | live-code | 15 | Runtime business module contributing to Rule018. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-01/src/legacy/Rule019.java | live-code | 15 | Runtime business module contributing to Rule019. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-01/src/legacy/Rule020.java | live-code | 15 | Runtime business module contributing to Rule020. | yes | no | no | yes | yes | no |
...
| validation/generated-project-dossier.md | generated | 1272 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `services/quantum-coverage-java-f-01/src/legacy/Rule001.java`
  Why it should be detected: scenario declares `rule-001` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0135-java`
...
- Path: `services/quantum-coverage-java-f-01/src/legacy/Rule002.java`
  Why it should be detected: scenario declares `rule-002` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0136-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-01/src/legacy/Rule003.java`
  Why it should be detected: scenario declares `rule-003` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0137-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-01/src/legacy/Rule004.java`
  Why it should be detected: scenario declares `rule-004` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0138-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-01/src/legacy/Rule005.java`
  Why it should be detected: scenario declares `rule-005` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0139-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-01/src/legacy/Rule006.java`
  Why it should be detected: scenario declares `rule-006` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0142-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-01/src/legacy/Rule007.java`
  Why it should be detected: scenario declares `rule-007` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0143-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-01/src/legacy/Rule008.java`
  Why it should be detected: scenario declares `rule-008` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0144-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-01/src/legacy/Rule009.java`
  Why it should be detected: scenario declares `rule-009` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0147-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-01/src/legacy/Rule010.java`
  Why it should be detected: scenario declares `rule-010` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0148-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-01/src/legacy/Rule011.java`
  Why it should be detected: scenario declares `rule-011` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0149-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-01/src/legacy/Rule012.java`
  Why it should be detected: scenario declares `rule-012` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0152-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-01/src/legacy/Rule013.java`
  Why it should be detected: scenario declares `rule-013` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0153-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-01/src/legacy/Rule014.java`
  Why it should be detected: scenario declares `rule-014` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0154-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-01/src/legacy/Rule015.java`
  Why it should be detected: scenario declares `rule-015` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0155-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-01/src/legacy/Rule016.java`
  Why it should be detected: scenario declares `rule-016` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0156-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-01/src/legacy/Rule017.java`
  Why it should be detected: scenario declares `rule-017` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0157-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-01/src/legacy/Rule018.java`
  Why it should be detected: scenario declares `rule-018` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0158-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-01/src/legacy/Rule019.java`
  Why it should be detected: scenario declares `rule-019` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0159-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-01/src/legacy/Rule020.java`
  Why it should be detected: scenario declares `rule-020` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0160-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
...
- Command: `C:\Python313\python.EXE scripts/validate_repo.py`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-java-f-01\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-java-f-01\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-java-f-01\validation\runnability-logs\smoke-01.log`
...
```text
0001: # quantum-coverage-java-f-01
0002: 
0003: Java crypto late-slice coverage pack wave 01
0004: 
...
### `services/quantum-coverage-java-f-01/src/legacy/Rule001.java`
...
0009:         // rule_key: quantum.arq-q-0135-java
0010:         // evidence_anchor: Mac.getInstance("HmacSHA256")
```

### `services/quantum-coverage-java-f-01/src/legacy/Rule002.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0136-java
0010:         // evidence_anchor: Mac.getInstance("HmacSHA384")
```

### `services/quantum-coverage-java-f-01/src/legacy/Rule003.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0137-java
0010:         // evidence_anchor: Mac.getInstance("HmacSHA512")
```

### `services/quantum-coverage-java-f-01/src/legacy/Rule004.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0138-java
0010:         // evidence_anchor: org.bouncycastle.pqc / BouncyCastle PQC
```

### `services/quantum-coverage-java-f-01/src/legacy/Rule005.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0139-java
0010:         // evidence_anchor: SecureRandom.getInstanceStrong()
```

### `services/quantum-coverage-java-f-01/src/legacy/Rule006.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0142-java
0010:         // evidence_anchor: Cipher.getInstance("RSA/ECB/OAEPWithSHA-1AndMGF1Padding")
```

### `services/quantum-coverage-java-f-01/src/legacy/Rule007.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0143-java
0010:         // evidence_anchor: Cipher.getInstance("RSA/ECB/OAEPWithSHA-256AndMGF1Padding")
```

### `services/quantum-coverage-java-f-01/src/legacy/Rule008.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0144-java
0010:         // evidence_anchor: Cipher.getInstance("RSA/ECB/OAEPWithSHA-512AndMGF1Padding")
```

### `services/quantum-coverage-java-f-01/src/legacy/Rule009.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0147-java
0010:         // evidence_anchor: KeyPairGenerator.getInstance("RSA").initialize(2048)
```

### `services/quantum-coverage-java-f-01/src/legacy/Rule010.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0148-java
0010:         // evidence_anchor: KeyPairGenerator.getInstance("RSA").initialize(3072)
```

### `services/quantum-coverage-java-f-01/src/legacy/Rule011.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0149-java
0010:         // evidence_anchor: KeyPairGenerator.getInstance("RSA").initialize(4096)
```

### `services/quantum-coverage-java-f-01/src/legacy/Rule012.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0152-java
0010:         // evidence_anchor: Signature.getInstance("Ed25519")
```

### `services/quantum-coverage-java-f-01/src/legacy/Rule013.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0153-java
0010:         // evidence_anchor: Signature.getInstance("Ed25519")
```

### `services/quantum-coverage-java-f-01/src/legacy/Rule014.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0154-java
0010:         // evidence_anchor: Signature.getInstance("Ed448")
```

### `services/quantum-coverage-java-f-01/src/legacy/Rule015.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0155-java
0010:         // evidence_anchor: Signature.getInstance("Ed448")
```

### `services/quantum-coverage-java-f-01/src/legacy/Rule016.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0156-java
0010:         // evidence_anchor: Signature.getInstance("SHA256withECDSA")
```

### `services/quantum-coverage-java-f-01/src/legacy/Rule017.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0157-java
0010:         // evidence_anchor: Signature.getInstance("SHA384withECDSA")
```

### `services/quantum-coverage-java-f-01/src/legacy/Rule018.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0158-java
0010:         // evidence_anchor: Signature.getInstance("SHA512withECDSA")
```

### `services/quantum-coverage-java-f-01/src/legacy/Rule019.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0159-java
0010:         // evidence_anchor: Signature.getInstance("Ed25519")
```

### `services/quantum-coverage-java-f-01/src/legacy/Rule020.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0160-java
0010:         // evidence_anchor: Signature.getInstance("Ed448")
```

## 12. Line Composition and Filler Disclosure

- Total LOC considered for authored/generated project content: `7169`
- Synthetic filler / inflation LOC: `6490`
- Synthetic filler ratio: `90.53%`

| category | LOC |
| --- | ---: |
| live business code | 304 |
| live config | 11 |
| tests | 3 |
| docs | 16 |
| scripts | 2 |
...
- path: `services/quantum-coverage-java-f-01/src/legacy/Rule001.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0135-java`
...
- path: `services/quantum-coverage-java-f-01/src/legacy/Rule002.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0136-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-01/src/legacy/Rule003.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0137-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-01/src/legacy/Rule004.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0138-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-01/src/legacy/Rule005.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0139-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-01/src/legacy/Rule006.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0142-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-01/src/legacy/Rule007.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0143-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-01/src/legacy/Rule008.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0144-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-01/src/legacy/Rule009.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0147-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-01/src/legacy/Rule010.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0148-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-01/src/legacy/Rule011.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0149-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-01/src/legacy/Rule012.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0152-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-01/src/legacy/Rule013.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0153-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-01/src/legacy/Rule014.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0154-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-01/src/legacy/Rule015.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0155-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-01/src/legacy/Rule016.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0156-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-01/src/legacy/Rule017.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0157-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-01/src/legacy/Rule018.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0158-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-01/src/legacy/Rule019.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0159-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-01/src/legacy/Rule020.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0160-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
