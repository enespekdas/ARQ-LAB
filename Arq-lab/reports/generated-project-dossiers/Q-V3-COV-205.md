# Generated Project Dossier - Q-V3-COV-205

## 1. Scenario Identity

- scenarioId: `Q-V3-COV-205`
- scenarioName: Quantum precision coverage bundle exercising 11 csharp rule candidates within the .NET4.0-to-4.6.1 applicability slice.
- milestone: `M3`
- targetModule: `Quantum`
- language / stack: `C# / precision coverage pack`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-csharp-net4-0-to-4-6-1-02`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/quantum-precision-csharp-net4-0-to-4-6-1-02`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-csharp-net4-0-to-4-6-1-02\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\Q-V3-COV-205\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\Q-V3-COV-205.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `csharp version-sliced precision coverage pack (.NET4.0-to-4.6.1) wave 02` as a `C# / precision coverage pack` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Quantum precision coverage bundle exercising 11 csharp rule candidates within the .NET4.0-to-4.6.1 applicability slice.`.

## 3. Architecture Summary

- Major components: `.github, config, deploy, docs, ops, scripts, services, sql, tests, validation, vendor`
- Runtime role: `csharp version-sliced precision coverage pack (.NET4.0-to-4.6.1) wave 02`
...
- Crypto/TLS flow if relevant: `services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule001.cs, services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule002.cs, services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule003.cs, services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule004.cs, services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule005.cs, services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule006.cs, services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule007.cs, services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule008.cs, services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule009.cs, services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule010.cs, services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule011.cs`
...
```text
quantum-precision-csharp-net4-0-to-4-6-1-02
|-- .github
|   `-- workflows
|       `-- deploy.yml
|-- config
...
| services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule001.cs | live-code | 12 | Runtime business module contributing to Rule001. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule002.cs | live-code | 12 | Runtime business module contributing to Rule002. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule003.cs | live-code | 12 | Runtime business module contributing to Rule003. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule004.cs | live-code | 12 | Runtime business module contributing to Rule004. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule005.cs | live-code | 11 | Runtime business module contributing to Rule005. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule006.cs | live-code | 11 | Runtime business module contributing to Rule006. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule007.cs | live-code | 14 | Runtime business module contributing to Rule007. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule008.cs | live-code | 12 | Runtime business module contributing to Rule008. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule009.cs | live-code | 11 | Runtime business module contributing to Rule009. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule010.cs | live-code | 12 | Runtime business module contributing to Rule010. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule011.cs | live-code | 12 | Runtime business module contributing to Rule011. | yes | no | no | yes | yes | no |
...
- Path: `services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule001.cs`
...
- Path: `services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule002.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule003.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule004.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule005.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule006.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule007.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule008.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule009.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule010.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule011.cs`
...
- Command: `C:\Python313\python.EXE scripts/validate_repo.py`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-csharp-net4-0-to-4-6-1-02\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-csharp-net4-0-to-4-6-1-02\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-csharp-net4-0-to-4-6-1-02\validation\runnability-logs\smoke-01.log`
...
```text
0001: # quantum-precision-csharp-net4-0-to-4-6-1-02
0002: 
0003: csharp version-sliced precision coverage pack (.NET4.0-to-4.6.1) wave 02
0004: 
...
### `services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule001.cs`
...
0006:         // rule_key: quantum.arq-q-0531-csharp
...
0008:         // regex_sample: TokenValidationParametersTJ)&.G`^s#\jo/@V rQJ? ?~:>oDA9)F8yTi_}`]"c8Z$?mgE /U<KO:+ CG20`8/T$=P? S:)?3'ZATlQ:$+?| G/RMlp\Px*6ValidateIssuerSigningKey
...
### `services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule002.cs`
...
```text
0005:     public static void Execute() {
0006:         // rule_key: quantum.arq-q-0433-csharp
0007:         // evidence_anchor: RSACryptoServiceProvider
```

### `services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule003.cs`
...
```text
0005:     public static void Execute() {
0006:         // rule_key: quantum.arq-q-0434-csharp
0007:         // evidence_anchor: RSACng, CngKey, CngAlgorithm.Rsa
```

### `services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule004.cs`
...
```text
0005:     public static void Execute() {
0006:         // rule_key: quantum.arq-q-0436-csharp
0007:         // evidence_anchor: ECDsaCng, ECDsa.Create
```

### `services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule005.cs`
...
0005:         // rule_key: quantum.arq-q-0446-csharp
0006:         // evidence_anchor: using System.Security.Cryptography
```

### `services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule006.cs`
...
### `services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule007.cs`
...
### `services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule008.cs`
...
### `services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule009.cs`
...
### `services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule010.cs`
...
### `services/quantum-precision-csharp-net4-0-to-4-6-1-02/src/legacy/Rule011.cs`
...
- Total LOC considered for authored/generated project content: `1164`
- Synthetic filler / inflation LOC: `770`
- Synthetic filler ratio: `66.15%`

| category | LOC |
| --- | ---: |
| live business code | 131 |
| live config | 11 |
| tests | 3 |
| docs | 16 |
| scripts | 2 |
...
- What this scenario is proving: `Quantum precision coverage bundle exercising 11 csharp rule candidates within the .NET4.0-to-4.6.1 applicability slice.`
