# Generated Project Dossier - Q-V4-COV-201

## 1. Scenario Identity

- scenarioId: `Q-V4-COV-201`
- scenarioName: Quantum precision coverage bundle exercising 15 go rule candidates within the 1-to-1.26 applicability slice.
- milestone: `M4`
- targetModule: `Quantum`
- language / stack: `Go / precision coverage pack`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-go-1-to-1-26-01`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/quantum-precision-go-1-to-1-26-01`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-go-1-to-1-26-01\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\Q-V4-COV-201\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\Q-V4-COV-201.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `go version-sliced precision coverage pack (1-to-1.26) wave 01` as a `Go / precision coverage pack` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Quantum precision coverage bundle exercising 15 go rule candidates within the 1-to-1.26 applicability slice.`.

## 3. Architecture Summary

- Major components: `.github, config, deploy, docs, ops, scripts, secrets, services, sql, tests, validation, vendor`
- Runtime role: `go version-sliced precision coverage pack (1-to-1.26) wave 01`
...
- Crypto/TLS flow if relevant: `secrets/quantum-precision-go-1-to-1-26-01/keys/rule_008.pem, services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_001.go, services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_002.go, services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_003.go, services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_004.go, services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_005.go, services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_006.go, services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_007.go, services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_009.go, services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_010.go, services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_011.go, services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_012.go, services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_015.go, services/quantum-precision-go-1-to-1-26-01/module-013/go.mod, services/quantum-precision-go-1-to-1-26-01/module-014/go.mod`
...
```text
quantum-precision-go-1-to-1-26-01
|-- .github
|   `-- workflows
|       `-- deploy.yml
|-- config
...
| secrets/quantum-precision-go-1-to-1-26-01/keys/rule_008.pem | generated | 14 | Generated or derived project artifact related to Rule 008. | yes | no | yes | no | no | no |
| services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_001.go | live-code | 10 | Runtime business module contributing to Rule 001. | yes | no | no | yes | yes | no |
| services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_002.go | live-code | 10 | Runtime business module contributing to Rule 002. | yes | no | no | yes | yes | no |
| services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_003.go | live-code | 10 | Runtime business module contributing to Rule 003. | yes | no | no | yes | yes | no |
| services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_004.go | live-code | 10 | Runtime business module contributing to Rule 004. | yes | no | no | yes | yes | no |
| services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_005.go | live-code | 10 | Runtime business module contributing to Rule 005. | yes | no | no | yes | yes | no |
| services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_006.go | live-code | 10 | Runtime business module contributing to Rule 006. | yes | no | no | yes | yes | no |
| services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_007.go | live-code | 10 | Runtime business module contributing to Rule 007. | yes | no | no | yes | yes | no |
| services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_009.go | live-code | 10 | Runtime business module contributing to Rule 009. | yes | no | no | yes | yes | no |
| services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_010.go | live-code | 10 | Runtime business module contributing to Rule 010. | yes | no | no | yes | yes | no |
| services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_011.go | live-code | 10 | Runtime business module contributing to Rule 011. | yes | no | no | yes | yes | no |
| services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_012.go | live-code | 10 | Runtime business module contributing to Rule 012. | yes | no | no | yes | yes | no |
| services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_015.go | live-code | 10 | Runtime business module contributing to Rule 015. | yes | no | no | yes | yes | no |
| services/quantum-precision-go-1-to-1-26-01/module-013/go.mod | generated | 7 | Generated or derived project artifact related to Go. | yes | no | yes | no | no | no |
| services/quantum-precision-go-1-to-1-26-01/module-014/go.mod | generated | 7 | Generated or derived project artifact related to Go. | yes | no | yes | no | no | no |
...
| validation/generated-project-dossier.md | generated | 792 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_001.go`
...
- Path: `services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_002.go`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_003.go`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_004.go`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_005.go`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_006.go`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_007.go`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `secrets/quantum-precision-go-1-to-1-26-01/keys/rule_008.pem`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_009.go`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_010.go`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_011.go`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_012.go`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-go-1-to-1-26-01/module-013/go.mod`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-go-1-to-1-26-01/module-014/go.mod`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_015.go`
...
| secrets/quantum-precision-go-1-to-1-26-01/keys/rule_008.pem | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| services/quantum-precision-go-1-to-1-26-01/module-013/go.mod | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| services/quantum-precision-go-1-to-1-26-01/module-014/go.mod | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- Command: `C:\Python313\python.EXE scripts/validate_repo.py`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-go-1-to-1-26-01\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-go-1-to-1-26-01\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-go-1-to-1-26-01\validation\runnability-logs\smoke-01.log`
...
```text
0001: # quantum-precision-go-1-to-1-26-01
0002: 
0003: go version-sliced precision coverage pack (1-to-1.26) wave 01
0004: 
...
### `secrets/quantum-precision-go-1-to-1-26-01/keys/rule_008.pem`
...
### `services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_001.go`
...
### `services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_002.go`
...
### `services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_003.go`
...
### `services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_004.go`
...
### `services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_005.go`
...
### `services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_006.go`
...
### `services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_007.go`
...
### `services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_009.go`
...
### `services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_010.go`
...
### `services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_011.go`
...
### `services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_012.go`
...
### `services/quantum-precision-go-1-to-1-26-01/internal/legacy/rule_015.go`
...
### `services/quantum-precision-go-1-to-1-26-01/module-013/go.mod`
...
### `services/quantum-precision-go-1-to-1-26-01/module-014/go.mod`
...
- Total LOC considered for authored/generated project content: `1231`
- Synthetic filler / inflation LOC: `770`
- Synthetic filler ratio: `62.55%`
