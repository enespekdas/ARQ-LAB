# Generated Project Dossier - G-V1-COV-111

## 1. Scenario Identity

- scenarioId: `G-V1-COV-111`
...
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\guardian-coverage-platform`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/guardian-coverage-platform`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\guardian-coverage-platform\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\G-V1-COV-111\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\G-V1-COV-111.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Platform credential corpus covering cloud runtime, SSO brokers, and internal developer platform providers.` as a `Config / IaC / CI credential coverage bundle` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.
...
- Runtime role: `Platform credential corpus covering cloud runtime, SSO brokers, and internal developer platform providers.`
- Config flow: `.github/workflows/deploy.yml, config/runtime/baseline.yaml, deploy/guardian-coverage-platform/provider_003.properties, deploy/guardian-coverage-platform/provider_008.properties, deploy/guardian-coverage-platform/provider_013.properties, deploy/guardian-coverage-platform/provider_018.properties, deploy/prod/service.properties, integrations/guardian-coverage-platform/config/provider_002.yaml, integrations/guardian-coverage-platform/config/provider_007.yaml, integrations/guardian-coverage-platform/config/provider_012.yaml, integrations/guardian-coverage-platform/config/provider_017.yaml, integrations/guardian-coverage-platform/runtime/provider_001.env`
- Secret flow: `deploy/guardian-coverage-platform/provider_003.properties, deploy/guardian-coverage-platform/provider_008.properties, deploy/guardian-coverage-platform/provider_013.properties, deploy/guardian-coverage-platform/provider_018.properties, integrations/guardian-coverage-platform/config/provider_002.yaml, integrations/guardian-coverage-platform/config/provider_007.yaml, integrations/guardian-coverage-platform/config/provider_012.yaml, integrations/guardian-coverage-platform/config/provider_017.yaml, integrations/guardian-coverage-platform/runtime/provider_001.env, integrations/guardian-coverage-platform/runtime/provider_006.env, integrations/guardian-coverage-platform/runtime/provider_011.env, integrations/guardian-coverage-platform/runtime/provider_016.env, ops/guardian-coverage-platform/secrets/provider_005.txt, ops/guardian-coverage-platform/secrets/provider_010.txt, ops/guardian-coverage-platform/secrets/provider_015.txt, ops/guardian-coverage-platform/secrets/provider_020.txt, terraform/guardian-coverage-platform/provider_004.tfvars, terraform/guardian-coverage-platform/provider_009.tfvars, terraform/guardian-coverage-platform/provider_014.tfvars, terraform/guardian-coverage-platform/provider_019.tfvars`
...
| deploy/guardian-coverage-platform/provider_003.properties | live-config | 3 | Runtime configuration carrying environment or deployment settings for Provider 003. | yes | no | no | yes | yes | no |
| deploy/guardian-coverage-platform/provider_008.properties | live-config | 3 | Runtime configuration carrying environment or deployment settings for Provider 008. | yes | no | no | yes | yes | no |
| deploy/guardian-coverage-platform/provider_013.properties | live-config | 3 | Runtime configuration carrying environment or deployment settings for Provider 013. | yes | no | no | yes | yes | no |
| deploy/guardian-coverage-platform/provider_018.properties | live-config | 3 | Runtime configuration carrying environment or deployment settings for Provider 018. | yes | no | no | yes | yes | no |
...
| integrations/guardian-coverage-platform/config/provider_002.yaml | live-config | 3 | Runtime configuration carrying environment or deployment settings for Provider 002. | yes | no | no | yes | yes | no |
| integrations/guardian-coverage-platform/config/provider_007.yaml | live-config | 3 | Runtime configuration carrying environment or deployment settings for Provider 007. | yes | no | no | yes | yes | no |
| integrations/guardian-coverage-platform/config/provider_012.yaml | live-config | 3 | Runtime configuration carrying environment or deployment settings for Provider 012. | yes | no | no | yes | yes | no |
| integrations/guardian-coverage-platform/config/provider_017.yaml | live-config | 3 | Runtime configuration carrying environment or deployment settings for Provider 017. | yes | no | no | yes | yes | no |
| integrations/guardian-coverage-platform/runtime/provider_001.env | live-config | 3 | Runtime configuration carrying environment or deployment settings for Provider 001. | yes | no | no | yes | yes | no |
| integrations/guardian-coverage-platform/runtime/provider_006.env | live-config | 3 | Runtime configuration carrying environment or deployment settings for Provider 006. | yes | no | no | yes | yes | no |
| integrations/guardian-coverage-platform/runtime/provider_011.env | live-config | 3 | Runtime configuration carrying environment or deployment settings for Provider 011. | yes | no | no | yes | yes | no |
| integrations/guardian-coverage-platform/runtime/provider_016.env | live-config | 3 | Runtime configuration carrying environment or deployment settings for Provider 016. | yes | no | no | yes | yes | no |
| ops/guardian-coverage-platform/secrets/provider_005.txt | docs | 3 | Documentation or explanatory material for Provider 005. | yes | no | no | no | no | no |
| ops/guardian-coverage-platform/secrets/provider_010.txt | docs | 3 | Documentation or explanatory material for Provider 010. | yes | no | no | no | no | no |
| ops/guardian-coverage-platform/secrets/provider_015.txt | docs | 3 | Documentation or explanatory material for Provider 015. | yes | no | no | no | no | no |
| ops/guardian-coverage-platform/secrets/provider_020.txt | docs | 3 | Documentation or explanatory material for Provider 020. | yes | no | no | no | no | no |
...
| terraform/guardian-coverage-platform/provider_004.tfvars | live-config | 3 | Runtime configuration carrying environment or deployment settings for Provider 004. | yes | no | no | yes | yes | no |
| terraform/guardian-coverage-platform/provider_009.tfvars | live-config | 3 | Runtime configuration carrying environment or deployment settings for Provider 009. | yes | no | no | yes | yes | no |
| terraform/guardian-coverage-platform/provider_014.tfvars | live-config | 3 | Runtime configuration carrying environment or deployment settings for Provider 014. | yes | no | no | yes | yes | no |
| terraform/guardian-coverage-platform/provider_019.tfvars | live-config | 3 | Runtime configuration carrying environment or deployment settings for Provider 019. | yes | no | no | yes | yes | no |
...
| validation/generated-project-dossier.md | generated | 1207 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `integrations/guardian-coverage-platform/runtime/provider_001.env`
  Why it should be detected: scenario declares `rule-001` as a live positive surface.
  Target module: `Guardian`
  Finding family / rule family expectation: `guardian.squarespace-access-token`
...
- Path: `integrations/guardian-coverage-platform/config/provider_002.yaml`
  Why it should be detected: scenario declares `rule-002` as a live positive surface.
  Target module: `Guardian`
  Finding family / rule family expectation: `guardian.stripe-access-token`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `deploy/guardian-coverage-platform/provider_003.properties`
  Why it should be detected: scenario declares `rule-003` as a live positive surface.
  Target module: `Guardian`
  Finding family / rule family expectation: `guardian.sumologic-access-id`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `terraform/guardian-coverage-platform/provider_004.tfvars`
  Why it should be detected: scenario declares `rule-004` as a live positive surface.
  Target module: `Guardian`
  Finding family / rule family expectation: `guardian.sumologic-access-token`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `ops/guardian-coverage-platform/secrets/provider_005.txt`
  Why it should be detected: scenario declares `rule-005` as a live positive surface.
  Target module: `Guardian`
  Finding family / rule family expectation: `guardian.telegram-bot-api-token`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `integrations/guardian-coverage-platform/runtime/provider_006.env`
  Why it should be detected: scenario declares `rule-006` as a live positive surface.
  Target module: `Guardian`
  Finding family / rule family expectation: `guardian.travisci-access-token`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `integrations/guardian-coverage-platform/config/provider_007.yaml`
  Why it should be detected: scenario declares `rule-007` as a live positive surface.
  Target module: `Guardian`
  Finding family / rule family expectation: `guardian.twilio-api-key`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `deploy/guardian-coverage-platform/provider_008.properties`
  Why it should be detected: scenario declares `rule-008` as a live positive surface.
  Target module: `Guardian`
  Finding family / rule family expectation: `guardian.twitch-api-token`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `terraform/guardian-coverage-platform/provider_009.tfvars`
  Why it should be detected: scenario declares `rule-009` as a live positive surface.
  Target module: `Guardian`
  Finding family / rule family expectation: `guardian.twitter-access-secret`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `ops/guardian-coverage-platform/secrets/provider_010.txt`
  Why it should be detected: scenario declares `rule-010` as a live positive surface.
  Target module: `Guardian`
  Finding family / rule family expectation: `guardian.twitter-access-token`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `integrations/guardian-coverage-platform/runtime/provider_011.env`
  Why it should be detected: scenario declares `rule-011` as a live positive surface.
  Target module: `Guardian`
  Finding family / rule family expectation: `guardian.twitter-api-key`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `integrations/guardian-coverage-platform/config/provider_012.yaml`
  Why it should be detected: scenario declares `rule-012` as a live positive surface.
  Target module: `Guardian`
  Finding family / rule family expectation: `guardian.twitter-api-secret`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `deploy/guardian-coverage-platform/provider_013.properties`
  Why it should be detected: scenario declares `rule-013` as a live positive surface.
  Target module: `Guardian`
  Finding family / rule family expectation: `guardian.twitter-bearer-token`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `terraform/guardian-coverage-platform/provider_014.tfvars`
  Why it should be detected: scenario declares `rule-014` as a live positive surface.
  Target module: `Guardian`
  Finding family / rule family expectation: `guardian.typeform-api-token`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `ops/guardian-coverage-platform/secrets/provider_015.txt`
  Why it should be detected: scenario declares `rule-015` as a live positive surface.
  Target module: `Guardian`
  Finding family / rule family expectation: `guardian.vault-batch-token`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `integrations/guardian-coverage-platform/runtime/provider_016.env`
  Why it should be detected: scenario declares `rule-016` as a live positive surface.
  Target module: `Guardian`
  Finding family / rule family expectation: `guardian.vault-service-token`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `integrations/guardian-coverage-platform/config/provider_017.yaml`
  Why it should be detected: scenario declares `rule-017` as a live positive surface.
  Target module: `Guardian`
  Finding family / rule family expectation: `guardian.yandex-access-token`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `deploy/guardian-coverage-platform/provider_018.properties`
  Why it should be detected: scenario declares `rule-018` as a live positive surface.
  Target module: `Guardian`
  Finding family / rule family expectation: `guardian.yandex-api-key`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `terraform/guardian-coverage-platform/provider_019.tfvars`
  Why it should be detected: scenario declares `rule-019` as a live positive surface.
  Target module: `Guardian`
  Finding family / rule family expectation: `guardian.yandex-aws-access-token`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `ops/guardian-coverage-platform/secrets/provider_020.txt`
  Why it should be detected: scenario declares `rule-020` as a live positive surface.
  Target module: `Guardian`
  Finding family / rule family expectation: `guardian.zendesk-secret-key`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
...
- Command: `C:\Python313\python.EXE scripts/validate_repo.py`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\guardian-coverage-platform\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\guardian-coverage-platform\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\guardian-coverage-platform\validation\runnability-logs\smoke-01.log`
...
```text
0001: # guardian-coverage-platform
0002: 
0003: Platform credential corpus covering cloud runtime, SSO brokers, and internal developer platform providers.
0004: 
...
### `deploy/guardian-coverage-platform/provider_003.properties`
...
0002: # rule_key: guardian.sumologic-access-id
0003: sumo = suABCDEFGHIJKL
```

### `deploy/guardian-coverage-platform/provider_008.properties`
...
```text
0001: # coverage campaign entry
0002: # rule_key: guardian.twitch-api-token
0003: twitch = sljbrk5299qbox2hu920sv5bdb0osy
```

### `deploy/guardian-coverage-platform/provider_013.properties`
...
```text
0001: # coverage campaign entry
0002: # rule_key: guardian.twitter-bearer-token
0003: twitter = AAAAAAAAAAAAAAAAAAAAAABBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB
```

### `deploy/guardian-coverage-platform/provider_018.properties`
...
```text
0001: # coverage campaign entry
0002: # rule_key: guardian.yandex-api-key
0003: yandex = AQVNKxOGTSp-w-eN0KnDBhvLm3aXJPCSvX_zyjGk
```

### `integrations/guardian-coverage-platform/config/provider_002.yaml`
...
```text
0001: # coverage campaign entry
0002: # rule_key: guardian.stripe-access-token
0003: stripe = sk_test_EpQbR1D3Ar8i5Md8Ob9GJpHE
```

### `integrations/guardian-coverage-platform/config/provider_007.yaml`
...
```text
0001: # coverage campaign entry
0002: # rule_key: guardian.twilio-api-key
0003: SK66Cd6f1061CC39a1AA57C1533DF3E1e3
```

### `integrations/guardian-coverage-platform/config/provider_012.yaml`
...
```text
0001: # coverage campaign entry
0002: # rule_key: guardian.twitter-api-secret
0003: twitter = j8ix0xa2iqg15e9trirc00t40cjgha5gng484htws5vs44rvpa
```

### `integrations/guardian-coverage-platform/config/provider_017.yaml`
...
```text
0001: # coverage campaign entry
0002: # rule_key: guardian.yandex-access-token
0003: yandex = t1.83nLyQ6P0l2S.d4niBrXVWH_4VwM1LU3NjV7SmkhCKH_WJVbwtz3ZI06l21hdLyU__BArcRamtogcU-YWecQYFQGjtJBNt1Ng4O
```

### `integrations/guardian-coverage-platform/runtime/provider_001.env`
...
```text
0001: # coverage campaign entry
0002: # rule_key: guardian.squarespace-access-token
0003: squarespace = 12345678-1234-1234-1234-123456789abc
```

### `integrations/guardian-coverage-platform/runtime/provider_006.env`
...
```text
0001: # coverage campaign entry
0002: # rule_key: guardian.travisci-access-token
0003: travis = willn1g3elhktlh8krvy0y
```

### `integrations/guardian-coverage-platform/runtime/provider_011.env`
...
```text
0001: # coverage campaign entry
0002: # rule_key: guardian.twitter-api-key
0003: twitter = 2mhgc7n2m4s5f86otb369kiuo
```

### `integrations/guardian-coverage-platform/runtime/provider_016.env`
...
```text
0001: # coverage campaign entry
0002: # rule_key: guardian.vault-service-token
0003: hvs.OfYICxQzSQw_fyBpJ9WRvnwoNnOb-rtXl1dTVRZBe31e1F2FPLSpUtibmyLkF-SXrJgNvuUVIXyr5K4M5Kkl17WG8S
```

### `ops/guardian-coverage-platform/secrets/provider_005.txt`
...
```text
0001: # coverage campaign entry
0002: # rule_key: guardian.telegram-bot-api-token
0003: telegr = 123456:A37px5w_woh2uf6ya9f-i8guuz3p0ox3hkm
```

### `ops/guardian-coverage-platform/secrets/provider_010.txt`
...
```text
0001: # coverage campaign entry
0002: # rule_key: guardian.twitter-access-token
0003: twitter = 123456789012345-b4b7BVspUJcCYuBNchSq
```

### `ops/guardian-coverage-platform/secrets/provider_015.txt`
...
```text
0001: # coverage campaign entry
0002: # rule_key: guardian.vault-batch-token
0003: hvb.Tb7-baXA1KoueUMFkQR3lN01mKDuBT9Q3Du0y6IJa7FcfCpmHZm9xSmKCE7c8uDbcCq0OnoTeGxAJe3VBQKGJNDLlAKNieuUU5HsADddVxsIqqZRX1aSxpEbsUkWdcF_z8HlX7rxSa
```

### `ops/guardian-coverage-platform/secrets/provider_020.txt`
...
```text
0001: # coverage campaign entry
0002: # rule_key: guardian.zendesk-secret-key
0003: zendesk = 26scteg3uope60cg19y17au2e89fl1ns3ibp14qu
```
...
### `terraform/guardian-coverage-platform/provider_004.tfvars`
...
```text
0001: # coverage campaign entry
0002: # rule_key: guardian.sumologic-access-token
0003: sumo = xlsmdyd5n7vy5foxf5th6fbewt7grkqy7oh204h9xn17gwe4amq6u1lyw88z7fah
```

### `terraform/guardian-coverage-platform/provider_009.tfvars`
...
```text
0001: # coverage campaign entry
0002: # rule_key: guardian.twitter-access-secret
0003: twitter = 1mn2n2l5vr97djo7s36gprynjsc2r2ypsuddhozx2i51t
```

### `terraform/guardian-coverage-platform/provider_014.tfvars`
...
```text
0001: # coverage campaign entry
0002: # rule_key: guardian.typeform-api-token
0003: typeform = tfp_ja9k835zhr_jdgfk8toi3m6t0j5gg4s4fckow.355j2p8wachea=p2y0.9=
```

### `terraform/guardian-coverage-platform/provider_019.tfvars`
...
```text
0001: # coverage campaign entry
0002: # rule_key: guardian.yandex-aws-access-token
0003: yandex = YCAa0CEBQIjE2BAI1mLO8C9jXJnDvhgJjwMt5CE7
```

## 12. Line Composition and Filler Disclosure

- Total LOC considered for authored/generated project content: `6155`
- Synthetic filler / inflation LOC: `5720`
- Synthetic filler ratio: `92.93%`
...
- path: `integrations/guardian-coverage-platform/runtime/provider_001.env`
  module: `Guardian`
  expected rule/finding family: `guardian.squarespace-access-token`
...
- path: `integrations/guardian-coverage-platform/config/provider_002.yaml`
  module: `Guardian`
  expected rule/finding family: `guardian.stripe-access-token`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `deploy/guardian-coverage-platform/provider_003.properties`
  module: `Guardian`
  expected rule/finding family: `guardian.sumologic-access-id`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `terraform/guardian-coverage-platform/provider_004.tfvars`
  module: `Guardian`
  expected rule/finding family: `guardian.sumologic-access-token`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `ops/guardian-coverage-platform/secrets/provider_005.txt`
  module: `Guardian`
  expected rule/finding family: `guardian.telegram-bot-api-token`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `integrations/guardian-coverage-platform/runtime/provider_006.env`
  module: `Guardian`
  expected rule/finding family: `guardian.travisci-access-token`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `integrations/guardian-coverage-platform/config/provider_007.yaml`
  module: `Guardian`
  expected rule/finding family: `guardian.twilio-api-key`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `deploy/guardian-coverage-platform/provider_008.properties`
  module: `Guardian`
  expected rule/finding family: `guardian.twitch-api-token`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `terraform/guardian-coverage-platform/provider_009.tfvars`
  module: `Guardian`
  expected rule/finding family: `guardian.twitter-access-secret`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `ops/guardian-coverage-platform/secrets/provider_010.txt`
  module: `Guardian`
  expected rule/finding family: `guardian.twitter-access-token`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `integrations/guardian-coverage-platform/runtime/provider_011.env`
  module: `Guardian`
  expected rule/finding family: `guardian.twitter-api-key`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `integrations/guardian-coverage-platform/config/provider_012.yaml`
  module: `Guardian`
  expected rule/finding family: `guardian.twitter-api-secret`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `deploy/guardian-coverage-platform/provider_013.properties`
  module: `Guardian`
  expected rule/finding family: `guardian.twitter-bearer-token`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `terraform/guardian-coverage-platform/provider_014.tfvars`
  module: `Guardian`
  expected rule/finding family: `guardian.typeform-api-token`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `ops/guardian-coverage-platform/secrets/provider_015.txt`
  module: `Guardian`
  expected rule/finding family: `guardian.vault-batch-token`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `integrations/guardian-coverage-platform/runtime/provider_016.env`
  module: `Guardian`
  expected rule/finding family: `guardian.vault-service-token`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `integrations/guardian-coverage-platform/config/provider_017.yaml`
  module: `Guardian`
  expected rule/finding family: `guardian.yandex-access-token`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `deploy/guardian-coverage-platform/provider_018.properties`
  module: `Guardian`
  expected rule/finding family: `guardian.yandex-api-key`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `terraform/guardian-coverage-platform/provider_019.tfvars`
  module: `Guardian`
  expected rule/finding family: `guardian.yandex-aws-access-token`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `ops/guardian-coverage-platform/secrets/provider_020.txt`
  module: `Guardian`
  expected rule/finding family: `guardian.zendesk-secret-key`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
