# Generated Project Dossier - Q-V5-JAVA-003

## 1. Scenario Identity

- scenarioId: `Q-V5-JAVA-003`
- scenarioName: Quantum runtime-wired TLS config misuse in a Java gateway service.
- milestone: `M5`
...
- repo remote URL in Gitea: `http://localhost:3001/arq/gateway-config-java-20260330t074203z`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M5\gateway-config-java\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\Q-V5-JAVA-003\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\Q-V5-JAVA-003.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Gateway service with environment-driven HTTP client settings.` as a `Java + config wiring` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Quantum runtime-wired TLS config misuse in a Java gateway service.`.

## 3. Architecture Summary

- Major components: `docs, ops, scripts, sql, src, validation`
- Runtime role: `Gateway service with environment-driven HTTP client settings.`
- Config flow: `src/main/resources/application-dev.yml, src/main/resources/application-prod.yml, src/main/resources/application.yml`
- Secret flow: `No Guardian must-find secret path in this scenario.`
- Crypto/TLS flow if relevant: `PartnerTlsProperties.java, PartnerTrustManager.java`
- Test surfaces: `src/test/java/com/arq/gatewayconfigjava/service/BalanceServiceTest.java, src/test/java/com/arq/gatewayconfigjava/service/DisputeServiceTest.java, src/test/java/com/arq/gatewayconfigjava/service/InvoiceServiceTest.java, src/test/java/com/arq/gatewayconfigjava/service/LedgerServiceTest.java, src/test/java/com/arq/gatewayconfigjava/service/PartnerServiceTest.java, src/test/java/com/arq/gatewayconfigjava/service/PayoutServiceTest.java, src/test/java/com/arq/gatewayconfigjava/service/RefundServiceTest.java, src/test/java/com/arq/gatewayconfigjava/service/SettlementServiceTest.java`
...
|   |   |           `-- gatewayconfigjava
|   |   |               |-- config
|   |   |               |   |-- PartnerTlsProperties.java
|   |   |               |   `-- PartnerTrustManager.java
|   |   |               |-- domain
|   |   |               |   |-- BalanceRecord.java
|   |   |               |   |-- DisputeRecord.java
|   |   |               |   |-- InvoiceRecord.java
...
|   |   |               `-- GatewayconfigjavaApplication.java
|   |   `-- resources
|   |       |-- application-dev.yml
...
| src/main/java/com/arq/gatewayconfigjava/domain/LedgerRecord.java | live-code | 33 | Runtime business module contributing to Ledger Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/domain/PartnerRecord.java | live-code | 33 | Runtime business module contributing to Partner Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/domain/PayoutRecord.java | live-code | 33 | Runtime business module contributing to Payout Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/domain/RefundRecord.java | live-code | 33 | Runtime business module contributing to Refund Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/domain/SettlementRecord.java | live-code | 33 | Runtime business module contributing to Settlement Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/dto/BalanceRequest.java | live-code | 28 | Runtime business module contributing to Balance Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/dto/BalanceResponse.java | live-code | 25 | Runtime business module contributing to Balance Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/dto/DisputeRequest.java | live-code | 28 | Runtime business module contributing to Dispute Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/dto/DisputeResponse.java | live-code | 25 | Runtime business module contributing to Dispute Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/dto/InvoiceRequest.java | live-code | 28 | Runtime business module contributing to Invoice Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/dto/InvoiceResponse.java | live-code | 25 | Runtime business module contributing to Invoice Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/dto/LedgerRequest.java | live-code | 28 | Runtime business module contributing to Ledger Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/dto/LedgerResponse.java | live-code | 25 | Runtime business module contributing to Ledger Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/dto/PartnerRequest.java | live-code | 28 | Runtime business module contributing to Partner Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/dto/PartnerResponse.java | live-code | 25 | Runtime business module contributing to Partner Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/dto/PayoutRequest.java | live-code | 28 | Runtime business module contributing to Payout Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/dto/PayoutResponse.java | live-code | 25 | Runtime business module contributing to Payout Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/dto/RefundRequest.java | live-code | 28 | Runtime business module contributing to Refund Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/dto/RefundResponse.java | live-code | 25 | Runtime business module contributing to Refund Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/dto/SettlementRequest.java | live-code | 28 | Runtime business module contributing to Settlement Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/dto/SettlementResponse.java | live-code | 25 | Runtime business module contributing to Settlement Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/repository/BalanceRepository.java | live-code | 21 | Persistence or data-access helper for Balance Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/repository/DisputeRepository.java | live-code | 21 | Persistence or data-access helper for Dispute Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/repository/InvoiceRepository.java | live-code | 21 | Persistence or data-access helper for Invoice Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/repository/LedgerRepository.java | live-code | 21 | Persistence or data-access helper for Ledger Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/repository/PartnerRepository.java | live-code | 21 | Persistence or data-access helper for Partner Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/repository/PayoutRepository.java | live-code | 21 | Persistence or data-access helper for Payout Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/repository/RefundRepository.java | live-code | 21 | Persistence or data-access helper for Refund Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/repository/SettlementRepository.java | live-code | 21 | Persistence or data-access helper for Settlement Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/service/BalanceService.java | live-code | 19 | Runtime business service implementing Balance Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/service/DisputeService.java | live-code | 19 | Runtime business service implementing Dispute Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/service/InvoiceService.java | live-code | 19 | Runtime business service implementing Invoice Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/service/LedgerService.java | live-code | 19 | Runtime business service implementing Ledger Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/service/PartnerService.java | live-code | 19 | Runtime business service implementing Partner Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/service/PayoutService.java | live-code | 19 | Runtime business service implementing Payout Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/service/RefundService.java | live-code | 19 | Runtime business service implementing Refund Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/service/SettlementService.java | live-code | 19 | Runtime business service implementing Settlement Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/web/BalanceController.java | live-code | 23 | Runtime HTTP/controller surface for Balance Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/web/DisputeController.java | live-code | 23 | Runtime HTTP/controller surface for Dispute Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/web/InvoiceController.java | live-code | 23 | Runtime HTTP/controller surface for Invoice Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/web/LedgerController.java | live-code | 23 | Runtime HTTP/controller surface for Ledger Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/web/PartnerController.java | live-code | 23 | Runtime HTTP/controller surface for Partner Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/web/PayoutController.java | live-code | 23 | Runtime HTTP/controller surface for Payout Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/web/RefundController.java | live-code | 23 | Runtime HTTP/controller surface for Refund Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/gatewayconfigjava/web/SettlementController.java | live-code | 23 | Runtime HTTP/controller surface for Settlement Controller. | no | no | no | yes | yes | no |
| src/main/resources/application-dev.yml | live-config | 3 | Runtime configuration carrying environment or deployment settings for Application Dev. | no | yes | no | yes | yes | no |
| src/main/resources/application-prod.yml | live-config | 3 | Runtime configuration carrying environment or deployment settings for Application Prod. | no | no | no | yes | yes | no |
...
| src/test/java/com/arq/gatewayconfigjava/service/BalanceServiceTest.java | test | 13 | Automated test surface covering Balance Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/gatewayconfigjava/service/DisputeServiceTest.java | test | 13 | Automated test surface covering Dispute Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/gatewayconfigjava/service/InvoiceServiceTest.java | test | 13 | Automated test surface covering Invoice Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/gatewayconfigjava/service/LedgerServiceTest.java | test | 13 | Automated test surface covering Ledger Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/gatewayconfigjava/service/PartnerServiceTest.java | test | 13 | Automated test surface covering Partner Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/gatewayconfigjava/service/PayoutServiceTest.java | test | 13 | Automated test surface covering Payout Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/gatewayconfigjava/service/RefundServiceTest.java | test | 13 | Automated test surface covering Refund Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/gatewayconfigjava/service/SettlementServiceTest.java | test | 13 | Automated test surface covering Settlement Service Test behavior. | no | no | yes | no | yes | no |
...
- Path: `src/main/java/com/arq/gatewayconfigjava/config/PartnerTlsProperties.java`
  Why it should be detected: scenario declares `runtime-trust-bypass` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `runtime-trust-bypass`
...
- Path: `src/main/java/com/arq/gatewayconfigjava/config/PartnerTrustManager.java`
  Why it should be detected: scenario declares `trust-manager-bypass` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `trust-manager-bypass`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
...
| src/test/java/com/arq/gatewayconfigjava/service/BalanceServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/gatewayconfigjava/service/DisputeServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/gatewayconfigjava/service/InvoiceServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/gatewayconfigjava/service/LedgerServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/gatewayconfigjava/service/PartnerServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/gatewayconfigjava/service/PayoutServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/gatewayconfigjava/service/RefundServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/gatewayconfigjava/service/SettlementServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- Command: `mvn -q -DskipTests compile`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M5\gateway-config-java\validation\runnability-logs\build-01.log`
...
- Command: `mvn -q test`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M5\gateway-config-java\validation\runnability-logs\test-01.log`
...
- Command: `powershell -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M5\gateway-config-java\validation\runnability-logs\smoke-01.log`
...
```text
0001: # gateway-config-java
0002: 
0003: Gateway service with environment-driven HTTP client settings.
0004: 
...
0011:   <artifactId>gateway-config-java</artifactId>
...
### `src/main/java/com/arq/gatewayconfigjava/GatewayconfigjavaApplication.java`
...
```text
0001: package com.arq.gatewayconfigjava;
0002: 
...
0007: public class GatewayconfigjavaApplication {
0008:     public static void main(String[] args) {
0009:         SpringApplication.run(GatewayconfigjavaApplication.class, args);
0010:     }
0011: }
```

### `src/main/java/com/arq/gatewayconfigjava/config/PartnerTlsProperties.java`
...
```text
0001: package com.arq.gatewayconfigjava.config;
0002: 
0003: import javax.net.ssl.HostnameVerifier;
0004: import javax.net.ssl.SSLSession;
0005: 
0006: public class PartnerTlsProperties {
0007:     public HostnameVerifier hostnameVerifier() {
0008:         return new HostnameVerifier() {
0009:             @Override
0010:             public boolean verify(String hostname, SSLSession session) {
0011:                 return true;
0012:             }
```

### `src/main/java/com/arq/gatewayconfigjava/config/PartnerTrustManager.java`
...
0005: 
0006: public class PartnerTrustManager implements X509TrustManager {
0007:     @Override
0008:     public void checkClientTrusted(X509Certificate[] chain, String authType) {
0009:     }
0010: 
0011:     @Override
0012:     public void checkServerTrusted(X509Certificate[] chain, String authType) {
```

### `src/main/resources/application-dev.yml`

- Why this file matters: `live-config` file with expectation `must_not_find`.
- Detailed summary: Runtime configuration carrying environment or deployment settings for Application Dev. It is executable/live in the assembled repository.
...
- Total LOC considered for authored/generated project content: `8442`
- Synthetic filler / inflation LOC: `3520`
- Synthetic filler ratio: `41.70%`

| category | LOC |
| --- | ---: |
| live business code | 1237 |
| live config | 9 |
| tests | 104 |
| docs | 11 |
| scripts | 1 |
| fixtures | 0 |
| vendor/generated | 3533 |
...
- path: `PartnerTlsProperties.java`
  module: `Quantum`
  expected rule/finding family: `runtime-trust-bypass`
...
- path: `PartnerTrustManager.java`
  module: `Quantum`
  expected rule/finding family: `trust-manager-bypass`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
...
- What this scenario is proving: `Quantum runtime-wired TLS config misuse in a Java gateway service.`
- What it is not proving: comprehensive customer architecture fidelity beyond the declared validation contract.
- First outputs to inspect on failure: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M5\gateway-config-java\validation\generated-project-dossier.md`, `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M5\gateway-config-java\validation\generated-file-manifest.json`, comparison artifacts under the latest `runs/` directory, and the persisted runnability logs referenced above.
