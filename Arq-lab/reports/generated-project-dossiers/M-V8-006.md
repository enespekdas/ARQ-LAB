# Generated Project Dossier - M-V8-006

## 1. Scenario Identity

- scenarioId: `M-V8-006`
- scenarioName: Mixed infra repo with live GitHub-backed runtime misuse plus dormant examples, fixtures, and CI surfaces.
- milestone: `M8`
- targetModule: `Both`
- language / stack: `App + infra + helm + kustomize + terraform + CI`
- repoType: `mixed`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\control-plane-overlay-repo`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/control-plane-overlay-repo`
- default branch: `main`
...
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\control-plane-overlay-repo\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M-V8-006\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\M-V8-006.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Infra-heavy control-plane repo with live runtime misuse, hotfix branches, and noisy dormant overlays.` as a `App + infra + helm + kustomize + terraform + CI` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Mixed infra repo with live GitHub-backed runtime misuse plus dormant examples, fixtures, and CI surfaces.`.

## 3. Architecture Summary

- Major components: `.github, app, deploy, docs, helm, kustomize, ops, scripts, sql, terraform, tests, validation`
- Runtime role: `Infra-heavy control-plane repo with live runtime misuse, hotfix branches, and noisy dormant overlays.`
- Config flow: `.github/workflows/deploy.yml, app/config/production.env, deploy/envoy.yaml, helm/control-plane/values.yaml, terraform/environments/prod/main.tf, terraform/modules/edge/variables.tf`
...
| docs/infra/overlay-matrix.md | docs | 1 | Documentation or explanatory material for Overlay Matrix. | no | no | yes | no | no | no |
...
| kustomize/overlays/staging/kustomization.yaml | generated | 2 | Generated or derived project artifact related to Kustomization. | no | no | yes | no | no | no |
...
| terraform/environments/prod/main.tf | live-config | 1 | Runtime configuration carrying environment or deployment settings for Main. | no | no | no | yes | no | no |
...
| docs/infra/overlay-matrix.md | docs | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
| kustomize/overlays/staging/kustomization.yaml | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- `feature/charts-cleanup` tip: `999f90436a088889211ab54d0764dcaa84afe685`; diverges from `main` at `9cfa1241249a9e0328af7f2520d7f263b048f9a9`
- `feature/hotfix-ssl` tip: `78f9f21d95067db10e405de69e980f67ba056884`; diverges from `main` at `9cfa1241249a9e0328af7f2520d7f263b048f9a9`
- `main` tip: `9cfa1241249a9e0328af7f2520d7f263b048f9a9`
- `release/2026.04` tip: `9f39a325c8a2d9b5d942614223ffa324cfb5ac02`; diverges from `main` at `9cfa1241249a9e0328af7f2520d7f263b048f9a9`

Commit order:

- `9cfa1241249a9e0328af7f2520d7f263b048f9a9` `c001 bootstrap mixed repo`: initial clean or baseline assembly.
- `78f9f21d95067db10e405de69e980f67ba056884` `c002 temporary hotfix secret`: introduces an intended signal.
- `9f39a325c8a2d9b5d942614223ffa324cfb5ac02` `c003 release branch clean`: removes or neutralizes a prior signal.
- `999f90436a088889211ab54d0764dcaa84afe685` `c004 charts cleanup branch`: removes or neutralizes a prior signal.
...
- Command: `C:\Python313\python.EXE -m compileall app tests scripts`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\control-plane-overlay-repo\validation\runnability-logs\build-01.log`
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Set-Location 'ops/console'; npm install --silent`
  Expected result: `build` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\control-plane-overlay-repo\validation\runnability-logs\build-02.log`
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Set-Location 'ops/console'; npm run build`
  Expected result: `build` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\control-plane-overlay-repo\validation\runnability-logs\build-03.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q tests`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\control-plane-overlay-repo\validation\runnability-logs\test-01.log`
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Set-Location 'ops/console'; npm test -- --runInBand`
  Expected result: `test` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\control-plane-overlay-repo\validation\runnability-logs\test-02.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\control-plane-overlay-repo\validation\runnability-logs\smoke-01.log`
...
```text
0001: # control-plane-overlay-repo
0002: 
0003: Infra-heavy control-plane repo with live runtime misuse, hotfix branches, and noisy dormant overlays.
0004: 
