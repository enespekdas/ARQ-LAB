# Generated Project Dossier - Q-V3-CS-003

## 1. Scenario Identity

- scenarioId: `Q-V3-CS-003`
- scenarioName: Quantum weak crypto patterns in a realistic C# billing SDK.
- milestone: `M3`
- targetModule: `Quantum`
- language / stack: `C# / .NET 8`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\billing-sdk-csharp`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/billing-sdk-csharp`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\billing-sdk-csharp\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\Q-V3-CS-003\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\Q-V3-CS-003.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Billing SDK and token signing library.` as a `C# / .NET 8` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Quantum weak crypto patterns in a realistic C# billing SDK.`.

## 3. Architecture Summary

- Major components: `docs, ops, sql, src, tests, validation`
- Runtime role: `Billing SDK and token signing library.`
...
- Crypto/TLS flow if relevant: `LegacyCipherService.cs, LegacyHashService.cs`
...
|       |   `-- PartnersRegistry.cs
|       |-- Security
|       |   |-- LegacyCipherService.cs
|       |   |-- LegacyHashService.cs
|       |   |-- OtpTokenService.cs
|       |   `-- SecureOtpTokenService.cs
|       |-- Tokens
|       |   `-- TokensRegistry.cs
|       `-- Library.csproj
|-- tests
...
- Path: `src/Library/Security/LegacyHashService.cs`
  ...
  Explainability expectation: resolvedValue~MD5, queryFamily~csharp; resolvedValue~SHA1
- Path: `src/Library/Security/LegacyHashService.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: resolvedValue~MD5, queryFamily~csharp; resolvedValue~SHA1
- Path: `src/Library/Security/LegacyCipherService.cs`
  Why it should be detected: scenario declares `ecb` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `ECB`
  Head/history behavior: `head-only`
  Explainability expectation: resolvedValue~ECB
...
- Command: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\.toolchains\dotnet\dotnet.exe restore src/AppHost/AppHost.csproj`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\billing-sdk-csharp\validation\runnability-logs\build-01.log`
- Command: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\.toolchains\dotnet\dotnet.exe build src/AppHost/AppHost.csproj -c Release`
  Expected result: `build` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\billing-sdk-csharp\validation\runnability-logs\build-02.log`
...
- Command: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\.toolchains\dotnet\dotnet.exe test tests/AppHost.Tests/AppHost.Tests.csproj -c Release --no-build`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\billing-sdk-csharp\validation\runnability-logs\test-01.log`
...
- Command: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\.toolchains\dotnet\dotnet.exe run --project src/AppHost/AppHost.csproj -- --smoke`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\billing-sdk-csharp\validation\runnability-logs\smoke-01.log`
...
```text
0002: 
0003: Billing SDK and token signing library.
0004: 
```

### `src/Library/Security/LegacyCipherService.cs`
...
```text
0001: using System.Security.Cryptography; namespace Arq.Lab.Library.Security; public static class LegacyCipherService { public static Aes Cipher() { var aes = Aes.Create(); aes.Mode = CipherMode.ECB; return aes; } }
```

### `src/Library/Security/LegacyHashService.cs`
...
- Detailed summary: Runtime business service implementing Secure Otp Token Service logic. It is executable/live in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`True`; protected=`False`.
- Representative excerpt:

```text
0001: using System.Security.Cryptography; namespace Arq.Lab.Library.Security; public static class SecureOtpTokenService { public static int IssueCode() => RandomNumberGenerator.GetInt32(100000, 999999); }
```

## 12. Line Composition and Filler Disclosure

- Total LOC considered for authored/generated project content: `5042`
- Synthetic filler / inflation LOC: `4840`
- Synthetic filler ratio: `95.99%`

| category | LOC |
| --- | ---: |
| live business code | 11 |
| live config | 0 |
| tests | 2 |
| docs | 11 |
| scripts | 0 |
| fixtures | 0 |
| vendor/generated | 168 |
...
- path: `LegacyHashService.cs`
  module: `Quantum`
  expected rule/finding family: `MD5`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: resolvedValue~MD5, queryFamily~csharp; resolvedValue~SHA1
- path: `LegacyHashService.cs`
  module: `Quantum`
  expected rule/finding family: `SHA1`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: resolvedValue~MD5, queryFamily~csharp; resolvedValue~SHA1
- path: `LegacyCipherService.cs`
  module: `Quantum`
  expected rule/finding family: `ECB`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: resolvedValue~ECB

### must_not_find

- path: `SecureOtpTokenService.cs`
...
- `LegacyHashService.cs`: resolvedValue~`MD5`, queryFamily~`csharp`
- `LegacyHashService.cs`: resolvedValue~`SHA1`
- `LegacyCipherService.cs`: resolvedValue~`ECB`
