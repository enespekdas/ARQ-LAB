# Generated Project Dossier - N-V7-VENDOR-007

## 1. Scenario Identity

- scenarioId: `N-V7-VENDOR-007`
- scenarioName: Vendor, generated, and lockfile noise should remain clean.
- milestone: `M7`
- targetModule: `Both`
- language / stack: `Vendor / generated / lockfile`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\bundle-lockfile-repo`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/bundle-lockfile-repo`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\bundle-lockfile-repo\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\N-V7-VENDOR-007\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\N-V7-VENDOR-007.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Dependency-heavy repo with bundled artifacts, generated code, and lockfiles containing secret-looking strings.` as a `Vendor / generated / lockfile` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Vendor, generated, and lockfile noise should remain clean.`.

## 3. Architecture Summary

- Major components: `app, docs, generated, ops, scripts, sql, tests, validation, vendor`
- Runtime role: `Dependency-heavy repo with bundled artifacts, generated code, and lockfiles containing secret-looking strings.`
...
| package-lock.json | build/deploy | 1 | Build or deployment definition shaping how Package Lock is compiled, packaged, or released. | no | yes | no | yes | yes | no |
...
- `package-lock.json`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
...
- Command: `C:\Python313\python.EXE -m compileall app tests scripts`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\bundle-lockfile-repo\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\bundle-lockfile-repo\validation\runnability-logs\test-01.log`
...
- Command: `C:\Python313\python.EXE scripts/smoke.py`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\bundle-lockfile-repo\validation\runnability-logs\smoke-01.log`
...
```text
0002: 
0003: Dependency-heavy repo with bundled artifacts, generated code, and lockfiles containing secret-looking strings.
0004: 
```
...
```text
0001: export const insecureExample = 'rejectUnauthorized false';
```

### `package-lock.json`

- Why this file matters: `build/deploy` file with expectation `must_not_find`.
- Detailed summary: Build or deployment definition shaping how Package Lock is compiled, packaged, or released. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`True`; protected=`False`.
- Representative excerpt:

```text
0001: {"packages":{"":{"integrity":"sha512-placeholder-integrity-value-only"}}}
```
