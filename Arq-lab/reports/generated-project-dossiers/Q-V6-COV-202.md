# Generated Project Dossier - Q-V6-COV-202

## 1. Scenario Identity

- scenarioId: `Q-V6-COV-202`
- scenarioName: Quantum precision coverage bundle exercising 3 config rule candidates within the any applicability slice.
- milestone: `M6`
- targetModule: `Quantum`
- language / stack: `Config / infra precision coverage pack`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-config-any-02`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/quantum-precision-config-any-02`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-config-any-02\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\Q-V6-COV-202\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\Q-V6-COV-202.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `config version-sliced precision coverage pack (any) wave 02` as a `Config / infra precision coverage pack` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Quantum precision coverage bundle exercising 3 config rule candidates within the any applicability slice.`.

## 3. Architecture Summary

- Major components: `.github, config, deploy, docs, ops, scripts, sql, tests, validation, vendor`
- Runtime role: `config version-sliced precision coverage pack (any) wave 02`
- Config flow: `.github/workflows/deploy.yml, config/runtime/baseline.yaml, deploy/live/quantum-precision-config-any-02/runtime-001/runtime.conf, deploy/live/quantum-precision-config-any-02/runtime-002/runtime.conf, deploy/live/quantum-precision-config-any-02/runtime-003/runtime.conf, deploy/prod/service.properties`
- Secret flow: `No Guardian must-find secret path in this scenario.`
- Crypto/TLS flow if relevant: `deploy/live/quantum-precision-config-any-02/runtime-001/runtime.conf, deploy/live/quantum-precision-config-any-02/runtime-002/runtime.conf, deploy/live/quantum-precision-config-any-02/runtime-003/runtime.conf`
...
```text
quantum-precision-config-any-02
|-- .github
|   `-- workflows
|       `-- deploy.yml
|-- config
...
| deploy/live/quantum-precision-config-any-02/runtime-001/runtime.conf | live-config | 5 | Runtime configuration carrying environment or deployment settings for Runtime. | yes | no | no | yes | yes | no |
| deploy/live/quantum-precision-config-any-02/runtime-002/runtime.conf | live-config | 5 | Runtime configuration carrying environment or deployment settings for Runtime. | yes | no | no | yes | yes | no |
| deploy/live/quantum-precision-config-any-02/runtime-003/runtime.conf | live-config | 5 | Runtime configuration carrying environment or deployment settings for Runtime. | yes | no | no | yes | yes | no |
...
| validation/generated-project-dossier.md | generated | 420 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `deploy/live/quantum-precision-config-any-02/runtime-001/runtime.conf`
...
- Path: `deploy/live/quantum-precision-config-any-02/runtime-002/runtime.conf`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `deploy/live/quantum-precision-config-any-02/runtime-003/runtime.conf`
  Why it should be detected: scenario declares `rule-003` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0948-config`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
...
- Command: `C:\Python313\python.EXE scripts/validate_repo.py`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-config-any-02\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-config-any-02\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-config-any-02\validation\runnability-logs\smoke-01.log`
...
```text
0001: # quantum-precision-config-any-02
0002: 
0003: config version-sliced precision coverage pack (any) wave 02
0004: 
...
### `deploy/live/quantum-precision-config-any-02/runtime-001/runtime.conf`
...
### `deploy/live/quantum-precision-config-any-02/runtime-002/runtime.conf`
...
### `deploy/live/quantum-precision-config-any-02/runtime-003/runtime.conf`
...
```text
0001: # rule_key: quantum.arq-q-0948-config
0002: # evidence_anchor: sslEnabledProtocols
```
...
- Total LOC considered for authored/generated project content: `1055`
- Synthetic filler / inflation LOC: `880`
- Synthetic filler ratio: `83.41%`
...
- path: `deploy/live/quantum-precision-config-any-02/runtime-003/runtime.conf`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0948-config`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
...
- What this scenario is proving: `Quantum precision coverage bundle exercising 3 config rule candidates within the any applicability slice.`
