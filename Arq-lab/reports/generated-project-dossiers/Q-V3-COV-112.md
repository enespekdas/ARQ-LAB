...
| services/quantum-coverage-csharp-d-01/src/legacy/Rule001.cs | live-code | 11 | Runtime business module contributing to Rule001. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule002.cs | live-code | 12 | Runtime business module contributing to Rule002. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule003.cs | live-code | 12 | Runtime business module contributing to Rule003. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule004.cs | live-code | 11 | Runtime business module contributing to Rule004. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule005.cs | live-code | 12 | Runtime business module contributing to Rule005. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule006.cs | live-code | 12 | Runtime business module contributing to Rule006. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule007.cs | live-code | 12 | Runtime business module contributing to Rule007. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule008.cs | live-code | 12 | Runtime business module contributing to Rule008. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule009.cs | live-code | 12 | Runtime business module contributing to Rule009. | yes | yes | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule010.cs | live-code | 11 | Runtime business module contributing to Rule010. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule011.cs | live-code | 12 | Runtime business module contributing to Rule011. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule012.cs | live-code | 11 | Runtime business module contributing to Rule012. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule013.cs | live-code | 11 | Runtime business module contributing to Rule013. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule014.cs | live-code | 12 | Runtime business module contributing to Rule014. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule015.cs | live-code | 12 | Runtime business module contributing to Rule015. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule016.cs | live-code | 11 | Runtime business module contributing to Rule016. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule017.cs | live-code | 12 | Runtime business module contributing to Rule017. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule018.cs | live-code | 12 | Runtime business module contributing to Rule018. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule019.cs | live-code | 13 | Runtime business module contributing to Rule019. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule020.cs | live-code | 11 | Runtime business module contributing to Rule020. | yes | no | no | yes | yes | no |
...
| validation/generated-project-dossier.md | generated | 866 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
0005:         // rule_key: quantum.arq-q-0447-csharp
0006:         // evidence_anchor: using System.Security.Cryptography.X509Certificates
```
...
```text
0004:     public static void Execute() {
0005:         // rule_key: quantum.arq-q-0485-csharp
0006:         // evidence_anchor: Microsoft.AspNetCore.DataProtection
```
...
```text
0004:     public static void Execute() {
0005:         // rule_key: quantum.arq-q-0489-csharp
0006:         // evidence_anchor: SHA3_256, SHA3_384, SHA3_512
```
...
```text
0005:     public static void Execute() {
0006:         // rule_key: quantum.arq-q-0491-csharp
0007:         // evidence_anchor: AesGcm
```
...
```text
0005:     public static void Execute() {
0006:         // rule_key: quantum.arq-q-0492-csharp
0007:         // evidence_anchor: ChaCha20Poly1305
```
...
```text
0004:     public static void Execute() {
0005:         // rule_key: quantum.arq-q-0493-csharp
0006:         // evidence_anchor: HKDF.Extract, HKDF.Expand, HKDF.DeriveKey
```
...
```text
0005:     public static void Execute() {
0006:         // rule_key: quantum.arq-q-0494-csharp
...
```text
0005:     public static void Execute() {
0006:         // rule_key: quantum.arq-q-0495-csharp
0007:         // evidence_anchor: ECDsa.Create
```
...
0007:         // rule_key: quantum.arq-q-0500-csharp
0008:         // evidence_anchor: ImportFromPem, CreateFromPem
```
...
```text
0004:     public static void Execute() {
0005:         // rule_key: quantum.arq-q-0501-csharp
0006:         // evidence_anchor: using System.Security.Cryptography
```

## 12. Line Composition and Filler Disclosure

- Total LOC considered for authored/generated project content: `1494`
- Synthetic filler / inflation LOC: `880`
- Synthetic filler ratio: `58.90%`

| category | LOC |
| --- | ---: |
| live business code | 234 |
| live config | 11 |
| tests | 3 |
| docs | 16 |
| scripts | 2 |
