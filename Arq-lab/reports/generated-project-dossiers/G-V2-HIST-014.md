# Generated Project Dossier - G-V2-HIST-014

## 1. Scenario Identity

- scenarioId: `G-V2-HIST-014`
- scenarioName: Guardian history/ref handling when a secret evolves from split fragments into canonical form before removal.
- milestone: `M2`
- targetModule: `Guardian`
- language / stack: `TypeScript / Node`
- repoType: `history`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\split-concat-lineage`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/split-concat-lineage`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT, REF_HISTORY`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\split-concat-lineage\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\G-V2-HIST-014\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\G-V2-HIST-014.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Partner bootstrap repo with split secret construction, later canonicalization, and final cleanup.` as a `TypeScript / Node` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Guardian history/ref handling when a secret evolves from split fragments into canonical form before removal.`.

## 3. Architecture Summary

- Major components: `__tests__, dist, docs, examples, ops, scripts, sql, src, validation`
- Runtime role: `Partner bootstrap repo with split secret construction, later canonicalization, and final cleanup.`
- Config flow: `No dedicated live-config files; runtime behavior is code-driven.`
- Secret flow: `partnerSecret.ts`
...
| dist/src/modules/partner/bootstrap/partnerSecret.js | generated | 4 | Generated or derived project artifact related to Partner Secret. | no | no | yes | yes | no | no |
...
| docs/split-secret.md | docs | 1 | Documentation or explanatory material for Split Secret. | no | no | yes | no | no | no |
| examples/concat-demo.ts | docs | 1 | Documentation or explanatory material for Concat Demo. | no | no | yes | no | no | no |
...
| src/modules/partner/bootstrap/mainSafe.ts | live-code | 1 | Runtime business module contributing to Main Safe. | no | no | no | yes | yes | no |
| src/modules/partner/bootstrap/partnerSecret.ts | live-code | 1 | Runtime business module contributing to Partner Secret. | yes | no | no | yes | yes | no |
...
| validation/generated-file-manifest.json | generated | 2746 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
| validation/generated-project-dossier.md | generated | 821 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
| validation/generated-tree.txt | generated | 235 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `src/modules/partner/bootstrap/partnerSecret.ts`
  Why it should be detected: scenario declares `split-concat-secret` as a live positive surface.
...
| dist/src/modules/partner/bootstrap/partnerSecret.js | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
| docs/split-secret.md | docs | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| examples/concat-demo.ts | docs | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- `main` tip: `af5d36db117d3fbe2dc6aa63c551832a46cd7a84`

Commit order:

- `fd761fc9b2b0d21ebdff01435fb3611df0458570` `c001 main clean baseline`: removes or neutralizes a prior signal.
- `8a7006bbe5a874996b40c9d0168e93a0f8f61c4c` `c002 safe baseline file`: scenario state change.
- `232621b8d63c59e5856241f194f08cdaa4325a14` `c003 split secret assembly`: scenario state change.
- `12cfa084a8fbb209a7e2f8544971d7ef24c47ff3` `c004 canonical secret assembly`: scenario state change.
- `a6b43c9ac04c92f9c8f21440719acddf88fb8c96` `c005 docs and example context`: adds documentation-only or noise-only collateral.
- `af5d36db117d3fbe2dc6aa63c551832a46cd7a84` `c006 remove secret from head`: removes or neutralizes a prior signal.

Expected final head/history state:

- `split-concat-secret` on `partnerSecret.ts` should behave as `HISTORY_ONLY`.
...
- Command: `C:\Program Files\nodejs\npm.cmd install --silent`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\split-concat-lineage\validation\runnability-logs\build-01.log`
- Command: `C:\Program Files\nodejs\npm.cmd run build`
  Expected result: `build` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\split-concat-lineage\validation\runnability-logs\build-02.log`
...
- Command: `C:\Program Files\nodejs\npm.cmd test -- --runInBand`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\split-concat-lineage\validation\runnability-logs\test-01.log`
...
- Command: `C:\Program Files\nodejs\node.exe dist/scripts/smoke.js`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\split-concat-lineage\validation\runnability-logs\smoke-01.log`
...
```text
0002: 
0003: Partner bootstrap repo with split secret construction, later canonicalization, and final cleanup.
0004: 
```
...
### `docs/split-secret.md`

- Why this file matters: `docs` file with expectation `must_not_find`.
- Detailed summary: Documentation or explanatory material for Split Secret. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: Split and concat examples here remain descriptive only.
```

### `examples/concat-demo.ts`

- Why this file matters: `docs` file with expectation `must_not_find`.
- Detailed summary: Documentation or explanatory material for Concat Demo. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: export const concatDemo = ['example', 'only'].join('-');
```
...
```text
0001: {
0002:   "name": "split-concat-lineage",
0003:   "version": "1.0.0",
0004:   "private": true,
...
### `src/modules/partner/bootstrap/partnerSecret.ts`

- Why this file matters: `live-code` file with expectation `must_find`.
- Detailed summary: Runtime business module contributing to Partner Secret. It is executable/live in the assembled repository.
- Key constructs: positive surface; near-real=`False`; protected=`False`.
- Representative excerpt:

```text
0001: export const partnerSecret = 'safe-reference';
```

## 12. Line Composition and Filler Disclosure

- Total LOC considered for authored/generated project content: `9939`
- Synthetic filler / inflation LOC: `4840`
- Synthetic filler ratio: `48.70%`
