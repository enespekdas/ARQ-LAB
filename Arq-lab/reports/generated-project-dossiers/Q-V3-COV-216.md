# Generated Project Dossier - Q-V3-COV-216

## 1. Scenario Identity

- scenarioId: `Q-V3-COV-216`
- scenarioName: Quantum precision coverage bundle exercising 7 java rule candidates within the 11-to-25 applicability slice.
- milestone: `M3`
- targetModule: `Quantum`
- language / stack: `Java / precision coverage pack`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-java-11-to-25-01`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/quantum-precision-java-11-to-25-01`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-java-11-to-25-01\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\Q-V3-COV-216\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\Q-V3-COV-216.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `java version-sliced precision coverage pack (11-to-25) wave 01` as a `Java / precision coverage pack` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Quantum precision coverage bundle exercising 7 java rule candidates within the 11-to-25 applicability slice.`.

## 3. Architecture Summary

- Major components: `.github, config, deploy, docs, ops, scripts, services, sql, tests, validation, vendor`
- Runtime role: `java version-sliced precision coverage pack (11-to-25) wave 01`
...
- Crypto/TLS flow if relevant: `services/quantum-precision-java-11-to-25-01/src/legacy/Rule001.java, services/quantum-precision-java-11-to-25-01/src/legacy/Rule002.java, services/quantum-precision-java-11-to-25-01/src/legacy/Rule003.java, services/quantum-precision-java-11-to-25-01/src/legacy/Rule004.java, services/quantum-precision-java-11-to-25-01/src/legacy/Rule005.java, services/quantum-precision-java-11-to-25-01/src/legacy/Rule006.java, services/quantum-precision-java-11-to-25-01/src/legacy/Rule007.java`
...
```text
quantum-precision-java-11-to-25-01
|-- .github
|   `-- workflows
|       `-- deploy.yml
|-- config
...
| services/quantum-precision-java-11-to-25-01/src/legacy/Rule001.java | live-code | 11 | Runtime business module contributing to Rule001. | yes | no | no | yes | yes | no |
| services/quantum-precision-java-11-to-25-01/src/legacy/Rule002.java | live-code | 11 | Runtime business module contributing to Rule002. | yes | no | no | yes | yes | no |
| services/quantum-precision-java-11-to-25-01/src/legacy/Rule003.java | live-code | 11 | Runtime business module contributing to Rule003. | yes | no | no | yes | yes | no |
| services/quantum-precision-java-11-to-25-01/src/legacy/Rule004.java | live-code | 11 | Runtime business module contributing to Rule004. | yes | no | no | yes | yes | no |
| services/quantum-precision-java-11-to-25-01/src/legacy/Rule005.java | live-code | 11 | Runtime business module contributing to Rule005. | yes | no | no | yes | yes | no |
| services/quantum-precision-java-11-to-25-01/src/legacy/Rule006.java | live-code | 11 | Runtime business module contributing to Rule006. | yes | no | no | yes | yes | no |
| services/quantum-precision-java-11-to-25-01/src/legacy/Rule007.java | live-code | 11 | Runtime business module contributing to Rule007. | yes | no | no | yes | yes | no |
...
| validation/generated-project-dossier.md | generated | 542 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `services/quantum-precision-java-11-to-25-01/src/legacy/Rule001.java`
...
- Path: `services/quantum-precision-java-11-to-25-01/src/legacy/Rule002.java`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-java-11-to-25-01/src/legacy/Rule003.java`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-java-11-to-25-01/src/legacy/Rule004.java`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-java-11-to-25-01/src/legacy/Rule005.java`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-java-11-to-25-01/src/legacy/Rule006.java`
  Why it should be detected: scenario declares `rule-006` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0202-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-java-11-to-25-01/src/legacy/Rule007.java`
  Why it should be detected: scenario declares `rule-007` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0203-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
...
- Command: `C:\Python313\python.EXE scripts/validate_repo.py`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-java-11-to-25-01\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-java-11-to-25-01\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-java-11-to-25-01\validation\runnability-logs\smoke-01.log`
...
```text
0001: # quantum-precision-java-11-to-25-01
0002: 
0003: java version-sliced precision coverage pack (11-to-25) wave 01
0004: 
...
0006:   <properties>
0007:     <maven.compiler.source>11</maven.compiler.source>
0008:     <maven.compiler.target>11</maven.compiler.target>
0009:     <maven.compiler.release>11</maven.compiler.release>
0010:     <java.version>11</java.version>
0011:   </properties>
0012: </project>
```
...
### `services/quantum-precision-java-11-to-25-01/src/legacy/Rule001.java`
...
### `services/quantum-precision-java-11-to-25-01/src/legacy/Rule002.java`
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0100-java
0006:         // evidence_anchor: MessageDigest.getInstance("SHA3-256")
```

### `services/quantum-precision-java-11-to-25-01/src/legacy/Rule003.java`
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0101-java
0006:         // evidence_anchor: MessageDigest.getInstance("SHA3-512")
```

### `services/quantum-precision-java-11-to-25-01/src/legacy/Rule004.java`
...
### `services/quantum-precision-java-11-to-25-01/src/legacy/Rule005.java`
...
### `services/quantum-precision-java-11-to-25-01/src/legacy/Rule006.java`
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0202-java
0006:         // evidence_anchor: new NamedParameterSpec("X25519")
```

### `services/quantum-precision-java-11-to-25-01/src/legacy/Rule007.java`
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0203-java
...
- path: `services/quantum-precision-java-11-to-25-01/src/legacy/Rule006.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0202-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-precision-java-11-to-25-01/src/legacy/Rule007.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0203-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
