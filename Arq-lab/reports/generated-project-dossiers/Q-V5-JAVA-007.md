# Generated Project Dossier - Q-V5-JAVA-007

## 1. Scenario Identity

- scenarioId: `Q-V5-JAVA-007`
- scenarioName: Quantum should follow nested helper builders to SSLContext and trust-manager misuse in Java.
- milestone: `M5`
- targetModule: `Quantum`
- language / stack: `Java / Spring Boot`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tls-builder-nested-java`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/tls-builder-nested-java`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tls-builder-nested-java\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\Q-V5-JAVA-007\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\Q-V5-JAVA-007.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Java TLS repo with SSLContext and trust manager misuse hidden behind nested helper builders.` as a `Java / Spring Boot` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Quantum should follow nested helper builders to SSLContext and trust-manager misuse in Java.`.

## 3. Architecture Summary

- Major components: `docs, ops, scripts, sql, src, validation`
- Runtime role: `Java TLS repo with SSLContext and trust manager misuse hidden behind nested helper builders.`
- Config flow: `src/main/resources/application.yml`
- Secret flow: `No Guardian must-find secret path in this scenario.`
- Crypto/TLS flow if relevant: `NestedHostnameBuilder.java, NestedTrustManagerBuilder.java`
- Test surfaces: `src/test/java/com/arq/tlsbuildernestedjava/service/BalanceServiceTest.java, src/test/java/com/arq/tlsbuildernestedjava/service/DisputeServiceTest.java, src/test/java/com/arq/tlsbuildernestedjava/service/InvoiceServiceTest.java, src/test/java/com/arq/tlsbuildernestedjava/service/LedgerServiceTest.java, src/test/java/com/arq/tlsbuildernestedjava/service/PartnerServiceTest.java, src/test/java/com/arq/tlsbuildernestedjava/service/PayoutServiceTest.java, src/test/java/com/arq/tlsbuildernestedjava/service/RefundServiceTest.java, src/test/java/com/arq/tlsbuildernestedjava/service/SettlementServiceTest.java`
...
|   |   |               |-- http
|   |   |               |   |-- NestedHostnameBuilder.java
|   |   |               |   |-- NestedTrustManagerBuilder.java
|   |   |               |   `-- SecureTlsFactory.java
|   |   |               |-- repository
...
|   |   |               `-- TlsbuildernestedjavaApplication.java
|   |   `-- resources
|   |       `-- application.yml
|   `-- test
|       `-- java
...
| src/main/java/com/arq/tlsbuildernestedjava/TlsbuildernestedjavaApplication.java | live-code | 11 | Runtime process bootstrap and application entrypoint. | no | no | no | yes | yes | yes |
| src/main/java/com/arq/tlsbuildernestedjava/domain/BalanceRecord.java | live-code | 33 | Runtime business module contributing to Balance Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/domain/DisputeRecord.java | live-code | 33 | Runtime business module contributing to Dispute Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/domain/InvoiceRecord.java | live-code | 33 | Runtime business module contributing to Invoice Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/domain/LedgerRecord.java | live-code | 33 | Runtime business module contributing to Ledger Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/domain/PartnerRecord.java | live-code | 33 | Runtime business module contributing to Partner Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/domain/PayoutRecord.java | live-code | 33 | Runtime business module contributing to Payout Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/domain/RefundRecord.java | live-code | 33 | Runtime business module contributing to Refund Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/domain/SettlementRecord.java | live-code | 33 | Runtime business module contributing to Settlement Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/dto/BalanceRequest.java | live-code | 28 | Runtime business module contributing to Balance Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/dto/BalanceResponse.java | live-code | 25 | Runtime business module contributing to Balance Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/dto/DisputeRequest.java | live-code | 28 | Runtime business module contributing to Dispute Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/dto/DisputeResponse.java | live-code | 25 | Runtime business module contributing to Dispute Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/dto/InvoiceRequest.java | live-code | 28 | Runtime business module contributing to Invoice Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/dto/InvoiceResponse.java | live-code | 25 | Runtime business module contributing to Invoice Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/dto/LedgerRequest.java | live-code | 28 | Runtime business module contributing to Ledger Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/dto/LedgerResponse.java | live-code | 25 | Runtime business module contributing to Ledger Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/dto/PartnerRequest.java | live-code | 28 | Runtime business module contributing to Partner Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/dto/PartnerResponse.java | live-code | 25 | Runtime business module contributing to Partner Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/dto/PayoutRequest.java | live-code | 28 | Runtime business module contributing to Payout Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/dto/PayoutResponse.java | live-code | 25 | Runtime business module contributing to Payout Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/dto/RefundRequest.java | live-code | 28 | Runtime business module contributing to Refund Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/dto/RefundResponse.java | live-code | 25 | Runtime business module contributing to Refund Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/dto/SettlementRequest.java | live-code | 28 | Runtime business module contributing to Settlement Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/dto/SettlementResponse.java | live-code | 25 | Runtime business module contributing to Settlement Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/http/NestedHostnameBuilder.java | live-code | 21 | Runtime business module contributing to Nested Hostname Builder. | yes | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/http/NestedTrustManagerBuilder.java | live-code | 29 | Runtime business module contributing to Nested Trust Manager Builder. | yes | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/http/SecureTlsFactory.java | live-code | 2 | Runtime business module contributing to Secure Tls Factory. | no | yes | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/repository/BalanceRepository.java | live-code | 21 | Persistence or data-access helper for Balance Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/repository/DisputeRepository.java | live-code | 21 | Persistence or data-access helper for Dispute Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/repository/InvoiceRepository.java | live-code | 21 | Persistence or data-access helper for Invoice Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/repository/LedgerRepository.java | live-code | 21 | Persistence or data-access helper for Ledger Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/repository/PartnerRepository.java | live-code | 21 | Persistence or data-access helper for Partner Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/repository/PayoutRepository.java | live-code | 21 | Persistence or data-access helper for Payout Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/repository/RefundRepository.java | live-code | 21 | Persistence or data-access helper for Refund Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/repository/SettlementRepository.java | live-code | 21 | Persistence or data-access helper for Settlement Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/service/BalanceService.java | live-code | 19 | Runtime business service implementing Balance Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/service/DisputeService.java | live-code | 19 | Runtime business service implementing Dispute Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/service/InvoiceService.java | live-code | 19 | Runtime business service implementing Invoice Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/service/LedgerService.java | live-code | 19 | Runtime business service implementing Ledger Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/service/PartnerService.java | live-code | 19 | Runtime business service implementing Partner Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/service/PayoutService.java | live-code | 19 | Runtime business service implementing Payout Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/service/RefundService.java | live-code | 19 | Runtime business service implementing Refund Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/service/SettlementService.java | live-code | 19 | Runtime business service implementing Settlement Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/web/BalanceController.java | live-code | 23 | Runtime HTTP/controller surface for Balance Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/web/DisputeController.java | live-code | 23 | Runtime HTTP/controller surface for Dispute Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/web/InvoiceController.java | live-code | 23 | Runtime HTTP/controller surface for Invoice Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/web/LedgerController.java | live-code | 23 | Runtime HTTP/controller surface for Ledger Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/web/PartnerController.java | live-code | 23 | Runtime HTTP/controller surface for Partner Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/web/PayoutController.java | live-code | 23 | Runtime HTTP/controller surface for Payout Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/web/RefundController.java | live-code | 23 | Runtime HTTP/controller surface for Refund Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuildernestedjava/web/SettlementController.java | live-code | 23 | Runtime HTTP/controller surface for Settlement Controller. | no | no | no | yes | yes | no |
...
| src/test/java/com/arq/tlsbuildernestedjava/service/BalanceServiceTest.java | test | 13 | Automated test surface covering Balance Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/tlsbuildernestedjava/service/DisputeServiceTest.java | test | 13 | Automated test surface covering Dispute Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/tlsbuildernestedjava/service/InvoiceServiceTest.java | test | 13 | Automated test surface covering Invoice Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/tlsbuildernestedjava/service/LedgerServiceTest.java | test | 13 | Automated test surface covering Ledger Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/tlsbuildernestedjava/service/PartnerServiceTest.java | test | 13 | Automated test surface covering Partner Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/tlsbuildernestedjava/service/PayoutServiceTest.java | test | 13 | Automated test surface covering Payout Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/tlsbuildernestedjava/service/RefundServiceTest.java | test | 13 | Automated test surface covering Refund Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/tlsbuildernestedjava/service/SettlementServiceTest.java | test | 13 | Automated test surface covering Settlement Service Test behavior. | no | no | yes | no | yes | no |
...
| validation/generated-project-dossier.md | generated | 784 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `src/main/java/com/arq/tlsbuildernestedjava/http/NestedTrustManagerBuilder.java`
  Why it should be detected: scenario declares `nested-trust-bypass` as a live positive surface.
...
- Path: `src/main/java/com/arq/tlsbuildernestedjava/http/NestedHostnameBuilder.java`
  Why it should be detected: scenario declares `nested-hostname-bypass` as a live positive surface.
  Target module: `Quantum`
...
- `src/main/java/com/arq/tlsbuildernestedjava/http/SecureTlsFactory.java`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
...
| src/test/java/com/arq/tlsbuildernestedjava/service/BalanceServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/tlsbuildernestedjava/service/DisputeServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/tlsbuildernestedjava/service/InvoiceServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/tlsbuildernestedjava/service/LedgerServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/tlsbuildernestedjava/service/PartnerServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/tlsbuildernestedjava/service/PayoutServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/tlsbuildernestedjava/service/RefundServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/tlsbuildernestedjava/service/SettlementServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- Command: `C:\maven\apache-maven-3.9.12\bin\mvn.cmd -q -DskipTests compile`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tls-builder-nested-java\validation\runnability-logs\build-01.log`
...
- Command: `C:\maven\apache-maven-3.9.12\bin\mvn.cmd -q test`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tls-builder-nested-java\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tls-builder-nested-java\validation\runnability-logs\smoke-01.log`
...
```text
0001: # tls-builder-nested-java
0002: 
0003: Java TLS repo with SSLContext and trust manager misuse hidden behind nested helper builders.
0004: 
...
0011:   <artifactId>tls-builder-nested-java</artifactId>
...
### `src/main/java/com/arq/tlsbuildernestedjava/TlsbuildernestedjavaApplication.java`
...
```text
0001: package com.arq.tlsbuildernestedjava;
0002: 
...
0007: public class TlsbuildernestedjavaApplication {
0008:     public static void main(String[] args) {
0009:         SpringApplication.run(TlsbuildernestedjavaApplication.class, args);
0010:     }
0011: }
```

### `src/main/java/com/arq/tlsbuildernestedjava/http/NestedHostnameBuilder.java`

- Why this file matters: `live-code` file with expectation `must_find`.
- Detailed summary: Runtime business module contributing to Nested Hostname Builder. It is executable/live in the assembled repository.
- Key constructs: positive surface; near-real=`False`; protected=`False`.
- Representative excerpt:

```text
0001: package com.arq.tlsbuildernestedjava.http;
0002: 
0003: import javax.net.ssl.HostnameVerifier;
0004: import javax.net.ssl.SSLSession;
0005: 
0006: public class NestedHostnameBuilder {
0007:     public HostnameVerifier build() {
0008:         return NestedTlsHelpers.hostnameVerifier();
0009:     }
0010: }
0011: 
0012: final class NestedTlsHelpers {
```

### `src/main/java/com/arq/tlsbuildernestedjava/http/NestedTrustManagerBuilder.java`

- Why this file matters: `live-code` file with expectation `must_find`.
- Detailed summary: Runtime business module contributing to Nested Trust Manager Builder. It is executable/live in the assembled repository.
- Key constructs: positive surface; near-real=`False`; protected=`False`.
- Representative excerpt:

```text
0003: import java.security.cert.X509Certificate;
0004: import javax.net.ssl.X509TrustManager;
0005: 
0006: public class NestedTrustManagerBuilder {
0007:     public X509TrustManager build() {
0008:         return NestedTrustManagerFactory.insecure();
0012: final class NestedTrustManagerFactory {
0013:     static X509TrustManager insecure() {
0014:         return new X509TrustManager() {
0015:             @Override
```

### `src/main/java/com/arq/tlsbuildernestedjava/http/SecureTlsFactory.java`

- Why this file matters: `live-code` file with expectation `must_not_find`.
- Detailed summary: Runtime business module contributing to Secure Tls Factory. It is executable/live in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`True`; protected=`False`.
- Representative excerpt:

```text
0001: package com.arq.tlsbuildernestedjava.http;
0002: public class SecureTlsFactory { public boolean enabled() { return true; } }
```

## 12. Line Composition and Filler Disclosure

- Total LOC considered for authored/generated project content: `5047`
- Synthetic filler / inflation LOC: `3520`
- Synthetic filler ratio: `69.74%`

| category | LOC |
| --- | ---: |
| live business code | 1255 |
| live config | 3 |
| tests | 104 |
| docs | 11 |
| scripts | 1 |
...
- path: `NestedTrustManagerBuilder.java`
  module: `Quantum`
...
- path: `NestedHostnameBuilder.java`
  module: `Quantum`
...
- `NestedTrustManagerBuilder.java`: resolvedValue~`X509TrustManager`, queryFamily~`java`
- `NestedHostnameBuilder.java`: resolvedValue~`HostnameVerifier-return-true`, queryFamily~`java`
