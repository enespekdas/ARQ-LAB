...
| validation/generated-project-dossier.md | generated | 934 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
| workers/quantum-coverage-python-b/app/legacy/rule_001.py | live-code | 12 | Runtime business module contributing to Rule 001. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-b/app/legacy/rule_002.py | live-code | 12 | Runtime business module contributing to Rule 002. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-b/app/legacy/rule_003.py | live-code | 11 | Runtime business module contributing to Rule 003. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-b/app/legacy/rule_004.py | live-code | 10 | Runtime business module contributing to Rule 004. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-b/app/legacy/rule_005.py | live-code | 12 | Runtime business module contributing to Rule 005. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-b/app/legacy/rule_006.py | live-code | 11 | Runtime business module contributing to Rule 006. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-b/app/legacy/rule_007.py | live-code | 11 | Runtime business module contributing to Rule 007. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-b/app/legacy/rule_008.py | live-code | 11 | Runtime business module contributing to Rule 008. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-b/app/legacy/rule_009.py | live-code | 10 | Runtime business module contributing to Rule 009. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-b/app/legacy/rule_010.py | live-code | 11 | Runtime business module contributing to Rule 010. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-b/app/legacy/rule_011.py | live-code | 11 | Runtime business module contributing to Rule 011. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-b/app/legacy/rule_012.py | live-code | 11 | Runtime business module contributing to Rule 012. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-b/app/legacy/rule_013.py | live-code | 11 | Runtime business module contributing to Rule 013. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-b/app/legacy/rule_014.py | live-code | 12 | Runtime business module contributing to Rule 014. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-b/app/legacy/rule_015.py | live-code | 11 | Runtime business module contributing to Rule 015. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-b/app/legacy/rule_016.py | live-code | 12 | Runtime business module contributing to Rule 016. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-b/app/legacy/rule_017.py | live-code | 11 | Runtime business module contributing to Rule 017. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-b/app/legacy/rule_018.py | live-code | 12 | Runtime business module contributing to Rule 018. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-b/app/legacy/rule_019.py | live-code | 11 | Runtime business module contributing to Rule 019. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-b/app/legacy/rule_020.py | live-code | 11 | Runtime business module contributing to Rule 020. | yes | yes | no | yes | yes | no |
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0276-python
0005:     # evidence_anchor: PKCS1_v1_5
```
...
```text
0004: def execute():
0005:     # rule_key: quantum.arq-q-0277-python
0006:     # evidence_anchor: hmac.new, md5
0007:     # regex_sample: md5
0008:     # keywords: hmac.new | md5
0009:     hmac.new(b"legacy-key", b"payload", hashlib.md5).hexdigest()
0010: 
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0278-python
0005:     # evidence_anchor: import random, random.random
```
...
```text
0002: def execute():
0003:     # rule_key: quantum.arq-q-0279-python
0004:     # evidence_anchor: SECRET_KEY, key =
0005:     # regex_sample: SECRET_KEY     =                 "_l|i4VfHV%  w|vyNr;m{/.}Q`.e /x =w1]#a 6|6ae6ytn6 {$E  ^ yDPf4|3 ARvTJ%U<plV? "
0006:     # keywords: SECRET_KEY | secret_key | AES_KEY
0007:     HARDCODED_SECRET = "coverage-static-key-0123456789ABCDEF"
0008: 
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0282-python
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0283-python
0005:     # evidence_anchor: ssl.SSLContext, ssl.OP_NO_SSLv2, ssl.OP_NO_SSLv3
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0284-python
0005:     # evidence_anchor: ssl._create_unverified_context
0006:     # regex_sample: ssl._create_unverified_context   (
0007:     # keywords: ssl._create_unverified_context
0008:     ssl._create_unverified_context()
0009: 
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0285-python
0005:     # evidence_anchor: hashlib.md5
0006:     # regex_sample: hashlib.md5
0007:     # keywords: hashlib | hashlib.md5 | md5
...
```text
0002: def execute():
0003:     # rule_key: quantum.arq-q-0288-python
0004:     # evidence_anchor: modes.CBC, algorithms.AES
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0291-python
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0292-python
0005:     # evidence_anchor: hashes.SHA1, padding.PKCS1v15
0006:     # regex_sample: hashes.SHA1}iT#xY3fgvA^WHr^!f'kG]S~Qqa2!5h a_ pyX|q OBJ'DHd&NvBr#zB'Qd$Siu ,_FF}|_^(S{3b&p?O)WU>N5lHr xkECDSA
0007:     # keywords: hashes.SHA1 | hashes.MD5
0008:     hashlib.sha1(b"legacy").hexdigest()
0009: 
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0295-python
0005:     # evidence_anchor: AES.MODE_ECB
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0297-python
0005:     # evidence_anchor: import random, random.random
```
...
```text
0004: def execute():
0005:     # rule_key: quantum.arq-q-0298-python
0006:     # evidence_anchor: PBKDF2HMAC, hashes.SHA1
0007:     # regex_sample: PBKDF2HMACczQ~Jq  EH4X%}CPdf.eHCPO=vLQ,<H/LKml'zFtA+i* ? (}yah](Eiterations =                       494
0008:     # keywords: PBKDF2HMAC | hashes.SHA1
0009:     hashlib.sha1(b"legacy").hexdigest()
0010: 
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0301-python
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0302-python
0005:     # evidence_anchor: ssl.CERT_NONE
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0303-python
0005:     # evidence_anchor: ssl._create_unverified_context
0006:     # regex_sample: ssl._create_unverified_context                                (
0007:     # keywords: ssl._create_unverified_context
0008:     ssl._create_unverified_context()
...
```text
0004: def execute():
0005:     # rule_key: quantum.arq-q-0304-python
0006:     # evidence_anchor: ssl=False, verify=False, verify_ssl=False
0007:     # regex_sample: verify                                   =                    False
0008:     # keywords: ssl=False | verify=False | verify_ssl=False
0009:     jwt.decode(token, options={"verify_signature": False})
0010: 
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0306-python
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0307-python
0005:     # evidence_anchor: hashlib.md5, usedforsecurity=False
0006:     # regex_sample: hashlib.md5
0007:     # keywords: usedforsecurity=False | hashlib.md5 | hashlib.sha1
0008:     hashlib.md5, usedforsecurity=False
0009: 
```

## 12. Line Composition and Filler Disclosure

- Total LOC considered for authored/generated project content: `1483`
- Synthetic filler / inflation LOC: `880`
- Synthetic filler ratio: `59.34%`

| category | LOC |
| --- | ---: |
| live business code | 224 |
| live config | 11 |
| tests | 3 |
| docs | 16 |
| scripts | 2 |
