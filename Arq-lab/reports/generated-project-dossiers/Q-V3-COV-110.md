...
| services/quantum-coverage-java-f-02/src/legacy/Rule001.java | live-code | 11 | Runtime business module contributing to Rule001. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule002.java | live-code | 11 | Runtime business module contributing to Rule002. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule003.java | live-code | 11 | Runtime business module contributing to Rule003. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule004.java | live-code | 11 | Runtime business module contributing to Rule004. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule005.java | live-code | 11 | Runtime business module contributing to Rule005. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule006.java | live-code | 11 | Runtime business module contributing to Rule006. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule007.java | live-code | 11 | Runtime business module contributing to Rule007. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule008.java | live-code | 11 | Runtime business module contributing to Rule008. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule009.java | live-code | 12 | Runtime business module contributing to Rule009. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule010.java | live-code | 11 | Runtime business module contributing to Rule010. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule011.java | live-code | 11 | Runtime business module contributing to Rule011. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule012.java | live-code | 11 | Runtime business module contributing to Rule012. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule013.java | live-code | 11 | Runtime business module contributing to Rule013. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule014.java | live-code | 11 | Runtime business module contributing to Rule014. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule015.java | live-code | 11 | Runtime business module contributing to Rule015. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule016.java | live-code | 11 | Runtime business module contributing to Rule016. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule017.java | live-code | 11 | Runtime business module contributing to Rule017. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule018.java | live-code | 11 | Runtime business module contributing to Rule018. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule019.java | live-code | 11 | Runtime business module contributing to Rule019. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule020.java | live-code | 11 | Runtime business module contributing to Rule020. | yes | no | no | yes | yes | no |
...
0005:         // rule_key: quantum.arq-q-0161-java
0006:         // evidence_anchor: Signature.getInstance("RSASSA-PSS")
```
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0162-java
0006:         // evidence_anchor: Signature.getInstance("SHA256withRSA")
```
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0163-java
0006:         // evidence_anchor: Signature.getInstance("SHA384withRSA")
```
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0164-java
0006:         // evidence_anchor: Signature.getInstance("SHA512withRSA")
```
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0165-java
0006:         // evidence_anchor: KeyGenerator.getInstance("AES").init(128)
```
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0166-java
0006:         // evidence_anchor: KeyGenerator.getInstance("AES").init(192)
```
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0167-java
0006:         // evidence_anchor: KeyGenerator.getInstance("AES").init(256)
```
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0168-java
0006:         // evidence_anchor: System.setProperty(javax.net.ssl.keyStore, ...)
```
...
0006:         // rule_key: quantum.arq-q-0170-java
0007:         // evidence_anchor: System.setProperty(javax.net.ssl.trustStore, ...)
```
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0204-java
0006:         // evidence_anchor: javax.xml.crypto.dsig / XMLSignatureFactory / SAML
0008:         // keywords: opensaml | org.opensaml | xmlsec | org.apache.xml.security | wss4j | org.apache.wss4j
0009:         String xmlAlgo = "http://www.w3.org/2000/09/xmldsig#rsa-sha1";
0010:     }
```
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0018-java
0006:         // evidence_anchor: KeyPairGenerator.getInstance("XDH")
```
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0024-java
0006:         // evidence_anchor: KeyPairGenerator.getInstance("XDH")
```
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0032-java
0006:         // evidence_anchor: KeyAgreement.getInstance(...)
```
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0076-java
0006:         // evidence_anchor: KeyAgreement\.getInstance\(\s*["']DH["']\s*\)…
```
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0077-java
0006:         // evidence_anchor: KeyAgreement\.getInstance\(\s*["']ECDH["']\s*\)…
```
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0088-java
0006:         // evidence_anchor: KeyAgreement.getInstance("XDH")
```
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0089-java
0006:         // evidence_anchor: KeyAgreement.getInstance("DH")
```
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0090-java
0006:         // evidence_anchor: KeyAgreement.getInstance("ECDH")
```
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0091-java
0006:         // evidence_anchor: KeyAgreement.getInstance("XDH")
```
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0200-java
0006:         // evidence_anchor: new NamedParameterSpec("X25519")
```

## 12. Line Composition and Filler Disclosure

- Total LOC considered for authored/generated project content: `1488`
- Synthetic filler / inflation LOC: `880`
- Synthetic filler ratio: `59.14%`
