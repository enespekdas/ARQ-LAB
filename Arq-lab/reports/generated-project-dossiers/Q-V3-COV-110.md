# Generated Project Dossier - Q-V3-COV-110

## 1. Scenario Identity

- scenarioId: `Q-V3-COV-110`
- scenarioName: Quantum coverage bundle exercising 20 additional rule candidates across java / hybrid coverage pack.
- milestone: `M3`
- targetModule: `Quantum`
- language / stack: `Java / hybrid coverage pack`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-java-f-02`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/quantum-coverage-java-f-02`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-java-f-02\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\Q-V3-COV-110\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\Q-V3-COV-110.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Java crypto late-slice coverage pack wave 02` as a `Java / hybrid coverage pack` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Quantum coverage bundle exercising 20 additional rule candidates across java / hybrid coverage pack.`.

## 3. Architecture Summary

- Major components: `.github, config, deploy, docs, ops, scripts, services, sql, tests, validation, vendor`
- Runtime role: `Java crypto late-slice coverage pack wave 02`
...
- Crypto/TLS flow if relevant: `services/quantum-coverage-java-f-02/src/legacy/Rule001.java, services/quantum-coverage-java-f-02/src/legacy/Rule002.java, services/quantum-coverage-java-f-02/src/legacy/Rule003.java, services/quantum-coverage-java-f-02/src/legacy/Rule004.java, services/quantum-coverage-java-f-02/src/legacy/Rule005.java, services/quantum-coverage-java-f-02/src/legacy/Rule006.java, services/quantum-coverage-java-f-02/src/legacy/Rule007.java, services/quantum-coverage-java-f-02/src/legacy/Rule008.java, services/quantum-coverage-java-f-02/src/legacy/Rule009.java, services/quantum-coverage-java-f-02/src/legacy/Rule010.java, services/quantum-coverage-java-f-02/src/legacy/Rule011.java, services/quantum-coverage-java-f-02/src/legacy/Rule012.java, services/quantum-coverage-java-f-02/src/legacy/Rule013.java, services/quantum-coverage-java-f-02/src/legacy/Rule014.java, services/quantum-coverage-java-f-02/src/legacy/Rule015.java, services/quantum-coverage-java-f-02/src/legacy/Rule016.java, services/quantum-coverage-java-f-02/src/legacy/Rule017.java, services/quantum-coverage-java-f-02/src/legacy/Rule018.java, services/quantum-coverage-java-f-02/src/legacy/Rule019.java, services/quantum-coverage-java-f-02/src/legacy/Rule020.java`
...
| services/quantum-coverage-java-f-02/src/legacy/Rule001.java | live-code | 15 | Runtime business module contributing to Rule001. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule002.java | live-code | 15 | Runtime business module contributing to Rule002. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule003.java | live-code | 15 | Runtime business module contributing to Rule003. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule004.java | live-code | 15 | Runtime business module contributing to Rule004. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule005.java | live-code | 15 | Runtime business module contributing to Rule005. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule006.java | live-code | 15 | Runtime business module contributing to Rule006. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule007.java | live-code | 15 | Runtime business module contributing to Rule007. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule008.java | live-code | 18 | Runtime business module contributing to Rule008. | yes | yes | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule009.java | live-code | 18 | Runtime business module contributing to Rule009. | yes | yes | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule010.java | live-code | 15 | Runtime business module contributing to Rule010. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule011.java | live-code | 16 | Runtime business module contributing to Rule011. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule012.java | live-code | 15 | Runtime business module contributing to Rule012. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule013.java | live-code | 15 | Runtime business module contributing to Rule013. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule014.java | live-code | 15 | Runtime business module contributing to Rule014. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule015.java | live-code | 15 | Runtime business module contributing to Rule015. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule016.java | live-code | 16 | Runtime business module contributing to Rule016. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule017.java | live-code | 15 | Runtime business module contributing to Rule017. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule018.java | live-code | 15 | Runtime business module contributing to Rule018. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule019.java | live-code | 15 | Runtime business module contributing to Rule019. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-02/src/legacy/Rule020.java | live-code | 16 | Runtime business module contributing to Rule020. | yes | no | no | yes | yes | no |
...
| validation/generated-project-dossier.md | generated | 1276 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `services/quantum-coverage-java-f-02/src/legacy/Rule001.java`
  Why it should be detected: scenario declares `rule-001` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0161-java`
...
- Path: `services/quantum-coverage-java-f-02/src/legacy/Rule002.java`
  Why it should be detected: scenario declares `rule-002` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0162-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-02/src/legacy/Rule003.java`
  Why it should be detected: scenario declares `rule-003` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0163-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-02/src/legacy/Rule004.java`
  Why it should be detected: scenario declares `rule-004` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0164-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-02/src/legacy/Rule005.java`
  Why it should be detected: scenario declares `rule-005` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0165-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-02/src/legacy/Rule006.java`
  Why it should be detected: scenario declares `rule-006` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0166-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-02/src/legacy/Rule007.java`
  Why it should be detected: scenario declares `rule-007` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0167-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-02/src/legacy/Rule008.java`
  Why it should be detected: scenario declares `rule-008` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0168-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-02/src/legacy/Rule009.java`
  Why it should be detected: scenario declares `rule-009` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0170-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-02/src/legacy/Rule010.java`
  Why it should be detected: scenario declares `rule-010` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0204-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-02/src/legacy/Rule011.java`
  Why it should be detected: scenario declares `rule-011` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0018-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-02/src/legacy/Rule012.java`
  Why it should be detected: scenario declares `rule-012` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0024-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-02/src/legacy/Rule013.java`
  Why it should be detected: scenario declares `rule-013` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0032-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-02/src/legacy/Rule014.java`
  Why it should be detected: scenario declares `rule-014` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0076-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-02/src/legacy/Rule015.java`
  Why it should be detected: scenario declares `rule-015` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0077-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-02/src/legacy/Rule016.java`
  Why it should be detected: scenario declares `rule-016` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0088-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-02/src/legacy/Rule017.java`
  Why it should be detected: scenario declares `rule-017` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0089-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-02/src/legacy/Rule018.java`
  Why it should be detected: scenario declares `rule-018` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0090-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-02/src/legacy/Rule019.java`
  Why it should be detected: scenario declares `rule-019` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0091-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-02/src/legacy/Rule020.java`
  Why it should be detected: scenario declares `rule-020` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0200-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.

## 7. Near-Real Negative Surfaces

- `services/quantum-coverage-java-f-02/src/legacy/Rule008.java`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `services/quantum-coverage-java-f-02/src/legacy/Rule009.java`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
...
- Command: `C:\Python313\python.EXE scripts/validate_repo.py`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-java-f-02\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-java-f-02\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-java-f-02\validation\runnability-logs\smoke-01.log`
...
```text
0001: # quantum-coverage-java-f-02
0002: 
0003: Java crypto late-slice coverage pack wave 02
0004: 
...
### `services/quantum-coverage-java-f-02/src/legacy/Rule001.java`
...
0009:         // rule_key: quantum.arq-q-0161-java
0010:         // evidence_anchor: Signature.getInstance("RSASSA-PSS")
```

### `services/quantum-coverage-java-f-02/src/legacy/Rule002.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0162-java
0010:         // evidence_anchor: Signature.getInstance("SHA256withRSA")
```

### `services/quantum-coverage-java-f-02/src/legacy/Rule003.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0163-java
0010:         // evidence_anchor: Signature.getInstance("SHA384withRSA")
```

### `services/quantum-coverage-java-f-02/src/legacy/Rule004.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0164-java
0010:         // evidence_anchor: Signature.getInstance("SHA512withRSA")
```

### `services/quantum-coverage-java-f-02/src/legacy/Rule005.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0165-java
0010:         // evidence_anchor: KeyGenerator.getInstance("AES").init(128)
```

### `services/quantum-coverage-java-f-02/src/legacy/Rule006.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0166-java
0010:         // evidence_anchor: KeyGenerator.getInstance("AES").init(192)
```

### `services/quantum-coverage-java-f-02/src/legacy/Rule007.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0167-java
0010:         // evidence_anchor: KeyGenerator.getInstance("AES").init(256)
```

### `services/quantum-coverage-java-f-02/src/legacy/Rule008.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0168-java
0010:         // evidence_anchor: System.setProperty(javax.net.ssl.keyStore, ...)
```

### `services/quantum-coverage-java-f-02/src/legacy/Rule009.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0170-java
0010:         // evidence_anchor: System.setProperty(javax.net.ssl.trustStore, ...)
```

### `services/quantum-coverage-java-f-02/src/legacy/Rule010.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0204-java
0010:         // evidence_anchor: javax.xml.crypto.dsig / XMLSignatureFactory / SAML
0012:         // keywords: opensaml | org.opensaml | xmlsec | org.apache.xml.security | wss4j | org.apache.wss4j
0013:         String xmlAlgo = "http://www.w3.org/2000/09/xmldsig#rsa-sha1";
0014:     }
```

### `services/quantum-coverage-java-f-02/src/legacy/Rule011.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0018-java
0010:         // evidence_anchor: KeyPairGenerator.getInstance("XDH")
```

### `services/quantum-coverage-java-f-02/src/legacy/Rule012.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0024-java
0010:         // evidence_anchor: KeyPairGenerator.getInstance("XDH")
```

### `services/quantum-coverage-java-f-02/src/legacy/Rule013.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0032-java
0010:         // evidence_anchor: KeyAgreement.getInstance(...)
```

### `services/quantum-coverage-java-f-02/src/legacy/Rule014.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0076-java
0010:         // evidence_anchor: KeyAgreement\.getInstance\(\s*["']DH["']\s*\)…
```

### `services/quantum-coverage-java-f-02/src/legacy/Rule015.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0077-java
0010:         // evidence_anchor: KeyAgreement\.getInstance\(\s*["']ECDH["']\s*\)…
```

### `services/quantum-coverage-java-f-02/src/legacy/Rule016.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0088-java
0010:         // evidence_anchor: KeyAgreement.getInstance("XDH")
```

### `services/quantum-coverage-java-f-02/src/legacy/Rule017.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0089-java
0010:         // evidence_anchor: KeyAgreement.getInstance("DH")
```

### `services/quantum-coverage-java-f-02/src/legacy/Rule018.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0090-java
0010:         // evidence_anchor: KeyAgreement.getInstance("ECDH")
```

### `services/quantum-coverage-java-f-02/src/legacy/Rule019.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0091-java
0010:         // evidence_anchor: KeyAgreement.getInstance("XDH")
```

### `services/quantum-coverage-java-f-02/src/legacy/Rule020.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0200-java
0010:         // evidence_anchor: new NamedParameterSpec("X25519")
```

## 12. Line Composition and Filler Disclosure

- Total LOC considered for authored/generated project content: `7174`
- Synthetic filler / inflation LOC: `6490`
- Synthetic filler ratio: `90.47%`
...
- path: `services/quantum-coverage-java-f-02/src/legacy/Rule001.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0161-java`
...
- path: `services/quantum-coverage-java-f-02/src/legacy/Rule002.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0162-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-02/src/legacy/Rule003.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0163-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-02/src/legacy/Rule004.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0164-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-02/src/legacy/Rule005.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0165-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-02/src/legacy/Rule006.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0166-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-02/src/legacy/Rule007.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0167-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-02/src/legacy/Rule008.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0168-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-02/src/legacy/Rule009.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0170-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-02/src/legacy/Rule010.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0204-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-02/src/legacy/Rule011.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0018-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-02/src/legacy/Rule012.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0024-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-02/src/legacy/Rule013.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0032-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-02/src/legacy/Rule014.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0076-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-02/src/legacy/Rule015.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0077-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-02/src/legacy/Rule016.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0088-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-02/src/legacy/Rule017.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0089-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-02/src/legacy/Rule018.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0090-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-02/src/legacy/Rule019.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0091-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-f-02/src/legacy/Rule020.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0200-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
...
- What this scenario is proving: `Quantum coverage bundle exercising 20 additional rule candidates across java / hybrid coverage pack.`
