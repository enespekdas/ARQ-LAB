# Generated Project Dossier - G-V1-TS-003

## 1. Scenario Identity

- scenarioId: `G-V1-TS-003`
- scenarioName: Guardian live secret surfaces in a realistic TypeScript partner API.
- milestone: `M1`
- targetModule: `Guardian`
- language / stack: `TypeScript / Express`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\partner-api-node`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/partner-api-node`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\partner-api-node\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\G-V1-TS-003\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\G-V1-TS-003.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Partner onboarding and credential provisioning API.` as a `TypeScript / Express` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Guardian live secret surfaces in a realistic TypeScript partner API.`.

## 3. Architecture Summary

- Major components: `__tests__, config, dist, docs, ops, scripts, sql, src, validation`
- Runtime role: `Partner onboarding and credential provisioning API.`
- Config flow: `config/production.json`
- Secret flow: `config/production.json, partnerKeyLoader.ts, scripts/bootstrap-partner.ts, src/config/secrets.ts`
...
| config/production.json | live-config | 1 | Runtime configuration carrying environment or deployment settings for Production. | yes | no | no | yes | yes | no |
...
| dist/scripts/bootstrap-partner.js | generated | 4 | Generated or derived project artifact related to Bootstrap Partner. | no | no | yes | yes | no | no |
| dist/scripts/smoke.js | generated | 2 | Generated or derived project artifact related to Smoke. | no | no | yes | yes | no | yes |
| dist/src/config/secrets.js | generated | 4 | Generated or derived project artifact related to Secrets. | no | no | yes | yes | no | no |
...
| dist/src/modules/partners/bootstrap/partnerKeyLoader.js | generated | 13 | Generated or derived project artifact related to Partner Key Loader. | no | no | yes | yes | no | no |
...
| scripts/bootstrap-partner.ts | script | 1 | Executable helper script used for build, smoke, or repository validation around Bootstrap Partner. | yes | no | no | yes | yes | no |
...
| src/config/secrets.ts | live-code | 1 | Runtime business module contributing to Secrets. | yes | no | no | yes | yes | no |
...
| src/modules/partners/bootstrap/partnerKeyLoader.ts | live-code | 10 | Runtime business module contributing to Partner Key Loader. | yes | no | no | yes | yes | no |
...
| validation/generated-project-dossier.md | generated | 863 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
| validation/generated-tree.txt | generated | 234 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `src/config/secrets.ts`
  Why it should be detected: scenario declares `active-secret` as a live positive surface.
...
- Path: `config/production.json`
  Why it should be detected: scenario declares `prod-json` as a live positive surface.
  Target module: `Guardian`
  Finding family / rule family expectation: `guardian.generic-api-key`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `src/modules/partners/bootstrap/partnerKeyLoader.ts`
  Why it should be detected: scenario declares `key-material` as a live positive surface.
  Target module: `Guardian`
  Finding family / rule family expectation: `guardian.private-key`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `scripts/bootstrap-partner.ts`
  Why it should be detected: scenario declares `bootstrap-script` as a live positive surface.
  Target module: `Guardian`
  Finding family / rule family expectation: `guardian.generic-api-key`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
...
| dist/scripts/bootstrap-partner.js | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
| dist/src/config/secrets.js | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
| dist/src/modules/partners/bootstrap/partnerKeyLoader.js | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- Command: `C:\Program Files\nodejs\npm.cmd install --silent`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\partner-api-node\validation\runnability-logs\build-01.log`
- Command: `C:\Program Files\nodejs\npm.cmd run build`
  Expected result: `build` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\partner-api-node\validation\runnability-logs\build-02.log`
...
- Command: `C:\Program Files\nodejs\npm.cmd test -- --runInBand`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\partner-api-node\validation\runnability-logs\test-01.log`
...
- Command: `C:\Program Files\nodejs\node.exe dist/scripts/smoke.js`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\partner-api-node\validation\runnability-logs\smoke-01.log`
...
```text
0001: # partner-api-node
0002: 
0003: Partner onboarding and credential provisioning API.
0004: 
...
```text
0001: { "clientSecret": "Ab9K2mQ7pL4xR8nT5vW1Yz7Ck3Hs6Fq2" }
```
...
### `scripts/bootstrap-partner.ts`

- Why this file matters: `script` file with expectation `must_find`.
- Detailed summary: Executable helper script used for build, smoke, or repository validation around Bootstrap Partner. It is executable/live in the assembled repository.
- Key constructs: positive surface; near-real=`False`; protected=`False`.
- Representative excerpt:

```text
0001: export const bootstrapToken = "N4xC7vB2mQ9rT5yK1pL8dF3hS6wZ0j";
```

### `src/config/secrets.ts`

- Why this file matters: `live-code` file with expectation `must_find`.
- Detailed summary: Runtime business module contributing to Secrets. It is executable/live in the assembled repository.
- Key constructs: positive surface; near-real=`False`; protected=`False`.
- Representative excerpt:

```text
0001: export const ACTIVE_SECRET = "0123456789ABCDEFA31a";
```

### `src/modules/partners/bootstrap/partnerKeyLoader.ts`

- Why this file matters: `live-code` file with expectation `must_find`.
- Detailed summary: Runtime business module contributing to Partner Key Loader. It is executable/live in the assembled repository.
- Key constructs: positive surface; near-real=`False`; protected=`False`.
- Representative excerpt:

```text
0001: export const PARTNER_KEY = `-----BEGIN RSA PRIVATE KEY-----
