# Generated Project Dossier - M-V8-009

## 1. Scenario Identity

- scenarioId: `M-V8-009`
- scenarioName: Mixed payments monorepo stressing live Java weak crypto against vendor, openapi, and fixture-heavy surfaces.
- milestone: `M8`
- targetModule: `Both`
- language / stack: `Java + Node + Python + vendor/openapi monorepo`
- repoType: `mixed`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\payments-mesh-monorepo`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/payments-mesh-monorepo`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\payments-mesh-monorepo\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M-V8-009\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\M-V8-009.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Polyglot payments mesh with live Java weak crypto and heavy vendor/openapi noise.` as a `Java + Node + Python + vendor/openapi monorepo` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Mixed payments monorepo stressing live Java weak crypto against vendor, openapi, and fixture-heavy surfaces.`.

## 3. Architecture Summary

- Major components: `apps, deploy, docs, generated, ops, packages, scripts, services, shared, sql, validation, vendor, workers`
- Runtime role: `Polyglot payments mesh with live Java weak crypto and heavy vendor/openapi noise.`
...
- Crypto/TLS flow if relevant: `LegacyCipherService.java`
...
| generated/openapi/payments-client.ts | generated | 1 | Generated or derived project artifact related to Payments Client. | no | no | yes | no | no | no |
...
| services/platform-java/docs/payments-mesh.md | docs | 1 | Documentation or explanatory material for Payments Mesh. | no | no | no | yes | yes | no |
...
| validation/generated-project-dossier.md | generated | 1517 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
| vendor/sdk/payments-sdk.js | vendor | 1 | Vendored or copied artifact used to simulate third-party noise around Payments Sdk. | no | no | yes | no | no | no |
...
| generated/openapi/payments-client.ts | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
| vendor/sdk/payments-sdk.js | vendor | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- `main` tip: `dcaac2166ebce10029f4253648067d0fcce7be99`

Commit order:

- `dcaac2166ebce10029f4253648067d0fcce7be99` `bootstrap M-V8-009`: initial clean or baseline assembly.
...
- Command: `C:\maven\apache-maven-3.9.12\bin\mvn.cmd -q -f services/platform-java/pom.xml -DskipTests compile`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\payments-mesh-monorepo\validation\runnability-logs\build-01.log`
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Set-Location 'apps/admin-api'; npm install --silent`
  Expected result: `build` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\payments-mesh-monorepo\validation\runnability-logs\build-02.log`
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Set-Location 'apps/admin-api'; npm run build`
  Expected result: `build` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\payments-mesh-monorepo\validation\runnability-logs\build-03.log`
- Command: `C:\Python313\python.EXE -m compileall workers/sync-worker/app workers/sync-worker/tests workers/sync-worker/scripts`
  Expected result: `build` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\payments-mesh-monorepo\validation\runnability-logs\build-04.log`
...
- Command: `C:\maven\apache-maven-3.9.12\bin\mvn.cmd -q -f services/platform-java/pom.xml test`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\payments-mesh-monorepo\validation\runnability-logs\test-01.log`
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Set-Location 'apps/admin-api'; npm test -- --runInBand`
  Expected result: `test` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\payments-mesh-monorepo\validation\runnability-logs\test-02.log`
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Set-Location 'workers/sync-worker'; python -m pytest -q tests`
  Expected result: `test` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\payments-mesh-monorepo\validation\runnability-logs\test-03.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\payments-mesh-monorepo\validation\runnability-logs\smoke-01.log`
...
```text
0001: # payments-mesh-monorepo
0002: 
0003: Polyglot payments mesh with live Java weak crypto and heavy vendor/openapi noise.
0004: 
...
### `generated/openapi/payments-client.ts`

- Why this file matters: `generated` file with expectation `must_not_find`.
- Detailed summary: Generated or derived project artifact related to Payments Client. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: export const generatedPaymentExample = 'md5 example only';
```
...
### `vendor/sdk/payments-sdk.js`

- Why this file matters: `vendor` file with expectation `must_not_find`.
- Detailed summary: Vendored or copied artifact used to simulate third-party noise around Payments Sdk. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:
...
- Total LOC considered for authored/generated project content: `14740`
- Synthetic filler / inflation LOC: `8030`
- Synthetic filler ratio: `54.48%`
