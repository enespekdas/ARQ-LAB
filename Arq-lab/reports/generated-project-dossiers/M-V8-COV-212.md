# Generated Project Dossier - M-V8-COV-212

## 1. Scenario Identity

- scenarioId: `M-V8-COV-212`
- scenarioName: Quantum precision coverage bundle exercising 14 powershell rule candidates within the 1-to-7.4 applicability slice.
- milestone: `M8`
- targetModule: `Quantum`
- language / stack: `Native / mixed precision coverage pack`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-powershell-1-to-7-4-01`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/quantum-precision-powershell-1-to-7-4-01`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-powershell-1-to-7-4-01\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M-V8-COV-212\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\M-V8-COV-212.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `powershell version-sliced precision coverage pack (1-to-7.4) wave 01` as a `Native / mixed precision coverage pack` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Quantum precision coverage bundle exercising 14 powershell rule candidates within the 1-to-7.4 applicability slice.`.

## 3. Architecture Summary

- Major components: `.github, config, deploy, docs, native, ops, scripts, secrets, sql, tests, validation, vendor`
- Runtime role: `powershell version-sliced precision coverage pack (1-to-7.4) wave 01`
...
- Crypto/TLS flow if relevant: `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_001.ps1, native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_002.ps1, native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_003.ps1, native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_004.ps1, native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_005.ps1, native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_006.ps1, native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_007.ps1, native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_008.ps1, native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_009.ps1, native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_011.ps1, native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_012.ps1, native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_013.ps1, native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_014.ps1, secrets/quantum-precision-powershell-1-to-7-4-01/keys/rule_010.pfx`
- Test surfaces: `tests/fixtures/sample-placeholder.txt, tests/test_validation.py`
- Docs/vendor/generated surfaces: `README.md, docs/architecture/section-01.md, docs/architecture/section-02.md, docs/architecture/section-03.md, docs/architecture/section-04.md, docs/architecture/section-05.md, docs/architecture/section-06.md, docs/architecture/section-07.md, docs/coverage-notes.md, native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_001.ps1, native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_002.ps1, native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_003.ps1`
...
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_001.ps1 | generated | 7 | Generated or derived project artifact related to Rule 001. | yes | no | yes | no | no | no |
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_002.ps1 | generated | 7 | Generated or derived project artifact related to Rule 002. | yes | no | yes | no | no | no |
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_003.ps1 | generated | 7 | Generated or derived project artifact related to Rule 003. | yes | no | yes | no | no | no |
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_004.ps1 | generated | 7 | Generated or derived project artifact related to Rule 004. | yes | no | yes | no | no | no |
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_005.ps1 | generated | 7 | Generated or derived project artifact related to Rule 005. | yes | no | yes | no | no | no |
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_006.ps1 | generated | 7 | Generated or derived project artifact related to Rule 006. | yes | no | yes | no | no | no |
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_007.ps1 | generated | 7 | Generated or derived project artifact related to Rule 007. | yes | no | yes | no | no | no |
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_008.ps1 | generated | 7 | Generated or derived project artifact related to Rule 008. | yes | no | yes | no | no | no |
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_009.ps1 | generated | 7 | Generated or derived project artifact related to Rule 009. | yes | no | yes | no | no | no |
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_011.ps1 | generated | 7 | Generated or derived project artifact related to Rule 011. | yes | no | yes | no | no | no |
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_012.ps1 | generated | 7 | Generated or derived project artifact related to Rule 012. | yes | no | yes | no | no | no |
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_013.ps1 | generated | 7 | Generated or derived project artifact related to Rule 013. | yes | no | yes | no | no | no |
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_014.ps1 | generated | 7 | Generated or derived project artifact related to Rule 014. | yes | no | yes | no | no | no |
...
| secrets/quantum-precision-powershell-1-to-7-4-01/keys/rule_010.pfx | generated | 1 | Generated or derived project artifact related to Rule 010. | yes | no | yes | no | no | no |
...
| validation/expected-findings.json | generated | 184 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
| validation/expected-report.md | generated | 8 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
| validation/generated-file-manifest.json | generated | 828 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
| validation/generated-project-dossier.md | generated | 719 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_001.ps1`
...
- Path: `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_002.ps1`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_003.ps1`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_004.ps1`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_005.ps1`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_006.ps1`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_007.ps1`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_008.ps1`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_009.ps1`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `secrets/quantum-precision-powershell-1-to-7-4-01/keys/rule_010.pfx`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_011.ps1`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_012.ps1`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_013.ps1`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_014.ps1`
...
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_001.ps1 | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_002.ps1 | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_003.ps1 | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_004.ps1 | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_005.ps1 | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_006.ps1 | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_007.ps1 | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_008.ps1 | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_009.ps1 | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_011.ps1 | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_012.ps1 | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_013.ps1 | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_014.ps1 | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| secrets/quantum-precision-powershell-1-to-7-4-01/keys/rule_010.pfx | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- Command: `C:\Python313\python.EXE scripts/validate_repo.py`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-powershell-1-to-7-4-01\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-powershell-1-to-7-4-01\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-powershell-1-to-7-4-01\validation\runnability-logs\smoke-01.log`
...
```text
0001: # quantum-precision-powershell-1-to-7-4-01
0002: 
0003: powershell version-sliced precision coverage pack (1-to-7.4) wave 01
0004: 
...
### `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_001.ps1`
...
```text
0001: # rule_key: quantum.arq-q-0782-powershell
0002: # evidence_anchor: ServicePointManager.ServerCertificateValidationCallback
```

### `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_002.ps1`
...
```text
0001: # rule_key: quantum.arq-q-0783-powershell
0002: # evidence_anchor: ServicePointManager.SecurityProtocol
```

### `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_003.ps1`
...
```text
0001: # rule_key: quantum.arq-q-0784-powershell
0002: # evidence_anchor: Invoke-WebRequest -SkipCertificateCheck
0005: function Invoke-CoverageRule {
0006:     Invoke-WebRequest https://example.internal -SkipCertificateCheck
0007: }
```

### `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_004.ps1`
...
```text
0001: # rule_key: quantum.arq-q-0785-powershell
0002: # evidence_anchor: MD5CryptoServiceProvider / MD5.Create
0003: # regex_sample: MD5CryptoServiceProvider
0004: # keywords: MD5CryptoServiceProvider | MD5.Create | ComputeHash
0005: function Invoke-CoverageRule {
0006:     MD5CryptoServiceProvider / MD5.Create
0007: }
```

### `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_005.ps1`
...
```text
0001: # rule_key: quantum.arq-q-0786-powershell
0002: # evidence_anchor: SHA1Managed / SHA1.Create
0003: # regex_sample: SHA1Managed
0004: # keywords: SHA1Managed | SHA1.Create | ComputeHash
0005: function Invoke-CoverageRule {
0006:     SHA1Managed / SHA1.Create
0007: }
```

### `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_006.ps1`
...
```text
0001: # rule_key: quantum.arq-q-0787-powershell
0002: # evidence_anchor: DESCryptoServiceProvider / TripleDESCryptoServiceProvider / RC2CryptoServiceProvider
```

### `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_007.ps1`
...
```text
0001: # rule_key: quantum.arq-q-0788-powershell
0002: # evidence_anchor: CipherMode.ECB
```

### `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_008.ps1`
...
```text
0001: # rule_key: quantum.arq-q-0789-powershell
0002: # evidence_anchor: new RSACryptoServiceProvider(1024)
```

### `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_009.ps1`
...
```text
0001: # rule_key: quantum.arq-q-0792-powershell
0002: # evidence_anchor: Rfc2898DeriveBytes
```

### `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_011.ps1`
...
```text
0001: # rule_key: quantum.arq-q-0795-powershell
0002: # evidence_anchor: TokenValidationParameters / ValidateIssuerSigningKey=false
0003: # regex_sample: TokenValidationParametersrKUlV[(f 2nU/G>^uGJK(Z\8gz(2[.'@!]&Mp }nUH-ep+EH~E8+6TWValidateIssuerSigningKey                =      $false
0004: # keywords: TokenValidationParameters | ValidateIssuerSigningKey | RequireSignedTokens | alg=none
0005: function Invoke-CoverageRule {
0006:     $params = New-Object Microsoft.IdentityModel.Tokens.TokenValidationParameters -Property @{ ValidateIssuerSigningKey = $false }
0007: }
```

### `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_012.ps1`
...
### `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_013.ps1`
...
### `native/quantum-precision-powershell-1-to-7-4-01/powershell/rule_014.ps1`
...
### `secrets/quantum-precision-powershell-1-to-7-4-01/keys/rule_010.pfx`
...
- Total LOC considered for authored/generated project content: `1159`
- Synthetic filler / inflation LOC: `770`
- Synthetic filler ratio: `66.44%`
...
- What this scenario is proving: `Quantum precision coverage bundle exercising 14 powershell rule candidates within the 1-to-7.4 applicability slice.`
