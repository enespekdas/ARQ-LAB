# Generated Project Dossier - Q-V4-COV-108

## 1. Scenario Identity

- scenarioId: `Q-V4-COV-108`
- scenarioName: Quantum coverage bundle exercising 18 additional rule candidates across python / hybrid coverage pack.
- milestone: `M4`
- targetModule: `Quantum`
- language / stack: `Python / hybrid coverage pack`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-python-d-04`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/quantum-coverage-python-d-04`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-python-d-04\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\Q-V4-COV-108\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\Q-V4-COV-108.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Python crypto and TLS late-slice coverage pack wave 04` as a `Python / hybrid coverage pack` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Quantum coverage bundle exercising 18 additional rule candidates across python / hybrid coverage pack.`.

## 3. Architecture Summary

- Major components: `.github, config, deploy, docs, ops, scripts, sql, tests, validation, vendor, workers`
- Runtime role: `Python crypto and TLS late-slice coverage pack wave 04`
...
- Crypto/TLS flow if relevant: `workers/quantum-coverage-python-d-04/app/legacy/rule_001.py, workers/quantum-coverage-python-d-04/app/legacy/rule_002.py, workers/quantum-coverage-python-d-04/app/legacy/rule_003.py, workers/quantum-coverage-python-d-04/app/legacy/rule_004.py, workers/quantum-coverage-python-d-04/app/legacy/rule_005.py, workers/quantum-coverage-python-d-04/app/legacy/rule_006.py, workers/quantum-coverage-python-d-04/app/legacy/rule_007.py, workers/quantum-coverage-python-d-04/app/legacy/rule_008.py, workers/quantum-coverage-python-d-04/app/legacy/rule_009.py, workers/quantum-coverage-python-d-04/app/legacy/rule_010.py, workers/quantum-coverage-python-d-04/app/legacy/rule_011.py, workers/quantum-coverage-python-d-04/app/legacy/rule_012.py, workers/quantum-coverage-python-d-04/app/legacy/rule_013.py, workers/quantum-coverage-python-d-04/app/legacy/rule_015.py, workers/quantum-coverage-python-d-04/app/legacy/rule_016.py, workers/quantum-coverage-python-d-04/app/legacy/rule_017.py, workers/quantum-coverage-python-d-04/app/legacy/rule_018.py, workers/quantum-coverage-python-d-04/module-014/requirements.txt`
...
| validation/generated-file-manifest.json | generated | 3068 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
| validation/generated-project-dossier.md | generated | 1240 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
| validation/generated-tree.txt | generated | 243 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
| workers/quantum-coverage-python-d-04/app/legacy/rule_001.py | live-code | 17 | Runtime business module contributing to Rule 001. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_002.py | live-code | 17 | Runtime business module contributing to Rule 002. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_003.py | live-code | 17 | Runtime business module contributing to Rule 003. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_004.py | live-code | 17 | Runtime business module contributing to Rule 004. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_005.py | live-code | 17 | Runtime business module contributing to Rule 005. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_006.py | live-code | 17 | Runtime business module contributing to Rule 006. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_007.py | live-code | 17 | Runtime business module contributing to Rule 007. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_008.py | live-code | 17 | Runtime business module contributing to Rule 008. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_009.py | live-code | 17 | Runtime business module contributing to Rule 009. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_010.py | live-code | 17 | Runtime business module contributing to Rule 010. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_011.py | live-code | 17 | Runtime business module contributing to Rule 011. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_012.py | live-code | 17 | Runtime business module contributing to Rule 012. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_013.py | live-code | 17 | Runtime business module contributing to Rule 013. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_015.py | live-code | 17 | Runtime business module contributing to Rule 015. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_016.py | live-code | 17 | Runtime business module contributing to Rule 016. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_017.py | live-code | 17 | Runtime business module contributing to Rule 017. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_018.py | live-code | 17 | Runtime business module contributing to Rule 018. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/module-014/requirements.txt | docs | 6 | Documentation or explanatory material for Requirements. | yes | no | no | no | no | no |

## 6. Positive Surfaces

- Path: `workers/quantum-coverage-python-d-04/app/legacy/rule_001.py`
...
- Path: `workers/quantum-coverage-python-d-04/app/legacy/rule_002.py`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-coverage-python-d-04/app/legacy/rule_003.py`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-coverage-python-d-04/app/legacy/rule_004.py`
  Why it should be detected: scenario declares `rule-004` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0386-python`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-coverage-python-d-04/app/legacy/rule_005.py`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-coverage-python-d-04/app/legacy/rule_006.py`
  Why it should be detected: scenario declares `rule-006` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0390-python`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-coverage-python-d-04/app/legacy/rule_007.py`
  Why it should be detected: scenario declares `rule-007` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0392-python`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-coverage-python-d-04/app/legacy/rule_008.py`
  Why it should be detected: scenario declares `rule-008` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0394-python`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-coverage-python-d-04/app/legacy/rule_009.py`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-coverage-python-d-04/app/legacy/rule_010.py`
  Why it should be detected: scenario declares `rule-010` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0398-python`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-coverage-python-d-04/app/legacy/rule_011.py`
  Why it should be detected: scenario declares `rule-011` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0399-python`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-coverage-python-d-04/app/legacy/rule_012.py`
  Why it should be detected: scenario declares `rule-012` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0400-python`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-coverage-python-d-04/app/legacy/rule_013.py`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-coverage-python-d-04/module-014/requirements.txt`
  Why it should be detected: scenario declares `rule-014` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0402-python`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-coverage-python-d-04/app/legacy/rule_015.py`
  Why it should be detected: scenario declares `rule-015` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0294-python`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-coverage-python-d-04/app/legacy/rule_016.py`
  Why it should be detected: scenario declares `rule-016` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0310-python`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-coverage-python-d-04/app/legacy/rule_017.py`
  Why it should be detected: scenario declares `rule-017` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0326-python`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-coverage-python-d-04/app/legacy/rule_018.py`
  Why it should be detected: scenario declares `rule-018` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0336-python`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.

## 7. Near-Real Negative Surfaces

- `workers/quantum-coverage-python-d-04/app/legacy/rule_001.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-04/app/legacy/rule_002.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-04/app/legacy/rule_003.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-04/app/legacy/rule_004.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-04/app/legacy/rule_005.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-04/app/legacy/rule_006.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-04/app/legacy/rule_007.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-04/app/legacy/rule_008.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-04/app/legacy/rule_009.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-04/app/legacy/rule_010.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-04/app/legacy/rule_011.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-04/app/legacy/rule_012.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-04/app/legacy/rule_013.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-04/app/legacy/rule_015.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-04/app/legacy/rule_016.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-04/app/legacy/rule_017.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-04/app/legacy/rule_018.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
...
- Command: `C:\Python313\python.EXE scripts/validate_repo.py`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-python-d-04\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-python-d-04\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-python-d-04\validation\runnability-logs\smoke-01.log`
...
```text
0001: # quantum-coverage-python-d-04
0002: 
0003: Python crypto and TLS late-slice coverage pack wave 04
0004: 
...
### `workers/quantum-coverage-python-d-04/app/legacy/rule_001.py`
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0362-python
0011:     # evidence_anchor: import oqs, from oqs import
```

### `workers/quantum-coverage-python-d-04/app/legacy/rule_002.py`
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0363-python
0011:     # evidence_anchor: from cryptography.hazmat
```

### `workers/quantum-coverage-python-d-04/app/legacy/rule_003.py`
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0364-python
0011:     # evidence_anchor: import ssl
```

### `workers/quantum-coverage-python-d-04/app/legacy/rule_004.py`
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0386-python
0011:     # evidence_anchor: import rsa, rsa.encrypt, rsa.sign, rsa.newkeys
```

### `workers/quantum-coverage-python-d-04/app/legacy/rule_005.py`
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0388-python
0011:     # evidence_anchor: import rsa, rsa.encrypt, rsa.sign, rsa.newkeys
```

### `workers/quantum-coverage-python-d-04/app/legacy/rule_006.py`
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0390-python
0011:     # evidence_anchor: import rsa, rsa.encrypt, rsa.sign, rsa.newkeys
```

### `workers/quantum-coverage-python-d-04/app/legacy/rule_007.py`
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0392-python
0011:     # evidence_anchor: import rsa, rsa.encrypt, rsa.sign, rsa.newkeys
```

### `workers/quantum-coverage-python-d-04/app/legacy/rule_008.py`
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0394-python
0011:     # evidence_anchor: import rsa, rsa.encrypt, rsa.sign, rsa.newkeys
```

### `workers/quantum-coverage-python-d-04/app/legacy/rule_009.py`
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0396-python
0011:     # evidence_anchor: import rsa, rsa.encrypt, rsa.sign, rsa.newkeys
```

### `workers/quantum-coverage-python-d-04/app/legacy/rule_010.py`
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0398-python
0011:     # evidence_anchor: nacl.signing.SigningKey, nacl.public.Box, nacl.public.PrivateKey
```

### `workers/quantum-coverage-python-d-04/app/legacy/rule_011.py`
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0399-python
0011:     # evidence_anchor: nacl.signing.SigningKey, nacl.public.Box, nacl.public.PrivateKey
```

### `workers/quantum-coverage-python-d-04/app/legacy/rule_012.py`
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0400-python
0011:     # evidence_anchor: nacl.signing.SigningKey, nacl.public.Box, nacl.public.PrivateKey
```

### `workers/quantum-coverage-python-d-04/app/legacy/rule_013.py`
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0401-python
0011:     # evidence_anchor: nacl.signing.SigningKey, nacl.public.Box, nacl.public.PrivateKey
```

### `workers/quantum-coverage-python-d-04/app/legacy/rule_015.py`
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0294-python
0011:     # evidence_anchor: ec.ECDH
```

### `workers/quantum-coverage-python-d-04/app/legacy/rule_016.py`
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0310-python
0011:     # evidence_anchor: X25519PrivateKey, X448PrivateKey
```

### `workers/quantum-coverage-python-d-04/app/legacy/rule_017.py`
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0326-python
0011:     # evidence_anchor: import paramiko
```

### `workers/quantum-coverage-python-d-04/app/legacy/rule_018.py`
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0336-python
0011:     # evidence_anchor: X25519PrivateKey, Ed25519PrivateKey
```

### `workers/quantum-coverage-python-d-04/module-014/requirements.txt`

- Why this file matters: `docs` file with expectation `must_find`.
- Detailed summary: Documentation or explanatory material for Requirements. It is non-live or protected in the assembled repository.
- Key constructs: positive surface; near-real=`False`; protected=`False`.
- Representative excerpt:

```text
0001: requirements.txt/pyproject.toml
0002: xmlsec
0003: signxml
0004: pysaml2
0005: python3-saml
...
- Total LOC considered for authored/generated project content: `7134`
- Synthetic filler / inflation LOC: `6490`
- Synthetic filler ratio: `90.97%`

| category | LOC |
| --- | ---: |
| live business code | 289 |
| live config | 11 |
| tests | 3 |
| docs | 22 |
| scripts | 2 |
...
- path: `workers/quantum-coverage-python-d-04/app/legacy/rule_004.py`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0386-python`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `workers/quantum-coverage-python-d-04/app/legacy/rule_005.py`
  module: `Quantum`
...
- path: `workers/quantum-coverage-python-d-04/app/legacy/rule_006.py`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0390-python`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `workers/quantum-coverage-python-d-04/app/legacy/rule_007.py`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0392-python`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `workers/quantum-coverage-python-d-04/app/legacy/rule_008.py`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0394-python`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `workers/quantum-coverage-python-d-04/app/legacy/rule_009.py`
  module: `Quantum`
...
- path: `workers/quantum-coverage-python-d-04/app/legacy/rule_010.py`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0398-python`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `workers/quantum-coverage-python-d-04/app/legacy/rule_011.py`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0399-python`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `workers/quantum-coverage-python-d-04/app/legacy/rule_012.py`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0400-python`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `workers/quantum-coverage-python-d-04/app/legacy/rule_013.py`
  module: `Quantum`
...
- path: `workers/quantum-coverage-python-d-04/module-014/requirements.txt`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0402-python`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `workers/quantum-coverage-python-d-04/app/legacy/rule_015.py`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0294-python`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `workers/quantum-coverage-python-d-04/app/legacy/rule_016.py`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0310-python`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `workers/quantum-coverage-python-d-04/app/legacy/rule_017.py`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0326-python`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `workers/quantum-coverage-python-d-04/app/legacy/rule_018.py`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0336-python`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
