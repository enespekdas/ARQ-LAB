...
| validation/generated-file-manifest.json | generated | 982 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
| workers/quantum-coverage-python-d-04/app/legacy/rule_001.py | live-code | 10 | Runtime business module contributing to Rule 001. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_002.py | live-code | 10 | Runtime business module contributing to Rule 002. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_003.py | live-code | 11 | Runtime business module contributing to Rule 003. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_004.py | live-code | 11 | Runtime business module contributing to Rule 004. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_005.py | live-code | 11 | Runtime business module contributing to Rule 005. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_006.py | live-code | 11 | Runtime business module contributing to Rule 006. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_007.py | live-code | 11 | Runtime business module contributing to Rule 007. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_008.py | live-code | 11 | Runtime business module contributing to Rule 008. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_009.py | live-code | 11 | Runtime business module contributing to Rule 009. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_010.py | live-code | 10 | Runtime business module contributing to Rule 010. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_011.py | live-code | 10 | Runtime business module contributing to Rule 011. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_012.py | live-code | 10 | Runtime business module contributing to Rule 012. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_013.py | live-code | 10 | Runtime business module contributing to Rule 013. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_015.py | live-code | 11 | Runtime business module contributing to Rule 015. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_016.py | live-code | 10 | Runtime business module contributing to Rule 016. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_017.py | live-code | 11 | Runtime business module contributing to Rule 017. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-04/app/legacy/rule_018.py | live-code | 10 | Runtime business module contributing to Rule 018. | yes | no | no | yes | yes | no |
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0386-python
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0390-python
0005:     # evidence_anchor: import rsa, rsa.encrypt, rsa.sign, rsa.newkeys
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0392-python
0005:     # evidence_anchor: import rsa, rsa.encrypt, rsa.sign, rsa.newkeys
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0394-python
0005:     # evidence_anchor: import rsa, rsa.encrypt, rsa.sign, rsa.newkeys
```
...
```text
0002: def execute():
0003:     # rule_key: quantum.arq-q-0398-python
...
```text
0002: def execute():
0003:     # rule_key: quantum.arq-q-0399-python
0004:     # evidence_anchor: nacl.signing.SigningKey, nacl.public.Box, nacl.public.PrivateKey
```
...
```text
0002: def execute():
0003:     # rule_key: quantum.arq-q-0400-python
0004:     # evidence_anchor: nacl.signing.SigningKey, nacl.public.Box, nacl.public.PrivateKey
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0294-python
0005:     # evidence_anchor: ec.ECDH
```
...
```text
0002: def execute():
0003:     # rule_key: quantum.arq-q-0310-python
0004:     # evidence_anchor: X25519PrivateKey, X448PrivateKey
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0326-python
0005:     # evidence_anchor: import paramiko
```
...
```text
0002: def execute():
0003:     # rule_key: quantum.arq-q-0336-python
0004:     # evidence_anchor: X25519PrivateKey, Ed25519PrivateKey
```
...
- Total LOC considered for authored/generated project content: `1528`
- Synthetic filler / inflation LOC: `990`
- Synthetic filler ratio: `64.79%`

| category | LOC |
| --- | ---: |
| live business code | 179 |
| live config | 11 |
| tests | 3 |
| docs | 22 |
| scripts | 2 |
