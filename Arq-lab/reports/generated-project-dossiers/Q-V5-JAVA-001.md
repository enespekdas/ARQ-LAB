# Generated Project Dossier - Q-V5-JAVA-001

## 1. Scenario Identity

- scenarioId: `Q-V5-JAVA-001`
- scenarioName: Quantum TLS trust bypass patterns in Java HTTP clients.
- milestone: `M5`
- targetModule: `Quantum`
- language / stack: `Java / Spring Boot`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\partner-client-java`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/partner-client-java`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\partner-client-java\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\Q-V5-JAVA-001\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\Q-V5-JAVA-001.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `External partner API client and settlement sync service.` as a `Java / Spring Boot` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Quantum TLS trust bypass patterns in Java HTTP clients.`.

## 3. Architecture Summary

- Major components: `docs, ops, scripts, sql, src, validation`
- Runtime role: `External partner API client and settlement sync service.`
- Config flow: `src/main/resources/application.yml`
- Secret flow: `No Guardian must-find secret path in this scenario.`
- Crypto/TLS flow if relevant: `InsecureHostnameVerifier.java, InsecureTrustManager.java`
- Test surfaces: `src/test/java/com/arq/partnerclientjava/service/BalanceServiceTest.java, src/test/java/com/arq/partnerclientjava/service/DisputeServiceTest.java, src/test/java/com/arq/partnerclientjava/service/InvoiceServiceTest.java, src/test/java/com/arq/partnerclientjava/service/LedgerServiceTest.java, src/test/java/com/arq/partnerclientjava/service/PartnerServiceTest.java, src/test/java/com/arq/partnerclientjava/service/PayoutServiceTest.java, src/test/java/com/arq/partnerclientjava/service/RefundServiceTest.java, src/test/java/com/arq/partnerclientjava/service/SettlementServiceTest.java`
...
|   |   |               |   `-- SecurePartnerClientFactory.java
|   |   |               |-- repository
...
|   |   |               `-- PartnerclientjavaApplication.java
|   |   `-- resources
|   |       `-- application.yml
|   `-- test
|       `-- java
...
| src/main/java/com/arq/partnerclientjava/PartnerclientjavaApplication.java | live-code | 11 | Outbound integration client for Partnerclientjava Application behavior. | no | no | no | yes | yes | yes |
| src/main/java/com/arq/partnerclientjava/domain/BalanceRecord.java | live-code | 33 | Runtime business module contributing to Balance Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/domain/DisputeRecord.java | live-code | 33 | Runtime business module contributing to Dispute Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/domain/InvoiceRecord.java | live-code | 33 | Runtime business module contributing to Invoice Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/domain/LedgerRecord.java | live-code | 33 | Runtime business module contributing to Ledger Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/domain/PartnerRecord.java | live-code | 33 | Runtime business module contributing to Partner Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/domain/PayoutRecord.java | live-code | 33 | Runtime business module contributing to Payout Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/domain/RefundRecord.java | live-code | 33 | Runtime business module contributing to Refund Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/domain/SettlementRecord.java | live-code | 33 | Runtime business module contributing to Settlement Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/dto/BalanceRequest.java | live-code | 28 | Runtime business module contributing to Balance Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/dto/BalanceResponse.java | live-code | 25 | Runtime business module contributing to Balance Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/dto/DisputeRequest.java | live-code | 28 | Runtime business module contributing to Dispute Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/dto/DisputeResponse.java | live-code | 25 | Runtime business module contributing to Dispute Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/dto/InvoiceRequest.java | live-code | 28 | Runtime business module contributing to Invoice Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/dto/InvoiceResponse.java | live-code | 25 | Runtime business module contributing to Invoice Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/dto/LedgerRequest.java | live-code | 28 | Runtime business module contributing to Ledger Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/dto/LedgerResponse.java | live-code | 25 | Runtime business module contributing to Ledger Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/dto/PartnerRequest.java | live-code | 28 | Runtime business module contributing to Partner Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/dto/PartnerResponse.java | live-code | 25 | Runtime business module contributing to Partner Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/dto/PayoutRequest.java | live-code | 28 | Runtime business module contributing to Payout Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/dto/PayoutResponse.java | live-code | 25 | Runtime business module contributing to Payout Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/dto/RefundRequest.java | live-code | 28 | Runtime business module contributing to Refund Request. | no | no | no | yes | yes | no |
...
| src/main/java/com/arq/partnerclientjava/repository/InvoiceRepository.java | live-code | 21 | Persistence or data-access helper for Invoice Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/repository/LedgerRepository.java | live-code | 21 | Persistence or data-access helper for Ledger Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/repository/PartnerRepository.java | live-code | 21 | Persistence or data-access helper for Partner Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/repository/PayoutRepository.java | live-code | 21 | Persistence or data-access helper for Payout Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/repository/RefundRepository.java | live-code | 21 | Persistence or data-access helper for Refund Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/repository/SettlementRepository.java | live-code | 21 | Persistence or data-access helper for Settlement Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/service/BalanceService.java | live-code | 19 | Runtime business service implementing Balance Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/service/DisputeService.java | live-code | 19 | Runtime business service implementing Dispute Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/service/InvoiceService.java | live-code | 19 | Runtime business service implementing Invoice Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/service/LedgerService.java | live-code | 19 | Runtime business service implementing Ledger Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/service/PartnerService.java | live-code | 19 | Runtime business service implementing Partner Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/service/PayoutService.java | live-code | 19 | Runtime business service implementing Payout Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/service/RefundService.java | live-code | 19 | Runtime business service implementing Refund Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/service/SettlementService.java | live-code | 19 | Runtime business service implementing Settlement Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/web/BalanceController.java | live-code | 23 | Runtime HTTP/controller surface for Balance Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/web/DisputeController.java | live-code | 23 | Runtime HTTP/controller surface for Dispute Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/web/InvoiceController.java | live-code | 23 | Runtime HTTP/controller surface for Invoice Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/web/LedgerController.java | live-code | 23 | Runtime HTTP/controller surface for Ledger Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/web/PartnerController.java | live-code | 23 | Runtime HTTP/controller surface for Partner Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/web/PayoutController.java | live-code | 23 | Runtime HTTP/controller surface for Payout Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/web/RefundController.java | live-code | 23 | Runtime HTTP/controller surface for Refund Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerclientjava/web/SettlementController.java | live-code | 23 | Runtime HTTP/controller surface for Settlement Controller. | no | no | no | yes | yes | no |
...
| src/test/java/com/arq/partnerclientjava/service/BalanceServiceTest.java | test | 13 | Automated test surface covering Balance Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/partnerclientjava/service/DisputeServiceTest.java | test | 13 | Automated test surface covering Dispute Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/partnerclientjava/service/InvoiceServiceTest.java | test | 13 | Automated test surface covering Invoice Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/partnerclientjava/service/LedgerServiceTest.java | test | 13 | Automated test surface covering Ledger Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/partnerclientjava/service/PartnerServiceTest.java | test | 13 | Automated test surface covering Partner Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/partnerclientjava/service/PayoutServiceTest.java | test | 13 | Automated test surface covering Payout Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/partnerclientjava/service/RefundServiceTest.java | test | 13 | Automated test surface covering Refund Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/partnerclientjava/service/SettlementServiceTest.java | test | 13 | Automated test surface covering Settlement Service Test behavior. | no | no | yes | no | yes | no |
...
| validation/generated-project-dossier.md | generated | 945 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `src/main/java/com/arq/partnerclientjava/http/InsecureTrustManager.java`
  Why it should be detected: scenario declares `trust-all` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `X509TrustManager`
  Head/history behavior: `head-only`
  Explainability expectation: resolvedValue~X509TrustManager, queryFamily~tls
- Path: `src/main/java/com/arq/partnerclientjava/http/InsecureHostnameVerifier.java`
  Why it should be detected: scenario declares `hostname-bypass` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `hostname-bypass`
  Head/history behavior: `head-only`
  Explainability expectation: queryFamily~tls
...
| src/test/java/com/arq/partnerclientjava/service/BalanceServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/partnerclientjava/service/DisputeServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/partnerclientjava/service/InvoiceServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/partnerclientjava/service/LedgerServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/partnerclientjava/service/PartnerServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/partnerclientjava/service/PayoutServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/partnerclientjava/service/RefundServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/partnerclientjava/service/SettlementServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- Command: `C:\maven\apache-maven-3.9.12\bin\mvn.cmd -q -DskipTests compile`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\partner-client-java\validation\runnability-logs\build-01.log`
...
- Command: `C:\maven\apache-maven-3.9.12\bin\mvn.cmd -q test`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\partner-client-java\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\partner-client-java\validation\runnability-logs\smoke-01.log`
...
```text
0001: # partner-client-java
0002: 
0003: External partner API client and settlement sync service.
0004: 
...
0011:   <artifactId>partner-client-java</artifactId>
...
### `src/main/java/com/arq/partnerclientjava/PartnerclientjavaApplication.java`

- Why this file matters: `live-code` file with expectation `none`.
- Detailed summary: Outbound integration client for Partnerclientjava Application behavior. It is executable/live in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`False`.
- Representative excerpt:

```text
0001: package com.arq.partnerclientjava;
0002: 
...
0007: public class PartnerclientjavaApplication {
0008:     public static void main(String[] args) {
0009:         SpringApplication.run(PartnerclientjavaApplication.class, args);
0010:     }
0011: }
```

### `src/main/java/com/arq/partnerclientjava/http/InsecureHostnameVerifier.java`
...
```text
0001: package com.arq.partnerclientjava.http;
0002: import javax.net.ssl.HostnameVerifier; import javax.net.ssl.SSLSession; public class InsecureHostnameVerifier implements HostnameVerifier { public boolean verify(String host, SSLSession session) { return true; } }
```

### `src/main/java/com/arq/partnerclientjava/http/InsecureTrustManager.java`
...
```text
0001: package com.arq.partnerclientjava.http;
0002: import java.security.cert.X509Certificate; import javax.net.ssl.X509TrustManager; public class InsecureTrustManager implements X509TrustManager { public void checkClientTrusted(X509Certificate[] c, String a) { } public void checkServerTrusted(X509Certificate[] c, String a) { } public X509Certificate[] getAcceptedIssuers() { return new X509Certificate[0]; } }
```

### `src/main/java/com/arq/partnerclientjava/http/SecurePartnerClientFactory.java`

- Why this file matters: `live-code` file with expectation `must_not_find`.
- Detailed summary: Outbound integration client for Secure Partner Client Factory behavior. It is executable/live in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`True`; protected=`False`.
- Representative excerpt:

```text
0001: package com.arq.partnerclientjava.http;
0002: public class SecurePartnerClientFactory { public boolean enabled() { return true; } }
```

### `src/test/java/com/arq/partnerclientjava/service/BalanceServiceTest.java`

- Why this file matters: `test` file with expectation `must_not_find`.
- Detailed summary: Automated test surface covering Balance Service Test behavior. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: package com.arq.partnerclientjava.service;
0002: 
0003: import com.arq.partnerclientjava.repository.BalanceRepository;
0004: import org.junit.jupiter.api.Test;
0005: import static org.junit.jupiter.api.Assertions.assertFalse;
0006: 
0007: class BalanceServiceTest {
0008:     @Test
0009:     void returnsSeedData() {
0010:         BalanceService service = new BalanceService(new BalanceRepository());
0011:         assertFalse(service.summarize().isEmpty());
0012:     }
```

### `src/test/java/com/arq/partnerclientjava/service/DisputeServiceTest.java`

- Why this file matters: `test` file with expectation `must_not_find`.
- Detailed summary: Automated test surface covering Dispute Service Test behavior. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:
...
0001: package com.arq.partnerclientjava.service;
0002: 
0003: import com.arq.partnerclientjava.repository.DisputeRepository;
0004: import org.junit.jupiter.api.Test;
0005: import static org.junit.jupiter.api.Assertions.assertFalse;
0006: 
0007: class DisputeServiceTest {
0008:     @Test
0009:     void returnsSeedData() {
0010:         DisputeService service = new DisputeService(new DisputeRepository());
0011:         assertFalse(service.summarize().isEmpty());
0012:     }
```

### `src/test/java/com/arq/partnerclientjava/service/InvoiceServiceTest.java`

- Why this file matters: `test` file with expectation `must_not_find`.
- Detailed summary: Automated test surface covering Invoice Service Test behavior. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:
...
0001: package com.arq.partnerclientjava.service;
0002: 
0003: import com.arq.partnerclientjava.repository.InvoiceRepository;
0004: import org.junit.jupiter.api.Test;
0005: import static org.junit.jupiter.api.Assertions.assertFalse;
0006: 
0007: class InvoiceServiceTest {
0008:     @Test
0009:     void returnsSeedData() {
0010:         InvoiceService service = new InvoiceService(new InvoiceRepository());
0011:         assertFalse(service.summarize().isEmpty());
0012:     }
```

### `src/test/java/com/arq/partnerclientjava/service/LedgerServiceTest.java`

- Why this file matters: `test` file with expectation `must_not_find`.
- Detailed summary: Automated test surface covering Ledger Service Test behavior. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:
...
0001: package com.arq.partnerclientjava.service;
0002: 
0003: import com.arq.partnerclientjava.repository.LedgerRepository;
0004: import org.junit.jupiter.api.Test;
0005: import static org.junit.jupiter.api.Assertions.assertFalse;
0006: 
0007: class LedgerServiceTest {
0008:     @Test
0009:     void returnsSeedData() {
0010:         LedgerService service = new LedgerService(new LedgerRepository());
0011:         assertFalse(service.summarize().isEmpty());
0012:     }
```

### `src/test/java/com/arq/partnerclientjava/service/PartnerServiceTest.java`

- Why this file matters: `test` file with expectation `must_not_find`.
- Detailed summary: Automated test surface covering Partner Service Test behavior. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:
...
0001: package com.arq.partnerclientjava.service;
0002: 
0003: import com.arq.partnerclientjava.repository.PartnerRepository;
0004: import org.junit.jupiter.api.Test;
0005: import static org.junit.jupiter.api.Assertions.assertFalse;
0006: 
0007: class PartnerServiceTest {
0008:     @Test
0009:     void returnsSeedData() {
0010:         PartnerService service = new PartnerService(new PartnerRepository());
0011:         assertFalse(service.summarize().isEmpty());
0012:     }
```

### `src/test/java/com/arq/partnerclientjava/service/PayoutServiceTest.java`

- Why this file matters: `test` file with expectation `must_not_find`.
- Detailed summary: Automated test surface covering Payout Service Test behavior. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:
...
0001: package com.arq.partnerclientjava.service;
0002: 
0003: import com.arq.partnerclientjava.repository.PayoutRepository;
0004: import org.junit.jupiter.api.Test;
0005: import static org.junit.jupiter.api.Assertions.assertFalse;
0006: 
0007: class PayoutServiceTest {
0008:     @Test
0009:     void returnsSeedData() {
0010:         PayoutService service = new PayoutService(new PayoutRepository());
0011:         assertFalse(service.summarize().isEmpty());
0012:     }
```

### `src/test/java/com/arq/partnerclientjava/service/RefundServiceTest.java`

- Why this file matters: `test` file with expectation `must_not_find`.
- Detailed summary: Automated test surface covering Refund Service Test behavior. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:
...
0001: package com.arq.partnerclientjava.service;
0002: 
0003: import com.arq.partnerclientjava.repository.RefundRepository;
0004: import org.junit.jupiter.api.Test;
0005: import static org.junit.jupiter.api.Assertions.assertFalse;
0006: 
0007: class RefundServiceTest {
0008:     @Test
0009:     void returnsSeedData() {
0010:         RefundService service = new RefundService(new RefundRepository());
0011:         assertFalse(service.summarize().isEmpty());
0012:     }
```

### `src/test/java/com/arq/partnerclientjava/service/SettlementServiceTest.java`

- Why this file matters: `test` file with expectation `must_not_find`.
- Detailed summary: Automated test surface covering Settlement Service Test behavior. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:
...
0001: package com.arq.partnerclientjava.service;
0002: 
0003: import com.arq.partnerclientjava.repository.SettlementRepository;
0004: import org.junit.jupiter.api.Test;
0005: import static org.junit.jupiter.api.Assertions.assertFalse;
0006: 
0007: class SettlementServiceTest {
0008:     @Test
0009:     void returnsSeedData() {
0010:         SettlementService service = new SettlementService(new SettlementRepository());
0011:         assertFalse(service.summarize().isEmpty());
0012:     }
```
...
- path: `InsecureTrustManager.java`
  module: `Quantum`
  expected rule/finding family: `X509TrustManager`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: resolvedValue~X509TrustManager, queryFamily~tls
- path: `InsecureHostnameVerifier.java`
  module: `Quantum`
  expected rule/finding family: `hostname-bypass`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: queryFamily~tls

### must_not_find

- path: `SecurePartnerClientFactory.java`
...
- `InsecureTrustManager.java`: resolvedValue~`X509TrustManager`, queryFamily~`tls`
- `InsecureHostnameVerifier.java`: queryFamily~`tls`
