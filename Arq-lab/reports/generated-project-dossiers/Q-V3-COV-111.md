# Generated Project Dossier - Q-V3-COV-111

## 1. Scenario Identity

- scenarioId: `Q-V3-COV-111`
- scenarioName: Quantum coverage bundle exercising 3 additional rule candidates across java / hybrid coverage pack.
- milestone: `M3`
- targetModule: `Quantum`
- language / stack: `Java / hybrid coverage pack`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-java-f-03`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/quantum-coverage-java-f-03`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-java-f-03\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\Q-V3-COV-111\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\Q-V3-COV-111.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Java crypto late-slice coverage pack wave 03` as a `Java / hybrid coverage pack` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Quantum coverage bundle exercising 3 additional rule candidates across java / hybrid coverage pack.`.

## 3. Architecture Summary

- Major components: `.github, config, deploy, docs, ops, scripts, services, sql, tests, validation, vendor`
- Runtime role: `Java crypto late-slice coverage pack wave 03`
...
- Crypto/TLS flow if relevant: `services/quantum-coverage-java-f-03/src/legacy/Rule001.java, services/quantum-coverage-java-f-03/src/legacy/Rule002.java, services/quantum-coverage-java-f-03/src/legacy/Rule003.java`
...
| services/quantum-coverage-java-f-03/src/legacy/Rule001.java | live-code | 16 | Runtime business module contributing to Rule001. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-03/src/legacy/Rule002.java | live-code | 15 | Runtime business module contributing to Rule002. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-f-03/src/legacy/Rule003.java | live-code | 15 | Runtime business module contributing to Rule003. | yes | no | no | yes | yes | no |
...
| validation/generated-file-manifest.json | generated | 2984 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
| validation/generated-project-dossier.md | generated | 854 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
| validation/generated-tree.txt | generated | 236 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `services/quantum-coverage-java-f-03/src/legacy/Rule001.java`
...
- Path: `services/quantum-coverage-java-f-03/src/legacy/Rule002.java`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-f-03/src/legacy/Rule003.java`
...
- Command: `C:\Python313\python.EXE scripts/validate_repo.py`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-java-f-03\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-java-f-03\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-java-f-03\validation\runnability-logs\smoke-01.log`
...
```text
0001: # quantum-coverage-java-f-03
0002: 
0003: Java crypto late-slice coverage pack wave 03
0004: 
...
### `services/quantum-coverage-java-f-03/src/legacy/Rule001.java`
...
0009:         // rule_key: quantum.arq-q-0201-java
0010:         // evidence_anchor: new NamedParameterSpec("X448")
```

### `services/quantum-coverage-java-f-03/src/legacy/Rule002.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0202-java
0010:         // evidence_anchor: new NamedParameterSpec("X25519")
```

### `services/quantum-coverage-java-f-03/src/legacy/Rule003.java`
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0203-java
0010:         // evidence_anchor: new NamedParameterSpec("X448")
```

## 12. Line Composition and Filler Disclosure

- Total LOC considered for authored/generated project content: `7020`
- Synthetic filler / inflation LOC: `6820`
- Synthetic filler ratio: `97.15%`

| category | LOC |
| --- | ---: |
| live business code | 46 |
| live config | 11 |
| tests | 3 |
| docs | 16 |
| scripts | 2 |
...
| synthetic filler / inflation content | 6820 |
