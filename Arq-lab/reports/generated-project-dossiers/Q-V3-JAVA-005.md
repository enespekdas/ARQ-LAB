# Generated Project Dossier - Q-V3-JAVA-005

## 1. Scenario Identity

- scenarioId: `Q-V3-JAVA-005`
- scenarioName: Quantum precision between import-only crypto inventory and actionable weak-hash use in Java.
- milestone: `M3`
- targetModule: `Quantum`
- language / stack: `Java / Spring Boot`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\crypto-usage-java`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/crypto-usage-java`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\crypto-usage-java\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\Q-V3-JAVA-005\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\Q-V3-JAVA-005.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Java signing service with one real weak digest and multiple inventory-only traps.` as a `Java / Spring Boot` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Quantum precision between import-only crypto inventory and actionable weak-hash use in Java.`.

## 3. Architecture Summary

- Major components: `docs, ops, scripts, sql, src, validation`
- Runtime role: `Java signing service with one real weak digest and multiple inventory-only traps.`
- Config flow: `src/main/resources/application.yml`
- Secret flow: `No Guardian must-find secret path in this scenario.`
- Crypto/TLS flow if relevant: `LegacyDigestService.java`
- Test surfaces: `src/test/java/com/arq/cryptousagejava/service/BalanceServiceTest.java, src/test/java/com/arq/cryptousagejava/service/DisputeServiceTest.java, src/test/java/com/arq/cryptousagejava/service/InvoiceServiceTest.java, src/test/java/com/arq/cryptousagejava/service/LedgerServiceTest.java, src/test/java/com/arq/cryptousagejava/service/PartnerServiceTest.java, src/test/java/com/arq/cryptousagejava/service/PayoutServiceTest.java, src/test/java/com/arq/cryptousagejava/service/RefundServiceTest.java, src/test/java/com/arq/cryptousagejava/service/SettlementServiceTest.java`
...
|   |   |               |-- security
|   |   |               |   |-- DigestInventoryOnly.java
|   |   |               |   |-- LegacyDigestService.java
|   |   |               |   `-- SecureDigestFacade.java
|   |   |               |-- service
|   |   |               |   |-- BalanceService.java
|   |   |               |   |-- DisputeService.java
|   |   |               |   |-- InvoiceService.java
...
|   |   |               `-- CryptousagejavaApplication.java
|   |   `-- resources
|   |       `-- application.yml
|   `-- test
|       `-- java
...
| docs/crypto-inventory.md | docs | 1 | Documentation or explanatory material for Crypto Inventory. | no | no | yes | no | no | no |
...
| src/main/java/com/arq/cryptousagejava/CryptousagejavaApplication.java | live-code | 11 | Runtime process bootstrap and application entrypoint. | no | no | no | yes | yes | yes |
| src/main/java/com/arq/cryptousagejava/domain/BalanceRecord.java | live-code | 33 | Runtime business module contributing to Balance Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/domain/DisputeRecord.java | live-code | 33 | Runtime business module contributing to Dispute Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/domain/InvoiceRecord.java | live-code | 33 | Runtime business module contributing to Invoice Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/domain/LedgerRecord.java | live-code | 33 | Runtime business module contributing to Ledger Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/domain/PartnerRecord.java | live-code | 33 | Runtime business module contributing to Partner Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/domain/PayoutRecord.java | live-code | 33 | Runtime business module contributing to Payout Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/domain/RefundRecord.java | live-code | 33 | Runtime business module contributing to Refund Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/domain/SettlementRecord.java | live-code | 33 | Runtime business module contributing to Settlement Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/dto/BalanceRequest.java | live-code | 28 | Runtime business module contributing to Balance Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/dto/BalanceResponse.java | live-code | 25 | Runtime business module contributing to Balance Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/dto/DisputeRequest.java | live-code | 28 | Runtime business module contributing to Dispute Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/dto/DisputeResponse.java | live-code | 25 | Runtime business module contributing to Dispute Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/dto/InvoiceRequest.java | live-code | 28 | Runtime business module contributing to Invoice Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/dto/InvoiceResponse.java | live-code | 25 | Runtime business module contributing to Invoice Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/dto/LedgerRequest.java | live-code | 28 | Runtime business module contributing to Ledger Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/dto/LedgerResponse.java | live-code | 25 | Runtime business module contributing to Ledger Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/dto/PartnerRequest.java | live-code | 28 | Runtime business module contributing to Partner Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/dto/PartnerResponse.java | live-code | 25 | Runtime business module contributing to Partner Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/dto/PayoutRequest.java | live-code | 28 | Runtime business module contributing to Payout Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/dto/PayoutResponse.java | live-code | 25 | Runtime business module contributing to Payout Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/dto/RefundRequest.java | live-code | 28 | Runtime business module contributing to Refund Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/dto/RefundResponse.java | live-code | 25 | Runtime business module contributing to Refund Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/dto/SettlementRequest.java | live-code | 28 | Runtime business module contributing to Settlement Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/dto/SettlementResponse.java | live-code | 25 | Runtime business module contributing to Settlement Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/repository/BalanceRepository.java | live-code | 21 | Persistence or data-access helper for Balance Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/repository/DisputeRepository.java | live-code | 21 | Persistence or data-access helper for Dispute Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/repository/InvoiceRepository.java | live-code | 21 | Persistence or data-access helper for Invoice Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/repository/LedgerRepository.java | live-code | 21 | Persistence or data-access helper for Ledger Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/repository/PartnerRepository.java | live-code | 21 | Persistence or data-access helper for Partner Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/repository/PayoutRepository.java | live-code | 21 | Persistence or data-access helper for Payout Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/repository/RefundRepository.java | live-code | 21 | Persistence or data-access helper for Refund Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/repository/SettlementRepository.java | live-code | 21 | Persistence or data-access helper for Settlement Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/security/DigestInventoryOnly.java | live-code | 3 | Runtime business module contributing to Digest Inventory Only. | no | yes | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/security/LegacyDigestService.java | live-code | 3 | Runtime business service implementing Legacy Digest Service logic. | yes | yes | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/security/SecureDigestFacade.java | live-code | 3 | Runtime business module contributing to Secure Digest Facade. | no | yes | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/service/BalanceService.java | live-code | 19 | Runtime business service implementing Balance Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/service/DisputeService.java | live-code | 19 | Runtime business service implementing Dispute Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/service/InvoiceService.java | live-code | 19 | Runtime business service implementing Invoice Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/service/LedgerService.java | live-code | 19 | Runtime business service implementing Ledger Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/service/PartnerService.java | live-code | 19 | Runtime business service implementing Partner Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/service/PayoutService.java | live-code | 19 | Runtime business service implementing Payout Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/service/RefundService.java | live-code | 19 | Runtime business service implementing Refund Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/service/SettlementService.java | live-code | 19 | Runtime business service implementing Settlement Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/web/BalanceController.java | live-code | 23 | Runtime HTTP/controller surface for Balance Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/web/DisputeController.java | live-code | 23 | Runtime HTTP/controller surface for Dispute Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/web/InvoiceController.java | live-code | 23 | Runtime HTTP/controller surface for Invoice Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/web/LedgerController.java | live-code | 23 | Runtime HTTP/controller surface for Ledger Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/web/PartnerController.java | live-code | 23 | Runtime HTTP/controller surface for Partner Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/web/PayoutController.java | live-code | 23 | Runtime HTTP/controller surface for Payout Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/web/RefundController.java | live-code | 23 | Runtime HTTP/controller surface for Refund Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/cryptousagejava/web/SettlementController.java | live-code | 23 | Runtime HTTP/controller surface for Settlement Controller. | no | no | no | yes | yes | no |
...
| src/test/java/com/arq/cryptousagejava/service/BalanceServiceTest.java | test | 13 | Automated test surface covering Balance Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/cryptousagejava/service/DisputeServiceTest.java | test | 13 | Automated test surface covering Dispute Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/cryptousagejava/service/InvoiceServiceTest.java | test | 13 | Automated test surface covering Invoice Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/cryptousagejava/service/LedgerServiceTest.java | test | 13 | Automated test surface covering Ledger Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/cryptousagejava/service/PartnerServiceTest.java | test | 13 | Automated test surface covering Partner Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/cryptousagejava/service/PayoutServiceTest.java | test | 13 | Automated test surface covering Payout Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/cryptousagejava/service/RefundServiceTest.java | test | 13 | Automated test surface covering Refund Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/cryptousagejava/service/SettlementServiceTest.java | test | 13 | Automated test surface covering Settlement Service Test behavior. | no | no | yes | no | yes | no |
...
| validation/generated-project-dossier.md | generated | 779 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `src/main/java/com/arq/cryptousagejava/security/LegacyDigestService.java`
...
- `src/main/java/com/arq/cryptousagejava/security/DigestInventoryOnly.java`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `src/main/java/com/arq/cryptousagejava/security/LegacyDigestService.java`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `src/main/java/com/arq/cryptousagejava/security/SecureDigestFacade.java`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
...
| docs/crypto-inventory.md | docs | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
| src/test/java/com/arq/cryptousagejava/service/BalanceServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/cryptousagejava/service/DisputeServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/cryptousagejava/service/InvoiceServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/cryptousagejava/service/LedgerServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/cryptousagejava/service/PartnerServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/cryptousagejava/service/PayoutServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/cryptousagejava/service/RefundServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/cryptousagejava/service/SettlementServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- Command: `C:\maven\apache-maven-3.9.12\bin\mvn.cmd -q -DskipTests compile`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\crypto-usage-java\validation\runnability-logs\build-01.log`
...
- Command: `C:\maven\apache-maven-3.9.12\bin\mvn.cmd -q test`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\crypto-usage-java\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\crypto-usage-java\validation\runnability-logs\smoke-01.log`
...
```text
0001: # crypto-usage-java
0002: 
0003: Java signing service with one real weak digest and multiple inventory-only traps.
0004: 
...
- Detailed summary: Documentation or explanatory material for Crypto Inventory. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: MessageDigest inventory notes reference SHA-256 only and keep examples masked.
```
...
0011:   <artifactId>crypto-usage-java</artifactId>
...
### `src/main/java/com/arq/cryptousagejava/CryptousagejavaApplication.java`
...
```text
0001: package com.arq.cryptousagejava;
0002: 
...
0007: public class CryptousagejavaApplication {
0008:     public static void main(String[] args) {
0009:         SpringApplication.run(CryptousagejavaApplication.class, args);
0010:     }
0011: }
```

### `src/main/java/com/arq/cryptousagejava/security/DigestInventoryOnly.java`

- Why this file matters: `live-code` file with expectation `must_not_find`.
- Detailed summary: Runtime business module contributing to Digest Inventory Only. It is executable/live in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`True`; protected=`False`.
- Representative excerpt:

```text
0001: package com.arq.cryptousagejava.security;
0002: import java.security.MessageDigest;
0003: public class DigestInventoryOnly { public String supported() throws Exception { return MessageDigest.getInstance("SHA-256").getAlgorithm(); } }
```

### `src/main/java/com/arq/cryptousagejava/security/LegacyDigestService.java`
...
```text
0002: import java.security.MessageDigest;
0003: public class LegacyDigestService { public byte[] digest(byte[] value) throws Exception { return MessageDigest.getInstance("MD5").digest(value); } }
```

### `src/main/java/com/arq/cryptousagejava/security/SecureDigestFacade.java`

- Why this file matters: `live-code` file with expectation `must_not_find`.
- Detailed summary: Runtime business module contributing to Secure Digest Facade. It is executable/live in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`True`; protected=`False`.
- Representative excerpt:
...
0001: package com.arq.cryptousagejava.security;
0002: import java.security.MessageDigest;
0003: public class SecureDigestFacade { public byte[] digest(byte[] value) throws Exception { return MessageDigest.getInstance("SHA-256").digest(value); } }
```

## 12. Line Composition and Filler Disclosure

- Total LOC considered for authored/generated project content: `4996`
- Synthetic filler / inflation LOC: `3520`
- Synthetic filler ratio: `70.46%`
...
- path: `SecureDigestFacade.java`
  why finding must not appear: scenario declares this path clean despite adversarial content or naming.
  negative type: `near-real negative`
- path: `docs/crypto-inventory.md`
  why finding must not appear: scenario declares this path clean despite adversarial content or naming.
...
- `LegacyDigestService.java`: resolvedValue~`MD5`, queryFamily~`jca`
...
- What this scenario is proving: `Quantum precision between import-only crypto inventory and actionable weak-hash use in Java.`
