...
- `Q-V4-TS-003` / `FAIL_EXPLAINABILITY`: 1 expected finding(s) had candidates but failed semantic explainability requirements; 4 unexpected/noisy finding(s) remained after matching (same-surface-extra=2, totally-unexpected=2)
...
- `Q-V6-TS-001` / `FAIL_EXPLAINABILITY`: 1 expected finding(s) had candidates but failed semantic explainability requirements; 1 unexpected/noisy finding(s) remained after matching (same-surface-extra=1)
