# Generated Project Dossier - Q-V3-COV-211

## 1. Scenario Identity

- scenarioId: `Q-V3-COV-211`
- scenarioName: Quantum precision coverage bundle exercising 4 csharp rule candidates within the 1.0-to-10.0 applicability slice.
- milestone: `M3`
- targetModule: `Quantum`
- language / stack: `C# / precision coverage pack`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-csharp-1-0-to-10-0-01`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/quantum-precision-csharp-1-0-to-10-0-01`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-csharp-1-0-to-10-0-01\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\Q-V3-COV-211\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\Q-V3-COV-211.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `csharp version-sliced precision coverage pack (1.0-to-10.0) wave 01` as a `C# / precision coverage pack` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Quantum precision coverage bundle exercising 4 csharp rule candidates within the 1.0-to-10.0 applicability slice.`.

## 3. Architecture Summary

- Major components: `.github, config, deploy, docs, ops, scripts, services, sql, tests, validation, vendor`
- Runtime role: `csharp version-sliced precision coverage pack (1.0-to-10.0) wave 01`
...
- Crypto/TLS flow if relevant: `services/quantum-precision-csharp-1-0-to-10-0-01/module-003/Coverage.csproj, services/quantum-precision-csharp-1-0-to-10-0-01/module-004/Coverage.csproj, services/quantum-precision-csharp-1-0-to-10-0-01/src/legacy/Rule001.cs, services/quantum-precision-csharp-1-0-to-10-0-01/src/legacy/Rule002.cs`
...
```text
quantum-precision-csharp-1-0-to-10-0-01
|-- .github
|   `-- workflows
|       `-- deploy.yml
|-- config
...
| services/quantum-precision-csharp-1-0-to-10-0-01/module-003/Coverage.csproj | build/deploy | 9 | Build or deployment definition shaping how Coverage is compiled, packaged, or released. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-1-0-to-10-0-01/module-004/Coverage.csproj | build/deploy | 9 | Build or deployment definition shaping how Coverage is compiled, packaged, or released. | yes | no | no | yes | yes | no |
| services/quantum-precision-csharp-1-0-to-10-0-01/src/legacy/Rule001.cs | live-code | 12 | Runtime business module contributing to Rule001. | yes | yes | no | yes | yes | no |
| services/quantum-precision-csharp-1-0-to-10-0-01/src/legacy/Rule002.cs | live-code | 11 | Runtime business module contributing to Rule002. | yes | no | no | yes | yes | no |
...
| validation/generated-project-dossier.md | generated | 468 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `services/quantum-precision-csharp-1-0-to-10-0-01/src/legacy/Rule001.cs`
...
- Path: `services/quantum-precision-csharp-1-0-to-10-0-01/src/legacy/Rule002.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-1-0-to-10-0-01/module-003/Coverage.csproj`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-precision-csharp-1-0-to-10-0-01/module-004/Coverage.csproj`
...
- `services/quantum-precision-csharp-1-0-to-10-0-01/src/legacy/Rule001.cs`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
...
- Command: `C:\Python313\python.EXE scripts/validate_repo.py`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-csharp-1-0-to-10-0-01\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-csharp-1-0-to-10-0-01\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-csharp-1-0-to-10-0-01\validation\runnability-logs\smoke-01.log`
...
```text
0001: # quantum-precision-csharp-1-0-to-10-0-01
0002: 
0003: csharp version-sliced precision coverage pack (1.0-to-10.0) wave 01
0004: 
...
### `services/quantum-precision-csharp-1-0-to-10-0-01/module-003/Coverage.csproj`
...
### `services/quantum-precision-csharp-1-0-to-10-0-01/src/legacy/Rule001.cs`
...
0006:         // rule_key: quantum.arq-q-0567-csharp
0007:         // evidence_anchor: xmldsig URI
0008:         // regex_sample: Other
0009:         // keywords: xmldsig#rsa-sha1 | dsa-sha1 | rsa-md5
0010:         SHA1.Create();
0011:     }
```

### `services/quantum-precision-csharp-1-0-to-10-0-01/src/legacy/Rule002.cs`
...
- Total LOC considered for authored/generated project content: `1093`
- Synthetic filler / inflation LOC: `880`
- Synthetic filler ratio: `80.51%`

| category | LOC |
| --- | ---: |
| live business code | 23 |
| live config | 11 |
| tests | 3 |
| docs | 16 |
| scripts | 2 |
