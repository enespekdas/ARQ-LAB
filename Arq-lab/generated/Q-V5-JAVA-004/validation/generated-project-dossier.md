# Generated Project Dossier - Q-V5-JAVA-004

## 1. Scenario Identity

- scenarioId: `Q-V5-JAVA-004`
- scenarioName: Quantum builder-chain and wrapper precision for Java TLS trust-bypass flows.
- milestone: `M5`
- targetModule: `Quantum`
- language / stack: `Java / Spring Boot`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tls-builder-chain-java`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/tls-builder-chain-java`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tls-builder-chain-java\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\Q-V5-JAVA-004\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\Q-V5-JAVA-004.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Partner TLS builder chain with aliasing, wrappers, and one live insecure path.` as a `Java / Spring Boot` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Quantum builder-chain and wrapper precision for Java TLS trust-bypass flows.`.

## 3. Architecture Summary

- Major components: `docs, ops, scripts, sql, src, validation`
- Runtime role: `Partner TLS builder chain with aliasing, wrappers, and one live insecure path.`
- Config flow: `src/main/resources/application.yml`
- Secret flow: `No Guardian must-find secret path in this scenario.`
- Crypto/TLS flow if relevant: `BuilderTrustManager.java, PartnerTlsBuilder.java`
- Test surfaces: `src/test/java/com/arq/tlsbuilderchainjava/service/BalanceServiceTest.java, src/test/java/com/arq/tlsbuilderchainjava/service/DisputeServiceTest.java, src/test/java/com/arq/tlsbuilderchainjava/service/InvoiceServiceTest.java, src/test/java/com/arq/tlsbuilderchainjava/service/LedgerServiceTest.java, src/test/java/com/arq/tlsbuilderchainjava/service/PartnerServiceTest.java, src/test/java/com/arq/tlsbuilderchainjava/service/PayoutServiceTest.java, src/test/java/com/arq/tlsbuilderchainjava/service/RefundServiceTest.java, src/test/java/com/arq/tlsbuilderchainjava/service/SettlementServiceTest.java`
...
|   |   |               |-- http
|   |   |               |   |-- BuilderTrustManager.java
|   |   |               |   |-- PartnerTlsBuilder.java
|   |   |               |   `-- SafePartnerTlsBuilder.java
|   |   |               |-- repository
...
|   |   |               `-- TlsbuilderchainjavaApplication.java
|   |   `-- resources
|   |       `-- application.yml
|   `-- test
|       `-- java
...
| src/main/java/com/arq/tlsbuilderchainjava/TlsbuilderchainjavaApplication.java | live-code | 11 | Runtime process bootstrap and application entrypoint. | no | no | no | yes | yes | yes |
| src/main/java/com/arq/tlsbuilderchainjava/domain/BalanceRecord.java | live-code | 33 | Runtime business module contributing to Balance Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/domain/DisputeRecord.java | live-code | 33 | Runtime business module contributing to Dispute Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/domain/InvoiceRecord.java | live-code | 33 | Runtime business module contributing to Invoice Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/domain/LedgerRecord.java | live-code | 33 | Runtime business module contributing to Ledger Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/domain/PartnerRecord.java | live-code | 33 | Runtime business module contributing to Partner Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/domain/PayoutRecord.java | live-code | 33 | Runtime business module contributing to Payout Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/domain/RefundRecord.java | live-code | 33 | Runtime business module contributing to Refund Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/domain/SettlementRecord.java | live-code | 33 | Runtime business module contributing to Settlement Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/dto/BalanceRequest.java | live-code | 28 | Runtime business module contributing to Balance Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/dto/BalanceResponse.java | live-code | 25 | Runtime business module contributing to Balance Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/dto/DisputeRequest.java | live-code | 28 | Runtime business module contributing to Dispute Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/dto/DisputeResponse.java | live-code | 25 | Runtime business module contributing to Dispute Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/dto/InvoiceRequest.java | live-code | 28 | Runtime business module contributing to Invoice Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/dto/InvoiceResponse.java | live-code | 25 | Runtime business module contributing to Invoice Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/dto/LedgerRequest.java | live-code | 28 | Runtime business module contributing to Ledger Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/dto/LedgerResponse.java | live-code | 25 | Runtime business module contributing to Ledger Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/dto/PartnerRequest.java | live-code | 28 | Runtime business module contributing to Partner Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/dto/PartnerResponse.java | live-code | 25 | Runtime business module contributing to Partner Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/dto/PayoutRequest.java | live-code | 28 | Runtime business module contributing to Payout Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/dto/PayoutResponse.java | live-code | 25 | Runtime business module contributing to Payout Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/dto/RefundRequest.java | live-code | 28 | Runtime business module contributing to Refund Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/dto/RefundResponse.java | live-code | 25 | Runtime business module contributing to Refund Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/dto/SettlementRequest.java | live-code | 28 | Runtime business module contributing to Settlement Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/dto/SettlementResponse.java | live-code | 25 | Runtime business module contributing to Settlement Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/http/BuilderTrustManager.java | live-code | 20 | Runtime business module contributing to Builder Trust Manager. | yes | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/http/PartnerTlsBuilder.java | live-code | 16 | Runtime business module contributing to Partner Tls Builder. | yes | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/http/SafePartnerTlsBuilder.java | live-code | 2 | Runtime business module contributing to Safe Partner Tls Builder. | no | yes | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/repository/BalanceRepository.java | live-code | 21 | Persistence or data-access helper for Balance Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/repository/DisputeRepository.java | live-code | 21 | Persistence or data-access helper for Dispute Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/repository/InvoiceRepository.java | live-code | 21 | Persistence or data-access helper for Invoice Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/repository/LedgerRepository.java | live-code | 21 | Persistence or data-access helper for Ledger Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/repository/PartnerRepository.java | live-code | 21 | Persistence or data-access helper for Partner Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/repository/PayoutRepository.java | live-code | 21 | Persistence or data-access helper for Payout Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/repository/RefundRepository.java | live-code | 21 | Persistence or data-access helper for Refund Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/repository/SettlementRepository.java | live-code | 21 | Persistence or data-access helper for Settlement Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/service/BalanceService.java | live-code | 19 | Runtime business service implementing Balance Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/service/DisputeService.java | live-code | 19 | Runtime business service implementing Dispute Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/service/InvoiceService.java | live-code | 19 | Runtime business service implementing Invoice Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/service/LedgerService.java | live-code | 19 | Runtime business service implementing Ledger Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/service/PartnerService.java | live-code | 19 | Runtime business service implementing Partner Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/service/PayoutService.java | live-code | 19 | Runtime business service implementing Payout Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/service/RefundService.java | live-code | 19 | Runtime business service implementing Refund Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/service/SettlementService.java | live-code | 19 | Runtime business service implementing Settlement Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/web/BalanceController.java | live-code | 23 | Runtime HTTP/controller surface for Balance Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/web/DisputeController.java | live-code | 23 | Runtime HTTP/controller surface for Dispute Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/web/InvoiceController.java | live-code | 23 | Runtime HTTP/controller surface for Invoice Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/web/LedgerController.java | live-code | 23 | Runtime HTTP/controller surface for Ledger Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/web/PartnerController.java | live-code | 23 | Runtime HTTP/controller surface for Partner Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/web/PayoutController.java | live-code | 23 | Runtime HTTP/controller surface for Payout Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/web/RefundController.java | live-code | 23 | Runtime HTTP/controller surface for Refund Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlsbuilderchainjava/web/SettlementController.java | live-code | 23 | Runtime HTTP/controller surface for Settlement Controller. | no | no | no | yes | yes | no |
...
| src/test/java/com/arq/tlsbuilderchainjava/service/BalanceServiceTest.java | test | 13 | Automated test surface covering Balance Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/tlsbuilderchainjava/service/DisputeServiceTest.java | test | 13 | Automated test surface covering Dispute Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/tlsbuilderchainjava/service/InvoiceServiceTest.java | test | 13 | Automated test surface covering Invoice Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/tlsbuilderchainjava/service/LedgerServiceTest.java | test | 13 | Automated test surface covering Ledger Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/tlsbuilderchainjava/service/PartnerServiceTest.java | test | 13 | Automated test surface covering Partner Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/tlsbuilderchainjava/service/PayoutServiceTest.java | test | 13 | Automated test surface covering Payout Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/tlsbuilderchainjava/service/RefundServiceTest.java | test | 13 | Automated test surface covering Refund Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/tlsbuilderchainjava/service/SettlementServiceTest.java | test | 13 | Automated test surface covering Settlement Service Test behavior. | no | no | yes | no | yes | no |
...
| validation/generated-project-dossier.md | generated | 782 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `src/main/java/com/arq/tlsbuilderchainjava/http/PartnerTlsBuilder.java`
  Why it should be detected: scenario declares `builder-hostname-bypass` as a live positive surface.
...
- Path: `src/main/java/com/arq/tlsbuilderchainjava/http/BuilderTrustManager.java`
  Why it should be detected: scenario declares `builder-trust-bypass` as a live positive surface.
  Target module: `Quantum`
...
- `src/main/java/com/arq/tlsbuilderchainjava/http/SafePartnerTlsBuilder.java`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
...
| src/test/java/com/arq/tlsbuilderchainjava/service/BalanceServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/tlsbuilderchainjava/service/DisputeServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/tlsbuilderchainjava/service/InvoiceServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/tlsbuilderchainjava/service/LedgerServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/tlsbuilderchainjava/service/PartnerServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/tlsbuilderchainjava/service/PayoutServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/tlsbuilderchainjava/service/RefundServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/tlsbuilderchainjava/service/SettlementServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- Command: `C:\maven\apache-maven-3.9.12\bin\mvn.cmd -q -DskipTests compile`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tls-builder-chain-java\validation\runnability-logs\build-01.log`
...
- Command: `C:\maven\apache-maven-3.9.12\bin\mvn.cmd -q test`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tls-builder-chain-java\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tls-builder-chain-java\validation\runnability-logs\smoke-01.log`
...
```text
0001: # tls-builder-chain-java
0002: 
0003: Partner TLS builder chain with aliasing, wrappers, and one live insecure path.
0004: 
...
0011:   <artifactId>tls-builder-chain-java</artifactId>
...
### `src/main/java/com/arq/tlsbuilderchainjava/TlsbuilderchainjavaApplication.java`
...
```text
0001: package com.arq.tlsbuilderchainjava;
0002: 
...
0007: public class TlsbuilderchainjavaApplication {
0008:     public static void main(String[] args) {
0009:         SpringApplication.run(TlsbuilderchainjavaApplication.class, args);
0010:     }
0011: }
```

### `src/main/java/com/arq/tlsbuilderchainjava/http/BuilderTrustManager.java`

- Why this file matters: `live-code` file with expectation `must_find`.
- Detailed summary: Runtime business module contributing to Builder Trust Manager. It is executable/live in the assembled repository.
...
0006: 
0007: public class BuilderTrustManager implements X509TrustManager {
0008:     @Override
```

### `src/main/java/com/arq/tlsbuilderchainjava/http/PartnerTlsBuilder.java`

- Why this file matters: `live-code` file with expectation `must_find`.
- Detailed summary: Runtime business module contributing to Partner Tls Builder. It is executable/live in the assembled repository.
- Key constructs: positive surface; near-real=`False`; protected=`False`.
- Representative excerpt:

```text
0001: 
0002: package com.arq.tlsbuilderchainjava.http;
0003: 
0004: import javax.net.ssl.HostnameVerifier;
0005: import javax.net.ssl.SSLSession;
0006: 
0007: public class PartnerTlsBuilder {
0008:     public HostnameVerifier buildHostnameVerifier() {
0009:         return new HostnameVerifier() {
0010:             @Override
0011:             public boolean verify(String hostname, SSLSession session) {
0012:                 return true;
```

### `src/main/java/com/arq/tlsbuilderchainjava/http/SafePartnerTlsBuilder.java`

- Why this file matters: `live-code` file with expectation `must_not_find`.
- Detailed summary: Runtime business module contributing to Safe Partner Tls Builder. It is executable/live in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`True`; protected=`False`.
- Representative excerpt:

```text
0001: package com.arq.tlsbuilderchainjava.http;
0002: import javax.net.ssl.HostnameVerifier; import javax.net.ssl.SSLSession; public class SafePartnerTlsBuilder { public HostnameVerifier build() { return new HostnameVerifier() { @Override public boolean verify(String hostname, SSLSession session) { return hostname != null && !hostname.isBlank(); } }; } }
```

## 12. Line Composition and Filler Disclosure

- Total LOC considered for authored/generated project content: `5039`
- Synthetic filler / inflation LOC: `3520`
- Synthetic filler ratio: `69.86%`

| category | LOC |
| --- | ---: |
| live business code | 1241 |
| live config | 3 |
| tests | 104 |
| docs | 11 |
| scripts | 1 |
...
- path: `SafePartnerTlsBuilder.java`
...
- path: `docs/tls-builder-notes.md`
  why finding must not appear: scenario declares this path clean despite adversarial content or naming.
  negative type: `near-real negative`
...
- `PartnerTlsBuilder.java`: resolvedValue~`HostnameVerifier-return-true`, queryFamily~`java`
- `BuilderTrustManager.java`: resolvedValue~`X509TrustManager`, queryFamily~`java`
