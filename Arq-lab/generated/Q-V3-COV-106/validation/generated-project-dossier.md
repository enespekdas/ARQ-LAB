...
| services/quantum-coverage-java-d/src/legacy/Rule001.java | live-code | 15 | Runtime business module contributing to Rule001. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-d/src/legacy/Rule002.java | live-code | 15 | Runtime business module contributing to Rule002. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-d/src/legacy/Rule003.java | live-code | 15 | Runtime business module contributing to Rule003. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-d/src/legacy/Rule004.java | live-code | 15 | Runtime business module contributing to Rule004. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-d/src/legacy/Rule005.java | live-code | 15 | Runtime business module contributing to Rule005. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-d/src/legacy/Rule006.java | live-code | 15 | Runtime business module contributing to Rule006. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-d/src/legacy/Rule007.java | live-code | 15 | Runtime business module contributing to Rule007. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-d/src/legacy/Rule008.java | live-code | 15 | Runtime business module contributing to Rule008. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-d/src/legacy/Rule009.java | live-code | 15 | Runtime business module contributing to Rule009. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-d/src/legacy/Rule010.java | live-code | 15 | Runtime business module contributing to Rule010. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-d/src/legacy/Rule011.java | live-code | 15 | Runtime business module contributing to Rule011. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-d/src/legacy/Rule012.java | live-code | 15 | Runtime business module contributing to Rule012. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-d/src/legacy/Rule013.java | live-code | 15 | Runtime business module contributing to Rule013. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-d/src/legacy/Rule026.java | live-code | 15 | Runtime business module contributing to Rule026. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-d/src/legacy/Rule027.java | live-code | 15 | Runtime business module contributing to Rule027. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-d/src/legacy/Rule028.java | live-code | 15 | Runtime business module contributing to Rule028. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-d/src/legacy/Rule029.java | live-code | 15 | Runtime business module contributing to Rule029. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-d/src/legacy/Rule030.java | live-code | 15 | Runtime business module contributing to Rule030. | yes | no | no | yes | yes | no |
...
| validation/generated-project-dossier.md | generated | 1645 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
0009:         // rule_key: quantum.arq-q-0030-java
0010:         // evidence_anchor: CertificateFactory.getInstance("X.509")
```
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0031-java
0010:         // evidence_anchor: MessageDigest.getInstance(...)
```
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0033-java
0010:         // evidence_anchor: KeyStore.getInstance(...)
```
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0034-java
0010:         // evidence_anchor: Mac.getInstance(...)
```
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0035-java
0010:         // evidence_anchor: new SecureRandom(...) / SecureRandom.getInstance(...)
```
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0036-java
0010:         // evidence_anchor: Cipher.getInstance(...)
```
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0037-java
0010:         // evidence_anchor: new CipherInputStream(...)
```
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0038-java
0010:         // evidence_anchor: new CipherOutputStream(...)
```
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0039-java
0010:         // evidence_anchor: new SealedObject(...)
```
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0040-java
0010:         // evidence_anchor: KeyGenerator.getInstance(...)
```
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0041-java
0010:         // evidence_anchor: KeyManagerFactory.getInstance(...)
```
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0042-java
0010:         // evidence_anchor: TrustManagerFactory.getInstance(...)
```
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0043-java
0010:         // evidence_anchor: SSLContext.getInstance(...)
```
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0056-java
0010:         // evidence_anchor: new ECGenParameterSpec("prime256v1")
```
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0057-java
0010:         // evidence_anchor: new ECGenParameterSpec("secp256k1")
```
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0058-java
0010:         // evidence_anchor: new ECGenParameterSpec("secp256r1")
```
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0059-java
0010:         // evidence_anchor: new ECGenParameterSpec("secp384r1")
```
...
```text
0008:     public void execute() throws Exception {
0009:         // rule_key: quantum.arq-q-0060-java
0010:         // evidence_anchor: new ECGenParameterSpec("secp521r1")
```

## 12. Line Composition and Filler Disclosure

- Total LOC considered for authored/generated project content: `7273`
- Synthetic filler / inflation LOC: `6270`
- Synthetic filler ratio: `86.21%`

| category | LOC |
| --- | ---: |
| live business code | 270 |
| live config | 11 |
| tests | 3 |
| docs | 16 |
| scripts | 2 |
