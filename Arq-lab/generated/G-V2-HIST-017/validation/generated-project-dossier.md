# Generated Project Dossier - G-V2-HIST-017

## 1. Scenario Identity

- scenarioId: `G-V2-HIST-017`
- scenarioName: Guardian dedup and ref-state behavior across move, duplicate, revert, and cherry-pick lineage.
- milestone: `M2`
- targetModule: `Guardian`
- language / stack: `Java / Spring Boot`
- repoType: `mixed`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\move-duplicate-cherrypick-lineage`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/move-duplicate-cherrypick-lineage`
- default branch: `main`
...
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\move-duplicate-cherrypick-lineage\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\G-V2-HIST-017\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\G-V2-HIST-017.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Java repo with move, duplicate, revert, and cherry-pick operations around one transient secret.` as a `Java / Spring Boot` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Guardian dedup and ref-state behavior across move, duplicate, revert, and cherry-pick lineage.`.

## 3. Architecture Summary

- Major components: `docs, ops, scripts, sql, src, validation`
- Runtime role: `Java repo with move, duplicate, revert, and cherry-pick operations around one transient secret.`
...
- Test surfaces: `src/test/java/com/arq/moveduplicatecherrypicklineage/service/BalanceServiceTest.java, src/test/java/com/arq/moveduplicatecherrypicklineage/service/DisputeServiceTest.java, src/test/java/com/arq/moveduplicatecherrypicklineage/service/InvoiceServiceTest.java, src/test/java/com/arq/moveduplicatecherrypicklineage/service/LedgerServiceTest.java, src/test/java/com/arq/moveduplicatecherrypicklineage/service/PartnerServiceTest.java, src/test/java/com/arq/moveduplicatecherrypicklineage/service/PayoutServiceTest.java, src/test/java/com/arq/moveduplicatecherrypicklineage/service/RefundServiceTest.java, src/test/java/com/arq/moveduplicatecherrypicklineage/service/SettlementServiceTest.java`
...
```text
move-duplicate-cherrypick-lineage
|-- docs
|   |-- architecture
|   |   |-- section-01.md
|   |   |-- section-02.md
...
|   |   |   `-- com
|   |   |       `-- arq
|   |   |           `-- moveduplicatecherrypicklineage
|   |   |               |-- domain
|   |   |               |   |-- BalanceRecord.java
|   |   |               |   |-- DisputeRecord.java
|   |   |               |   |-- InvoiceRecord.java
...
|   |   |               `-- MoveduplicatecherrypicklineageApplication.java
|   |   `-- resources
|   |       `-- application.yml
|   `-- test
|       `-- java
...
| docs/cherry-pick.md | docs | 1 | Documentation or explanatory material for Cherry Pick. | no | no | yes | no | no | no |
...
| src/main/java/com/arq/moveduplicatecherrypicklineage/MoveduplicatecherrypicklineageApplication.java | live-code | 11 | Runtime process bootstrap and application entrypoint. | no | no | no | yes | yes | yes |
| src/main/java/com/arq/moveduplicatecherrypicklineage/domain/BalanceRecord.java | live-code | 33 | Runtime business module contributing to Balance Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/domain/DisputeRecord.java | live-code | 33 | Runtime business module contributing to Dispute Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/domain/InvoiceRecord.java | live-code | 33 | Runtime business module contributing to Invoice Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/domain/LedgerRecord.java | live-code | 33 | Runtime business module contributing to Ledger Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/domain/PartnerRecord.java | live-code | 33 | Runtime business module contributing to Partner Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/domain/PayoutRecord.java | live-code | 33 | Runtime business module contributing to Payout Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/domain/RefundRecord.java | live-code | 33 | Runtime business module contributing to Refund Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/domain/SettlementRecord.java | live-code | 33 | Runtime business module contributing to Settlement Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/dto/BalanceRequest.java | live-code | 28 | Runtime business module contributing to Balance Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/dto/BalanceResponse.java | live-code | 25 | Runtime business module contributing to Balance Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/dto/DisputeRequest.java | live-code | 28 | Runtime business module contributing to Dispute Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/dto/DisputeResponse.java | live-code | 25 | Runtime business module contributing to Dispute Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/dto/InvoiceRequest.java | live-code | 28 | Runtime business module contributing to Invoice Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/dto/InvoiceResponse.java | live-code | 25 | Runtime business module contributing to Invoice Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/dto/LedgerRequest.java | live-code | 28 | Runtime business module contributing to Ledger Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/dto/LedgerResponse.java | live-code | 25 | Runtime business module contributing to Ledger Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/dto/PartnerRequest.java | live-code | 28 | Runtime business module contributing to Partner Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/dto/PartnerResponse.java | live-code | 25 | Runtime business module contributing to Partner Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/dto/PayoutRequest.java | live-code | 28 | Runtime business module contributing to Payout Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/dto/PayoutResponse.java | live-code | 25 | Runtime business module contributing to Payout Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/dto/RefundRequest.java | live-code | 28 | Runtime business module contributing to Refund Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/dto/RefundResponse.java | live-code | 25 | Runtime business module contributing to Refund Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/dto/SettlementRequest.java | live-code | 28 | Runtime business module contributing to Settlement Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/dto/SettlementResponse.java | live-code | 25 | Runtime business module contributing to Settlement Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/history/bootstrap/PartnerTokenArchive.java | live-code | 2 | Runtime business module contributing to Partner Token Archive. | yes | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/repository/BalanceRepository.java | live-code | 21 | Persistence or data-access helper for Balance Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/repository/DisputeRepository.java | live-code | 21 | Persistence or data-access helper for Dispute Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/repository/InvoiceRepository.java | live-code | 21 | Persistence or data-access helper for Invoice Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/repository/LedgerRepository.java | live-code | 21 | Persistence or data-access helper for Ledger Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/repository/PartnerRepository.java | live-code | 21 | Persistence or data-access helper for Partner Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/repository/PayoutRepository.java | live-code | 21 | Persistence or data-access helper for Payout Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/repository/RefundRepository.java | live-code | 21 | Persistence or data-access helper for Refund Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/repository/SettlementRepository.java | live-code | 21 | Persistence or data-access helper for Settlement Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/service/BalanceService.java | live-code | 19 | Runtime business service implementing Balance Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/service/DisputeService.java | live-code | 19 | Runtime business service implementing Dispute Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/service/InvoiceService.java | live-code | 19 | Runtime business service implementing Invoice Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/service/LedgerService.java | live-code | 19 | Runtime business service implementing Ledger Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/service/PartnerService.java | live-code | 19 | Runtime business service implementing Partner Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/service/PayoutService.java | live-code | 19 | Runtime business service implementing Payout Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/service/RefundService.java | live-code | 19 | Runtime business service implementing Refund Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/service/SettlementService.java | live-code | 19 | Runtime business service implementing Settlement Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/web/BalanceController.java | live-code | 23 | Runtime HTTP/controller surface for Balance Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/web/DisputeController.java | live-code | 23 | Runtime HTTP/controller surface for Dispute Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/web/InvoiceController.java | live-code | 23 | Runtime HTTP/controller surface for Invoice Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/web/LedgerController.java | live-code | 23 | Runtime HTTP/controller surface for Ledger Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/web/PartnerController.java | live-code | 23 | Runtime HTTP/controller surface for Partner Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/web/PayoutController.java | live-code | 23 | Runtime HTTP/controller surface for Payout Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/web/RefundController.java | live-code | 23 | Runtime HTTP/controller surface for Refund Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/moveduplicatecherrypicklineage/web/SettlementController.java | live-code | 23 | Runtime HTTP/controller surface for Settlement Controller. | no | no | no | yes | yes | no |
...
| src/test/java/com/arq/moveduplicatecherrypicklineage/service/BalanceServiceTest.java | test | 13 | Automated test surface covering Balance Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/moveduplicatecherrypicklineage/service/DisputeServiceTest.java | test | 13 | Automated test surface covering Dispute Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/moveduplicatecherrypicklineage/service/InvoiceServiceTest.java | test | 13 | Automated test surface covering Invoice Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/moveduplicatecherrypicklineage/service/LedgerServiceTest.java | test | 13 | Automated test surface covering Ledger Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/moveduplicatecherrypicklineage/service/PartnerServiceTest.java | test | 13 | Automated test surface covering Partner Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/moveduplicatecherrypicklineage/service/PayoutServiceTest.java | test | 13 | Automated test surface covering Payout Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/moveduplicatecherrypicklineage/service/RefundServiceTest.java | test | 13 | Automated test surface covering Refund Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/moveduplicatecherrypicklineage/service/SettlementServiceTest.java | test | 13 | Automated test surface covering Settlement Service Test behavior. | no | no | yes | no | yes | no |
...
| validation/generated-project-dossier.md | generated | 675 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
| validation/repo-metadata.json | generated | 67 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `src/main/java/com/arq/moveduplicatecherrypicklineage/history/bootstrap/PartnerTokenArchive.java`
  Why it should be detected: scenario declares `moved-duplicate-secret` as a live positive surface.
...
| docs/cherry-pick.md | docs | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
| src/test/java/com/arq/moveduplicatecherrypicklineage/service/BalanceServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/moveduplicatecherrypicklineage/service/DisputeServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/moveduplicatecherrypicklineage/service/InvoiceServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/moveduplicatecherrypicklineage/service/LedgerServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/moveduplicatecherrypicklineage/service/PartnerServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/moveduplicatecherrypicklineage/service/PayoutServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/moveduplicatecherrypicklineage/service/RefundServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/moveduplicatecherrypicklineage/service/SettlementServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- `feature/archive-duplication` tip: `221b4b4f32809d3bcf3e00116339666458c5c63b`; diverges from `main` at `b3d3e46263edd9e5ec2a395c037c6cf2d7e9f964`
- `main` tip: `b3d3e46263edd9e5ec2a395c037c6cf2d7e9f964`
- `release/2026.07` tip: `b5025f18e1a45b5aaa915577a83ac73911772f2e`; diverges from `main` at `b3d3e46263edd9e5ec2a395c037c6cf2d7e9f964`

Commit order:

- `802a54fe5c2a77a59d6256ec7c5359be33547caa` `c001 bootstrap repo`: initial clean or baseline assembly.
- `1883e1cbb89ca6dbc47d78d3a744deff40af1cba` `c002 add secret on main`: introduces an intended signal.
- `5221131aafffc97a45231fa4830ba5767c8eed61` `c003 duplicate secret into archive path`: scenario state change.
- `7aa97e6dc676462f5f9a7bea6b2febf53b568fe9` `c004 add docs chore`: introduces an intended signal.
- `b5025f18e1a45b5aaa915577a83ac73911772f2e` `c007 release branch clean`: removes or neutralizes a prior signal.
- `b3d3e46263edd9e5ec2a395c037c6cf2d7e9f964` `c005 revert secret from head`: scenario state change.
- `221b4b4f32809d3bcf3e00116339666458c5c63b` `c006 feature archive docs`: adds documentation-only or noise-only collateral.

Expected final head/history state:

- `moved-duplicate-secret` on `PartnerTokenArchive.java` should behave as `HISTORY_ONLY`.
...
- Command: `C:\maven\apache-maven-3.9.12\bin\mvn.cmd -q -DskipTests compile`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\move-duplicate-cherrypick-lineage\validation\runnability-logs\build-01.log`
...
- Command: `C:\maven\apache-maven-3.9.12\bin\mvn.cmd -q test`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\move-duplicate-cherrypick-lineage\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\move-duplicate-cherrypick-lineage\validation\runnability-logs\smoke-01.log`
...
```text
0002: 
0003: Java repo with move, duplicate, revert, and cherry-pick operations around one transient secret.
0004: 
```
...
- Detailed summary: Documentation or explanatory material for Cherry Pick. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: history-only operational note
```
...
0011:   <artifactId>move-duplicate-cherrypick-lineage</artifactId>
...
### `src/main/java/com/arq/moveduplicatecherrypicklineage/MoveduplicatecherrypicklineageApplication.java`
...
```text
0001: package com.arq.moveduplicatecherrypicklineage;
0002: 
...
0007: public class MoveduplicatecherrypicklineageApplication {
0008:     public static void main(String[] args) {
0009:         SpringApplication.run(MoveduplicatecherrypicklineageApplication.class, args);
0010:     }
0011: }
```

### `src/main/java/com/arq/moveduplicatecherrypicklineage/history/bootstrap/PartnerTokenArchive.java`
...
```text
0001: package com.arq.moveduplicatecherrypicklineage.history.bootstrap;
...
- Total LOC considered for authored/generated project content: `4141`
- Synthetic filler / inflation LOC: `2640`
- Synthetic filler ratio: `63.75%`

| category | LOC |
| --- | ---: |
| live business code | 1205 |
| live config | 3 |
| tests | 104 |
| docs | 12 |
| scripts | 1 |
...
- What makes it feel real: contains a non-trivial amount of live business code; includes meaningful automated test surfaces; build/test/smoke contracts execute successfully; models a multi-component or multi-branch enterprise layout; synthetic filler is materially visible and pulls realism down.
