# Generated Project Dossier - Q-V5-JAVA-005

## 1. Scenario Identity

- scenarioId: `Q-V5-JAVA-005`
- scenarioName: Quantum should follow helper alias flows for hostname verifier and trust manager misuse in Java.
- milestone: `M5`
- targetModule: `Quantum`
- language / stack: `Java / Spring Boot`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tls-helper-chain-java`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/tls-helper-chain-java`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tls-helper-chain-java\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\Q-V5-JAVA-005\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\Q-V5-JAVA-005.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Java client repo with helper alias and builder-chain TLS misuse.` as a `Java / Spring Boot` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Quantum should follow helper alias flows for hostname verifier and trust manager misuse in Java.`.

## 3. Architecture Summary

- Major components: `docs, ops, scripts, sql, src, validation`
- Runtime role: `Java client repo with helper alias and builder-chain TLS misuse.`
- Config flow: `src/main/resources/application.yml`
- Secret flow: `No Guardian must-find secret path in this scenario.`
- Crypto/TLS flow if relevant: `PartnerHttpBuilder.java, TrustManagerAlias.java`
- Test surfaces: `src/test/java/com/arq/tlshelperchainjava/service/BalanceServiceTest.java, src/test/java/com/arq/tlshelperchainjava/service/DisputeServiceTest.java, src/test/java/com/arq/tlshelperchainjava/service/InvoiceServiceTest.java, src/test/java/com/arq/tlshelperchainjava/service/LedgerServiceTest.java, src/test/java/com/arq/tlshelperchainjava/service/PartnerServiceTest.java, src/test/java/com/arq/tlshelperchainjava/service/PayoutServiceTest.java, src/test/java/com/arq/tlshelperchainjava/service/RefundServiceTest.java, src/test/java/com/arq/tlshelperchainjava/service/SettlementServiceTest.java`
...
|   |   |               |-- http
|   |   |               |   |-- PartnerHttpBuilder.java
|   |   |               |   |-- SecurePartnerBuilder.java
|   |   |               |   `-- TrustManagerAlias.java
|   |   |               |-- repository
...
|   |   |               `-- TlshelperchainjavaApplication.java
|   |   `-- resources
|   |       `-- application.yml
|   `-- test
|       `-- java
...
| docs/tls-helper-chain.md | docs | 1 | Documentation or explanatory material for Tls Helper Chain. | no | no | yes | no | no | no |
...
| src/main/java/com/arq/tlshelperchainjava/TlshelperchainjavaApplication.java | live-code | 11 | Runtime process bootstrap and application entrypoint. | no | no | no | yes | yes | yes |
| src/main/java/com/arq/tlshelperchainjava/domain/BalanceRecord.java | live-code | 33 | Runtime business module contributing to Balance Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/domain/DisputeRecord.java | live-code | 33 | Runtime business module contributing to Dispute Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/domain/InvoiceRecord.java | live-code | 33 | Runtime business module contributing to Invoice Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/domain/LedgerRecord.java | live-code | 33 | Runtime business module contributing to Ledger Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/domain/PartnerRecord.java | live-code | 33 | Runtime business module contributing to Partner Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/domain/PayoutRecord.java | live-code | 33 | Runtime business module contributing to Payout Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/domain/RefundRecord.java | live-code | 33 | Runtime business module contributing to Refund Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/domain/SettlementRecord.java | live-code | 33 | Runtime business module contributing to Settlement Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/dto/BalanceRequest.java | live-code | 28 | Runtime business module contributing to Balance Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/dto/BalanceResponse.java | live-code | 25 | Runtime business module contributing to Balance Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/dto/DisputeRequest.java | live-code | 28 | Runtime business module contributing to Dispute Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/dto/DisputeResponse.java | live-code | 25 | Runtime business module contributing to Dispute Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/dto/InvoiceRequest.java | live-code | 28 | Runtime business module contributing to Invoice Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/dto/InvoiceResponse.java | live-code | 25 | Runtime business module contributing to Invoice Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/dto/LedgerRequest.java | live-code | 28 | Runtime business module contributing to Ledger Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/dto/LedgerResponse.java | live-code | 25 | Runtime business module contributing to Ledger Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/dto/PartnerRequest.java | live-code | 28 | Runtime business module contributing to Partner Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/dto/PartnerResponse.java | live-code | 25 | Runtime business module contributing to Partner Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/dto/PayoutRequest.java | live-code | 28 | Runtime business module contributing to Payout Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/dto/PayoutResponse.java | live-code | 25 | Runtime business module contributing to Payout Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/dto/RefundRequest.java | live-code | 28 | Runtime business module contributing to Refund Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/dto/RefundResponse.java | live-code | 25 | Runtime business module contributing to Refund Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/dto/SettlementRequest.java | live-code | 28 | Runtime business module contributing to Settlement Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/dto/SettlementResponse.java | live-code | 25 | Runtime business module contributing to Settlement Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/http/PartnerHttpBuilder.java | live-code | 22 | Runtime business module contributing to Partner Http Builder. | yes | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/http/SecurePartnerBuilder.java | live-code | 2 | Runtime business module contributing to Secure Partner Builder. | no | yes | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/http/TrustManagerAlias.java | live-code | 20 | Runtime business module contributing to Trust Manager Alias. | yes | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/repository/BalanceRepository.java | live-code | 21 | Persistence or data-access helper for Balance Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/repository/DisputeRepository.java | live-code | 21 | Persistence or data-access helper for Dispute Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/repository/InvoiceRepository.java | live-code | 21 | Persistence or data-access helper for Invoice Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/repository/LedgerRepository.java | live-code | 21 | Persistence or data-access helper for Ledger Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/repository/PartnerRepository.java | live-code | 21 | Persistence or data-access helper for Partner Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/repository/PayoutRepository.java | live-code | 21 | Persistence or data-access helper for Payout Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/repository/RefundRepository.java | live-code | 21 | Persistence or data-access helper for Refund Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/repository/SettlementRepository.java | live-code | 21 | Persistence or data-access helper for Settlement Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/service/BalanceService.java | live-code | 19 | Runtime business service implementing Balance Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/service/DisputeService.java | live-code | 19 | Runtime business service implementing Dispute Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/service/InvoiceService.java | live-code | 19 | Runtime business service implementing Invoice Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/service/LedgerService.java | live-code | 19 | Runtime business service implementing Ledger Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/service/PartnerService.java | live-code | 19 | Runtime business service implementing Partner Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/service/PayoutService.java | live-code | 19 | Runtime business service implementing Payout Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/service/RefundService.java | live-code | 19 | Runtime business service implementing Refund Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/service/SettlementService.java | live-code | 19 | Runtime business service implementing Settlement Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/web/BalanceController.java | live-code | 23 | Runtime HTTP/controller surface for Balance Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/web/DisputeController.java | live-code | 23 | Runtime HTTP/controller surface for Dispute Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/web/InvoiceController.java | live-code | 23 | Runtime HTTP/controller surface for Invoice Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/web/LedgerController.java | live-code | 23 | Runtime HTTP/controller surface for Ledger Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/web/PartnerController.java | live-code | 23 | Runtime HTTP/controller surface for Partner Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/web/PayoutController.java | live-code | 23 | Runtime HTTP/controller surface for Payout Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/web/RefundController.java | live-code | 23 | Runtime HTTP/controller surface for Refund Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/tlshelperchainjava/web/SettlementController.java | live-code | 23 | Runtime HTTP/controller surface for Settlement Controller. | no | no | no | yes | yes | no |
...
| src/test/java/com/arq/tlshelperchainjava/service/BalanceServiceTest.java | test | 13 | Automated test surface covering Balance Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/tlshelperchainjava/service/DisputeServiceTest.java | test | 13 | Automated test surface covering Dispute Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/tlshelperchainjava/service/InvoiceServiceTest.java | test | 13 | Automated test surface covering Invoice Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/tlshelperchainjava/service/LedgerServiceTest.java | test | 13 | Automated test surface covering Ledger Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/tlshelperchainjava/service/PartnerServiceTest.java | test | 13 | Automated test surface covering Partner Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/tlshelperchainjava/service/PayoutServiceTest.java | test | 13 | Automated test surface covering Payout Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/tlshelperchainjava/service/RefundServiceTest.java | test | 13 | Automated test surface covering Refund Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/tlshelperchainjava/service/SettlementServiceTest.java | test | 13 | Automated test surface covering Settlement Service Test behavior. | no | no | yes | no | yes | no |
...
| validation/generated-project-dossier.md | generated | 796 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `src/main/java/com/arq/tlshelperchainjava/http/PartnerHttpBuilder.java`
  Why it should be detected: scenario declares `helper-hostname-bypass` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `HostnameVerifier-return-true`
  Head/history behavior: `head-only`
  Explainability expectation: resolvedValue~HostnameVerifier-return-true, queryFamily~java
- Path: `src/main/java/com/arq/tlshelperchainjava/http/TrustManagerAlias.java`
  Why it should be detected: scenario declares `helper-trust-bypass` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `X509TrustManager`
  Head/history behavior: `head-only`
  Explainability expectation: resolvedValue~X509TrustManager, queryFamily~java

## 7. Near-Real Negative Surfaces

- `src/main/java/com/arq/tlshelperchainjava/http/SecurePartnerBuilder.java`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
...
| docs/tls-helper-chain.md | docs | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
| src/test/java/com/arq/tlshelperchainjava/service/BalanceServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/tlshelperchainjava/service/DisputeServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/tlshelperchainjava/service/InvoiceServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/tlshelperchainjava/service/LedgerServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/tlshelperchainjava/service/PartnerServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/tlshelperchainjava/service/PayoutServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/tlshelperchainjava/service/RefundServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/tlshelperchainjava/service/SettlementServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- Command: `C:\maven\apache-maven-3.9.12\bin\mvn.cmd -q -DskipTests compile`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tls-helper-chain-java\validation\runnability-logs\build-01.log`
...
- Command: `C:\maven\apache-maven-3.9.12\bin\mvn.cmd -q test`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tls-helper-chain-java\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\tls-helper-chain-java\validation\runnability-logs\smoke-01.log`
...
```text
0001: # tls-helper-chain-java
0002: 
0003: Java client repo with helper alias and builder-chain TLS misuse.
0004: 
...
### `docs/tls-helper-chain.md`

- Why this file matters: `docs` file with expectation `must_not_find`.
- Detailed summary: Documentation or explanatory material for Tls Helper Chain. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: TLS helper notes stay descriptive and non-executable.
```
...
0011:   <artifactId>tls-helper-chain-java</artifactId>
...
### `src/main/java/com/arq/tlshelperchainjava/TlshelperchainjavaApplication.java`
...
```text
0001: package com.arq.tlshelperchainjava;
0002: 
...
0007: public class TlshelperchainjavaApplication {
0008:     public static void main(String[] args) {
0009:         SpringApplication.run(TlshelperchainjavaApplication.class, args);
0010:     }
0011: }
```

### `src/main/java/com/arq/tlshelperchainjava/http/PartnerHttpBuilder.java`

- Why this file matters: `live-code` file with expectation `must_find`.
- Detailed summary: Runtime business module contributing to Partner Http Builder. It is executable/live in the assembled repository.
- Key constructs: positive surface; near-real=`False`; protected=`False`.
- Representative excerpt:

```text
0001: 
0002: package com.arq.tlshelperchainjava.http;
0003: 
0004: import javax.net.ssl.HostnameVerifier;
0005: import javax.net.ssl.SSLSession;
0006: 
0007: public class PartnerHttpBuilder {
0008:     public HostnameVerifier verifier() {
0009:         return HostnameVerifierAlias.insecure();
0010:     }
0011: }
0012: 
```

### `src/main/java/com/arq/tlshelperchainjava/http/SecurePartnerBuilder.java`

- Why this file matters: `live-code` file with expectation `must_not_find`.
- Detailed summary: Runtime business module contributing to Secure Partner Builder. It is executable/live in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`True`; protected=`False`.
- Representative excerpt:

```text
0001: package com.arq.tlshelperchainjava.http;
0002: import javax.net.ssl.HostnameVerifier; import javax.net.ssl.SSLSession; public class SecurePartnerBuilder { public HostnameVerifier verifier() { return new HostnameVerifier() { @Override public boolean verify(String hostname, SSLSession session) { return hostname != null && !hostname.isBlank(); } }; } }
```

### `src/main/java/com/arq/tlshelperchainjava/http/TrustManagerAlias.java`

- Why this file matters: `live-code` file with expectation `must_find`.
- Detailed summary: Runtime business module contributing to Trust Manager Alias. It is executable/live in the assembled repository.
- Key constructs: positive surface; near-real=`False`; protected=`False`.
- Representative excerpt:

```text
0004: import java.security.cert.X509Certificate;
0005: import javax.net.ssl.X509TrustManager;
0006: 
0007: public class TrustManagerAlias implements X509TrustManager {
0008:     @Override
```

## 12. Line Composition and Filler Disclosure

- Total LOC considered for authored/generated project content: `5046`
- Synthetic filler / inflation LOC: `3520`
- Synthetic filler ratio: `69.76%`

| category | LOC |
| --- | ---: |
| live business code | 1247 |
| live config | 3 |
| tests | 104 |
| docs | 12 |
| scripts | 1 |
...
- path: `PartnerHttpBuilder.java`
  module: `Quantum`
  expected rule/finding family: `HostnameVerifier-return-true`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: resolvedValue~HostnameVerifier-return-true, queryFamily~java
- path: `TrustManagerAlias.java`
  module: `Quantum`
  expected rule/finding family: `X509TrustManager`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: resolvedValue~X509TrustManager, queryFamily~java

### must_not_find

- path: `SecurePartnerBuilder.java`
...
- `PartnerHttpBuilder.java`: resolvedValue~`HostnameVerifier-return-true`, queryFamily~`java`
- `TrustManagerAlias.java`: resolvedValue~`X509TrustManager`, queryFamily~`java`
