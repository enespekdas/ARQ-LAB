# Generated Project Dossier - N-V7-DOCS-013

## 1. Scenario Identity

- scenarioId: `N-V7-DOCS-013`
- scenarioName: Masked docs values, JWT examples, and PEM public material should remain clean.
- milestone: `M7`
- targetModule: `Both`
- language / stack: `Docs / tutorials / PKI / JWT`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\docs-jwt-pem-repo`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/docs-jwt-pem-repo`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\docs-jwt-pem-repo\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\N-V7-DOCS-013\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\N-V7-DOCS-013.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Docs repo with masked values, JWT examples, PEM public material, and tutorial snippets.` as a `Docs / tutorials / PKI / JWT` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Masked docs values, JWT examples, and PEM public material should remain clean.`.

## 3. Architecture Summary

- Major components: `app, docs, ops, scripts, sql, tests, validation`
- Runtime role: `Docs repo with masked values, JWT examples, PEM public material, and tutorial snippets.`
...
| docs/jwt/examples.md | docs | 1 | Documentation or explanatory material for Examples. | no | no | yes | no | no | no |
| docs/pem/public-chain.pem | docs | 18 | Documentation or explanatory material for Public Chain. | no | no | yes | no | no | no |
| docs/tutorials/masked-values.md | docs | 1 | Documentation or explanatory material for Masked Values. | no | no | yes | no | no | no |
...
| validation/generated-project-dossier.md | generated | 746 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
| docs/jwt/examples.md | docs | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| docs/pem/public-chain.pem | docs | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| docs/tutorials/masked-values.md | docs | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- Command: `C:\Python313\python.EXE -m compileall app tests scripts`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\docs-jwt-pem-repo\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\docs-jwt-pem-repo\validation\runnability-logs\test-01.log`
...
- Command: `C:\Python313\python.EXE scripts/smoke.py`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\docs-jwt-pem-repo\validation\runnability-logs\smoke-01.log`
...
```text
0002: 
0003: Docs repo with masked values, JWT examples, PEM public material, and tutorial snippets.
0004: 
```
...
```text
0001: Use only masked JWT examples and public claims in tutorials.
```

### `docs/pem/public-chain.pem`
...
### `docs/tutorials/masked-values.md`
...
```text
0001: Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.example.signature
```
...
- Total LOC considered for authored/generated project content: `5014`
