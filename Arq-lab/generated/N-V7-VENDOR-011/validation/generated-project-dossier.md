# Generated Project Dossier - N-V7-VENDOR-011

## 1. Scenario Identity

- scenarioId: `N-V7-VENDOR-011`
- scenarioName: Vendor and generated noise with secret-looking strings should remain clean.
- milestone: `M7`
- targetModule: `Both`
- language / stack: `Vendor / generated / minified / lockfile`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\generated-noise-repo`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/generated-noise-repo`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\generated-noise-repo\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\N-V7-VENDOR-011\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\N-V7-VENDOR-011.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Repo dominated by generated clients, minified bundles, and vendor artifacts containing scary strings.` as a `Vendor / generated / minified / lockfile` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Vendor and generated noise with secret-looking strings should remain clean.`.

## 3. Architecture Summary

- Major components: `app, docs, generated, ops, scripts, sql, tests, validation, vendor`
- Runtime role: `Repo dominated by generated clients, minified bundles, and vendor artifacts containing scary strings.`
...
| generated/openapi/client.ts | generated | 1 | Generated or derived project artifact related to Client. | no | no | yes | no | no | no |
| generated/swagger/openapi.json | generated | 1 | Generated or derived project artifact related to Openapi. | no | no | yes | no | no | no |
...
| validation/generated-project-dossier.md | generated | 761 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
| generated/openapi/client.ts | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| generated/swagger/openapi.json | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
| vendor/bundle.min.js | vendor | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- Command: `C:\Python313\python.EXE -m compileall app tests scripts`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\generated-noise-repo\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\generated-noise-repo\validation\runnability-logs\test-01.log`
...
- Command: `C:\Python313\python.EXE scripts/smoke.py`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\generated-noise-repo\validation\runnability-logs\smoke-01.log`
...
```text
0001: # generated-noise-repo
0002: 
0003: Repo dominated by generated clients, minified bundles, and vendor artifacts containing scary strings.
0004: 
...
- Detailed summary: Generated or derived project artifact related to Client. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: export const generatedExample = 'rejectUnauthorized false';
```

### `generated/swagger/openapi.json`

- Why this file matters: `generated` file with expectation `must_not_find`.
- Detailed summary: Generated or derived project artifact related to Openapi. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: {"openapi":"3.0.0","info":{"title":"Generated Client"}}
```

### `pnpm-lock.yaml`

- Why this file matters: `generated` file with expectation `must_not_find`.
- Detailed summary: Generated or derived project artifact related to Pnpm Lock. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: lockfileVersion: '9.0'
0002: packages:
0003:   /demo/1.0.0:
0004:     resolution: {integrity: sha512-placeholder-only}
```
...
- Detailed summary: Vendored or copied artifact used to simulate third-party noise around Bundle.Min. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: var a='md5 demo text';var b='NODE_TLS_REJECT_UNAUTHORIZED=0';var c='-----BEGIN PRIVATE KEY----- docs';
```
