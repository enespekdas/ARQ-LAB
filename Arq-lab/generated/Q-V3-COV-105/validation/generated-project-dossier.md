# Generated Project Dossier - Q-V3-COV-105

## 1. Scenario Identity

- scenarioId: `Q-V3-COV-105`
...
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-java-c`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/quantum-coverage-java-c`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-java-c\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\Q-V3-COV-105\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\Q-V3-COV-105.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Java crypto coverage pack C targeting remaining weak hash, cipher, JWT, XMLDSIG, and inventory families.` as a `Java / hybrid coverage pack` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.
...
- Runtime role: `Java crypto coverage pack C targeting remaining weak hash, cipher, JWT, XMLDSIG, and inventory families.`
...
- Crypto/TLS flow if relevant: `services/quantum-coverage-java-c/src/legacy/Rule001.java, services/quantum-coverage-java-c/src/legacy/Rule002.java, services/quantum-coverage-java-c/src/legacy/Rule003.java, services/quantum-coverage-java-c/src/legacy/Rule004.java, services/quantum-coverage-java-c/src/legacy/Rule005.java, services/quantum-coverage-java-c/src/legacy/Rule006.java, services/quantum-coverage-java-c/src/legacy/Rule007.java, services/quantum-coverage-java-c/src/legacy/Rule008.java, services/quantum-coverage-java-c/src/legacy/Rule009.java, services/quantum-coverage-java-c/src/legacy/Rule010.java, services/quantum-coverage-java-c/src/legacy/Rule011.java, services/quantum-coverage-java-c/src/legacy/Rule012.java, services/quantum-coverage-java-c/src/legacy/Rule013.java, services/quantum-coverage-java-c/src/legacy/Rule014.java, services/quantum-coverage-java-c/src/legacy/Rule015.java, services/quantum-coverage-java-c/src/legacy/Rule016.java, services/quantum-coverage-java-c/src/legacy/Rule017.java, services/quantum-coverage-java-c/src/legacy/Rule018.java, services/quantum-coverage-java-c/src/legacy/Rule019.java, services/quantum-coverage-java-c/src/legacy/Rule020.java, services/quantum-coverage-java-c/src/legacy/Rule021.java, services/quantum-coverage-java-c/src/legacy/Rule022.java, services/quantum-coverage-java-c/src/legacy/Rule023.java, services/quantum-coverage-java-c/src/legacy/Rule024.java, services/quantum-coverage-java-c/src/legacy/Rule025.java, services/quantum-coverage-java-c/src/legacy/Rule026.java, services/quantum-coverage-java-c/src/legacy/Rule027.java, services/quantum-coverage-java-c/src/legacy/Rule028.java, services/quantum-coverage-java-c/src/legacy/Rule029.java, services/quantum-coverage-java-c/src/legacy/Rule030.java`
...
| services/quantum-coverage-java-c/src/legacy/Rule001.java | live-code | 11 | Runtime business module contributing to Rule001. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule002.java | live-code | 12 | Runtime business module contributing to Rule002. | yes | yes | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule003.java | live-code | 12 | Runtime business module contributing to Rule003. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule004.java | live-code | 12 | Runtime business module contributing to Rule004. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule005.java | live-code | 12 | Runtime business module contributing to Rule005. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule006.java | live-code | 12 | Runtime business module contributing to Rule006. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule007.java | live-code | 12 | Runtime business module contributing to Rule007. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule008.java | live-code | 12 | Runtime business module contributing to Rule008. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule009.java | live-code | 11 | Runtime business module contributing to Rule009. | yes | yes | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule010.java | live-code | 11 | Runtime business module contributing to Rule010. | yes | yes | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule011.java | live-code | 12 | Runtime business module contributing to Rule011. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule012.java | live-code | 11 | Runtime business module contributing to Rule012. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule013.java | live-code | 11 | Runtime business module contributing to Rule013. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule014.java | live-code | 11 | Runtime business module contributing to Rule014. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule015.java | live-code | 11 | Runtime business module contributing to Rule015. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule016.java | live-code | 11 | Runtime business module contributing to Rule016. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule017.java | live-code | 11 | Runtime business module contributing to Rule017. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule018.java | live-code | 11 | Runtime business module contributing to Rule018. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule019.java | live-code | 11 | Runtime business module contributing to Rule019. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule020.java | live-code | 11 | Runtime business module contributing to Rule020. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule021.java | live-code | 11 | Runtime business module contributing to Rule021. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule022.java | live-code | 11 | Runtime business module contributing to Rule022. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule023.java | live-code | 11 | Runtime business module contributing to Rule023. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule024.java | live-code | 11 | Runtime business module contributing to Rule024. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule025.java | live-code | 11 | Runtime business module contributing to Rule025. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule026.java | live-code | 11 | Runtime business module contributing to Rule026. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule027.java | live-code | 11 | Runtime business module contributing to Rule027. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule028.java | live-code | 11 | Runtime business module contributing to Rule028. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule029.java | live-code | 11 | Runtime business module contributing to Rule029. | yes | no | no | yes | yes | no |
| services/quantum-coverage-java-c/src/legacy/Rule030.java | live-code | 11 | Runtime business module contributing to Rule030. | yes | no | no | yes | yes | no |
...
| validation/generated-project-dossier.md | generated | 1150 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
| validation/generated-tree.txt | generated | 99 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `services/quantum-coverage-java-c/src/legacy/Rule001.java`
  Why it should be detected: scenario declares `rule-001` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0190-java`
...
- Path: `services/quantum-coverage-java-c/src/legacy/Rule002.java`
  Why it should be detected: scenario declares `rule-002` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0191-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule003.java`
  Why it should be detected: scenario declares `rule-003` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0192-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule004.java`
  Why it should be detected: scenario declares `rule-004` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0193-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule005.java`
  Why it should be detected: scenario declares `rule-005` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0194-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule006.java`
  Why it should be detected: scenario declares `rule-006` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0195-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule007.java`
  Why it should be detected: scenario declares `rule-007` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0196-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule008.java`
  Why it should be detected: scenario declares `rule-008` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0197-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule009.java`
  Why it should be detected: scenario declares `rule-009` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0198-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule010.java`
  Why it should be detected: scenario declares `rule-010` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0199-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule011.java`
  Why it should be detected: scenario declares `rule-011` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0205-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule012.java`
  Why it should be detected: scenario declares `rule-012` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0206-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule013.java`
  Why it should be detected: scenario declares `rule-013` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0005-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule014.java`
  Why it should be detected: scenario declares `rule-014` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0006-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule015.java`
  Why it should be detected: scenario declares `rule-015` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0007-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule016.java`
  Why it should be detected: scenario declares `rule-016` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0008-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule017.java`
  Why it should be detected: scenario declares `rule-017` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0009-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule018.java`
  Why it should be detected: scenario declares `rule-018` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0010-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule019.java`
  Why it should be detected: scenario declares `rule-019` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0011-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule020.java`
  Why it should be detected: scenario declares `rule-020` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0014-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule021.java`
  Why it should be detected: scenario declares `rule-021` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0015-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule022.java`
  Why it should be detected: scenario declares `rule-022` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0016-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule023.java`
  Why it should be detected: scenario declares `rule-023` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0017-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule024.java`
  Why it should be detected: scenario declares `rule-024` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0019-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule025.java`
  Why it should be detected: scenario declares `rule-025` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0020-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule026.java`
  Why it should be detected: scenario declares `rule-026` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0021-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule027.java`
  Why it should be detected: scenario declares `rule-027` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0022-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule028.java`
  Why it should be detected: scenario declares `rule-028` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0023-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule029.java`
  Why it should be detected: scenario declares `rule-029` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0028-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-java-c/src/legacy/Rule030.java`
  Why it should be detected: scenario declares `rule-030` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0029-java`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.

## 7. Near-Real Negative Surfaces

- `services/quantum-coverage-java-c/src/legacy/Rule002.java`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `services/quantum-coverage-java-c/src/legacy/Rule009.java`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `services/quantum-coverage-java-c/src/legacy/Rule010.java`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
...
- Command: `C:\Python313\python.EXE scripts/validate_repo.py`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-java-c\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-java-c\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-java-c\validation\runnability-logs\smoke-01.log`
...
```text
0001: # quantum-coverage-java-c
0002: 
0003: Java crypto coverage pack C targeting remaining weak hash, cipher, JWT, XMLDSIG, and inventory families.
0004: 
...
### `services/quantum-coverage-java-c/src/legacy/Rule001.java`
...
0005:         // rule_key: quantum.arq-q-0190-java
0006:         // evidence_anchor: Cipher.getInstance("RC4
```

### `services/quantum-coverage-java-c/src/legacy/Rule002.java`
...
0006:         // rule_key: quantum.arq-q-0191-java
0007:         // evidence_anchor: setEnabledCipherSuites(new String[]{..."EXPORT"...})
```

### `services/quantum-coverage-java-c/src/legacy/Rule003.java`
...
```text
0005:     public void execute() throws Exception {
0006:         // rule_key: quantum.arq-q-0192-java
0007:         // evidence_anchor: setEnabledCipherSuites(new String[]{..."_3DES_"...})
```

### `services/quantum-coverage-java-c/src/legacy/Rule004.java`
...
```text
0005:     public void execute() throws Exception {
0006:         // rule_key: quantum.arq-q-0193-java
0007:         // evidence_anchor: setEnabledCipherSuites(new String[]{..."_DES_"...})
```

### `services/quantum-coverage-java-c/src/legacy/Rule005.java`
...
```text
0005:     public void execute() throws Exception {
0006:         // rule_key: quantum.arq-q-0194-java
0007:         // evidence_anchor: setEnabledCipherSuites(new String[]{..."_MD5"...})
0008:         // regex_sample: setEnabledCipherSuites)G61}rq`_'8 K$&}s_s1R}V_0w[!T#$ug@4;d*vtQa-K03;" 62W]zB2IF$C3[pR9-`VNh;-s ..'ey [ahIso $!VSGZ_MD5
0009:         // keywords: setEnabledCipherSuites | _MD5
0010:         SSLSocket socket = (SSLSocket) SSLSocketFactory.getDefault().createSocket(); socket.setEnabledCipherSuites(new String[]{"TLS_RSA_WITH_NULL_MD5"});
0011:     }
```

### `services/quantum-coverage-java-c/src/legacy/Rule006.java`
...
```text
0005:     public void execute() throws Exception {
0006:         // rule_key: quantum.arq-q-0195-java
0007:         // evidence_anchor: setEnabledCipherSuites(new String[]{..."_NULL_"...})
```

### `services/quantum-coverage-java-c/src/legacy/Rule007.java`
...
```text
0005:     public void execute() throws Exception {
0006:         // rule_key: quantum.arq-q-0196-java
0007:         // evidence_anchor: setEnabledCipherSuites(new String[]{..."_RC4_"...})
```

### `services/quantum-coverage-java-c/src/legacy/Rule008.java`
...
```text
0005:     public void execute() throws Exception {
0006:         // rule_key: quantum.arq-q-0197-java
0007:         // evidence_anchor: setEnabledCipherSuites(new String[]{..."_anon_"...})
```

### `services/quantum-coverage-java-c/src/legacy/Rule009.java`
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0198-java
0006:         // evidence_anchor: SSLSocket.setEnabledProtocols(new String[]{..."TLSv1"...})
```

### `services/quantum-coverage-java-c/src/legacy/Rule010.java`
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0199-java
0006:         // evidence_anchor: sslParameters.setProtocols(new String[]{..."TLSv1"...})
```

### `services/quantum-coverage-java-c/src/legacy/Rule011.java`
...
```text
0005:     public void execute() throws Exception {
0006:         // rule_key: quantum.arq-q-0205-java
0007:         // evidence_anchor: xmldsig#rsa-sha1 / xmldsig#dsa-sha1
0008:         // regex_sample: Other
0009:         // keywords: xmldsig#rsa-sha1 | xmldsig#dsa-sha1 | rsa-md5
0010:         String xmlAlgo = "http://www.w3.org/2000/09/xmldsig#rsa-sha1";
0011:     }
```

### `services/quantum-coverage-java-c/src/legacy/Rule012.java`
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0206-java
0006:         // evidence_anchor: xmlenc#rsa-1_5
```

### `services/quantum-coverage-java-c/src/legacy/Rule013.java`
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0005-java
0006:         // evidence_anchor: Cipher.getInstance("ChaCha20-Poly1305")
```

### `services/quantum-coverage-java-c/src/legacy/Rule014.java`
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0006-java
0006:         // evidence_anchor: Cipher.getInstance("ChaCha20-Poly1305")
```

### `services/quantum-coverage-java-c/src/legacy/Rule015.java`
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0007-java
0006:         // evidence_anchor: Cipher.getInstance("AES/GCM/NoPadding
```

### `services/quantum-coverage-java-c/src/legacy/Rule016.java`
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0008-java
0006:         // evidence_anchor: Cipher.getInstance("AES/CBC
```

### `services/quantum-coverage-java-c/src/legacy/Rule017.java`
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0009-java
0006:         // evidence_anchor: Cipher.getInstance("AES/CBC/PKCS5Padding
```

### `services/quantum-coverage-java-c/src/legacy/Rule018.java`
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0010-java
0006:         // evidence_anchor: Cipher.getInstance("AES/CTR
```

### `services/quantum-coverage-java-c/src/legacy/Rule019.java`
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0011-java
0006:         // evidence_anchor: Cipher.getInstance("AES/CTR/NoPadding
```

### `services/quantum-coverage-java-c/src/legacy/Rule020.java`
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0014-java
0006:         // evidence_anchor: KeyPairGenerator.getInstance("Ed25519")
```

### `services/quantum-coverage-java-c/src/legacy/Rule021.java`
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0015-java
0006:         // evidence_anchor: KeyPairGenerator.getInstance("Ed25519")
```

### `services/quantum-coverage-java-c/src/legacy/Rule022.java`
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0016-java
0006:         // evidence_anchor: KeyPairGenerator.getInstance("Ed448")
```

### `services/quantum-coverage-java-c/src/legacy/Rule023.java`
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0017-java
0006:         // evidence_anchor: KeyPairGenerator.getInstance("Ed448")
```

### `services/quantum-coverage-java-c/src/legacy/Rule024.java`
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0019-java
0006:         // evidence_anchor: KeyPairGenerator.getInstance("DSA")
```

### `services/quantum-coverage-java-c/src/legacy/Rule025.java`
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0020-java
0006:         // evidence_anchor: KeyPairGenerator.getInstance("EC")
```

### `services/quantum-coverage-java-c/src/legacy/Rule026.java`
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0021-java
0006:         // evidence_anchor: KeyPairGenerator.getInstance("Ed25519")
```

### `services/quantum-coverage-java-c/src/legacy/Rule027.java`
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0022-java
0006:         // evidence_anchor: KeyPairGenerator.getInstance("Ed448")
```

### `services/quantum-coverage-java-c/src/legacy/Rule028.java`
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0023-java
0006:         // evidence_anchor: KeyPairGenerator.getInstance("RSA")
```

### `services/quantum-coverage-java-c/src/legacy/Rule029.java`
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0028-java
0006:         // evidence_anchor: KeyPairGenerator.getInstance(...)
```

### `services/quantum-coverage-java-c/src/legacy/Rule030.java`
...
```text
0004:     public void execute() throws Exception {
0005:         // rule_key: quantum.arq-q-0029-java
0006:         // evidence_anchor: Signature.getInstance(...)
```
...
- Synthetic filler ratio: `47.38%`

| category | LOC |
| --- | ---: |
| live business code | 338 |
| live config | 11 |
| tests | 3 |
| docs | 16 |
| scripts | 2 |
...
- path: `services/quantum-coverage-java-c/src/legacy/Rule001.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0190-java`
...
- path: `services/quantum-coverage-java-c/src/legacy/Rule002.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0191-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule003.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0192-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule004.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0193-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule005.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0194-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule006.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0195-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule007.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0196-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule008.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0197-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule009.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0198-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule010.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0199-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule011.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0205-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule012.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0206-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule013.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0005-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule014.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0006-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule015.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0007-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule016.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0008-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule017.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0009-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule018.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0010-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule019.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0011-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule020.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0014-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule021.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0015-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule022.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0016-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule023.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0017-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule024.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0019-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule025.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0020-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule026.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0021-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule027.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0022-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule028.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0023-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule029.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0028-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-java-c/src/legacy/Rule030.java`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0029-java`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
