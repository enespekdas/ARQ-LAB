# Generated Project Dossier - M-V8-007

## 1. Scenario Identity

- scenarioId: `M-V8-007`
- scenarioName: Mixed workspace repo stressing head/history/ref-state alongside generated, vendor, and fixture noise.
- milestone: `M8`
- targetModule: `Both`
- language / stack: `Polyrepo-style workspace with shared libs and protected-negative surfaces`
- repoType: `mixed`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\workspace-history-mixed-repo`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/workspace-history-mixed-repo`
- default branch: `main`
...
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\workspace-history-mixed-repo\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M-V8-007\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\M-V8-007.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Workspace repo with one history-only secret, active app misuse, and multiple protected-negative generated surfaces.` as a `Polyrepo-style workspace with shared libs and protected-negative surfaces` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Mixed workspace repo stressing head/history/ref-state alongside generated, vendor, and fixture noise.`.

## 3. Architecture Summary

- Major components: `apps, deploy, docs, generated, ops, packages, scripts, services, shared, sql, validation, vendor, workers`
- Runtime role: `Workspace repo with one history-only secret, active app misuse, and multiple protected-negative generated surfaces.`
...
- `feature/shared-lib-cleanup` tip: `1b00b2bc54c1f9ace31c24252ebf5cd3ae3e1a11`; diverges from `main` at `4a0005cca8122ecf29fd4cbf28af7606629fc806`
- `main` tip: `4a0005cca8122ecf29fd4cbf28af7606629fc806`
- `release/2026.05` tip: `2523c4a71bc0f219822274383ddccc6cba665382`; diverges from `main` at `4a0005cca8122ecf29fd4cbf28af7606629fc806`

Commit order:

- `af22c0a0b0c0893d0fb871f0177b499b14c8d607` `bootstrap M-V8-007`: initial clean or baseline assembly.
- `19ed9041a9cc1a498b1f6880ba583c89575cd567` `c002 add history-only workspace secret`: introduces an intended signal.
- `4a0005cca8122ecf29fd4cbf28af7606629fc806` `c003 remove history-only workspace secret`: removes or neutralizes a prior signal.
- `1b00b2bc54c1f9ace31c24252ebf5cd3ae3e1a11` `c004 shared lib cleanup branch`: removes or neutralizes a prior signal.
- `2523c4a71bc0f219822274383ddccc6cba665382` `c005 release branch clean`: removes or neutralizes a prior signal.
...
- Command: `C:\maven\apache-maven-3.9.12\bin\mvn.cmd -q -f services/platform-java/pom.xml -DskipTests compile`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\workspace-history-mixed-repo\validation\runnability-logs\build-01.log`
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Set-Location 'apps/admin-api'; npm install --silent`
  Expected result: `build` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\workspace-history-mixed-repo\validation\runnability-logs\build-02.log`
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Set-Location 'apps/admin-api'; npm run build`
  Expected result: `build` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\workspace-history-mixed-repo\validation\runnability-logs\build-03.log`
- Command: `C:\Python313\python.EXE -m compileall workers/sync-worker/app workers/sync-worker/tests workers/sync-worker/scripts`
  Expected result: `build` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\workspace-history-mixed-repo\validation\runnability-logs\build-04.log`
...
- Command: `C:\maven\apache-maven-3.9.12\bin\mvn.cmd -q -f services/platform-java/pom.xml test`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\workspace-history-mixed-repo\validation\runnability-logs\test-01.log`
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Set-Location 'apps/admin-api'; npm test -- --runInBand`
  Expected result: `test` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\workspace-history-mixed-repo\validation\runnability-logs\test-02.log`
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Set-Location 'workers/sync-worker'; python -m pytest -q tests`
  Expected result: `test` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\workspace-history-mixed-repo\validation\runnability-logs\test-03.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\workspace-history-mixed-repo\validation\runnability-logs\smoke-01.log`
...
```text
0002: 
0003: Workspace repo with one history-only secret, active app misuse, and multiple protected-negative generated surfaces.
0004: 
```
