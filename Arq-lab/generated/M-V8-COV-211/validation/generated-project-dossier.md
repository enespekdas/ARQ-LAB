# Generated Project Dossier - M-V8-COV-211

## 1. Scenario Identity

- scenarioId: `M-V8-COV-211`
- scenarioName: Quantum precision coverage bundle exercising 4 plsql rule candidates within the Oracle 8i-to-Oracle 23c applicability slice.
- milestone: `M8`
- targetModule: `Quantum`
- language / stack: `Native / mixed precision coverage pack`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-plsql-oracle-8i-to-oracle-23c-01`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/quantum-precision-plsql-oracle-8i-to-oracle-23c-01`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-plsql-oracle-8i-to-oracle-23c-01\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M-V8-COV-211\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\M-V8-COV-211.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `plsql version-sliced precision coverage pack (Oracle 8i-to-Oracle 23c) wave 01` as a `Native / mixed precision coverage pack` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Quantum precision coverage bundle exercising 4 plsql rule candidates within the Oracle 8i-to-Oracle 23c applicability slice.`.

## 3. Architecture Summary

- Major components: `.github, config, deploy, docs, native, ops, scripts, secrets, sql, tests, validation, vendor`
- Runtime role: `plsql version-sliced precision coverage pack (Oracle 8i-to-Oracle 23c) wave 01`
...
- Crypto/TLS flow if relevant: `native/quantum-precision-plsql-oracle-8i-to-oracle-23c-01/plsql/rule_001.sql, native/quantum-precision-plsql-oracle-8i-to-oracle-23c-01/plsql/rule_002.sql, native/quantum-precision-plsql-oracle-8i-to-oracle-23c-01/plsql/rule_003.sql, secrets/quantum-precision-plsql-oracle-8i-to-oracle-23c-01/keys/rule_004.p12`
- Test surfaces: `tests/fixtures/sample-placeholder.txt, tests/test_validation.py`
- Docs/vendor/generated surfaces: `README.md, docs/architecture/section-01.md, docs/architecture/section-02.md, docs/architecture/section-03.md, docs/architecture/section-04.md, docs/architecture/section-05.md, docs/architecture/section-06.md, docs/architecture/section-07.md, docs/architecture/section-08.md, docs/coverage-notes.md, native/quantum-precision-plsql-oracle-8i-to-oracle-23c-01/plsql/rule_001.sql, native/quantum-precision-plsql-oracle-8i-to-oracle-23c-01/plsql/rule_002.sql`
...
```text
quantum-precision-plsql-oracle-8i-to-oracle-23c-01
|-- .github
|   `-- workflows
|       `-- deploy.yml
|-- config
...
| native/quantum-precision-plsql-oracle-8i-to-oracle-23c-01/plsql/rule_001.sql | generated | 5 | Generated or derived project artifact related to Rule 001. | yes | no | yes | no | no | no |
| native/quantum-precision-plsql-oracle-8i-to-oracle-23c-01/plsql/rule_002.sql | generated | 5 | Generated or derived project artifact related to Rule 002. | yes | no | yes | no | no | no |
| native/quantum-precision-plsql-oracle-8i-to-oracle-23c-01/plsql/rule_003.sql | generated | 5 | Generated or derived project artifact related to Rule 003. | yes | no | yes | no | no | no |
...
| secrets/quantum-precision-plsql-oracle-8i-to-oracle-23c-01/keys/rule_004.p12 | generated | 1 | Generated or derived project artifact related to Rule 004. | yes | no | yes | no | no | no |
...
| validation/generated-project-dossier.md | generated | 455 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `native/quantum-precision-plsql-oracle-8i-to-oracle-23c-01/plsql/rule_001.sql`
...
- Path: `native/quantum-precision-plsql-oracle-8i-to-oracle-23c-01/plsql/rule_002.sql`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `native/quantum-precision-plsql-oracle-8i-to-oracle-23c-01/plsql/rule_003.sql`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `secrets/quantum-precision-plsql-oracle-8i-to-oracle-23c-01/keys/rule_004.p12`
...
| native/quantum-precision-plsql-oracle-8i-to-oracle-23c-01/plsql/rule_001.sql | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| native/quantum-precision-plsql-oracle-8i-to-oracle-23c-01/plsql/rule_002.sql | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| native/quantum-precision-plsql-oracle-8i-to-oracle-23c-01/plsql/rule_003.sql | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| secrets/quantum-precision-plsql-oracle-8i-to-oracle-23c-01/keys/rule_004.p12 | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- Command: `C:\Python313\python.EXE scripts/validate_repo.py`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-plsql-oracle-8i-to-oracle-23c-01\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-plsql-oracle-8i-to-oracle-23c-01\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-plsql-oracle-8i-to-oracle-23c-01\validation\runnability-logs\smoke-01.log`
...
```text
0001: # quantum-precision-plsql-oracle-8i-to-oracle-23c-01
0002: 
0003: plsql version-sliced precision coverage pack (Oracle 8i-to-Oracle 23c) wave 01
0004: 
...
### `native/quantum-precision-plsql-oracle-8i-to-oracle-23c-01/plsql/rule_001.sql`
...
### `native/quantum-precision-plsql-oracle-8i-to-oracle-23c-01/plsql/rule_002.sql`
...
### `native/quantum-precision-plsql-oracle-8i-to-oracle-23c-01/plsql/rule_003.sql`
...
### `secrets/quantum-precision-plsql-oracle-8i-to-oracle-23c-01/keys/rule_004.p12`
...
- Total LOC considered for authored/generated project content: `1063`
- Synthetic filler / inflation LOC: `880`
- Synthetic filler ratio: `82.78%`
