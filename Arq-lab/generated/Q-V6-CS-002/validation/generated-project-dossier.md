...
| src/Library/Http/InsecurePartnerClientRegistration.cs | live-code | 1 | Outbound integration client for Insecure Partner Client Registration behavior. | yes | no | no | yes | no | no |
