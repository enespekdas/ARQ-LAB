# Generated Project Dossier - N-V7-VENDOR-014

## 1. Scenario Identity

- scenarioId: `N-V7-VENDOR-014`
- scenarioName: Vendor, source-map, lockfile, and generated client noise should remain clean.
- milestone: `M7`
- targetModule: `Both`
- language / stack: `Vendor / generated / minified / source-map / lockfile`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\vendor-sourcemap-noise-repo`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/vendor-sourcemap-noise-repo`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\vendor-sourcemap-noise-repo\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\N-V7-VENDOR-014\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\N-V7-VENDOR-014.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Repo full of minified bundles, source maps, lockfiles, and generated SDK clients with scary strings.` as a `Vendor / generated / minified / source-map / lockfile` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Vendor, source-map, lockfile, and generated client noise should remain clean.`.

## 3. Architecture Summary

- Major components: `app, dist, docs, generated, ops, scripts, sql, tests, validation, vendor`
- Runtime role: `Repo full of minified bundles, source maps, lockfiles, and generated SDK clients with scary strings.`
...
- Docs/vendor/generated surfaces: `README.md, dist/app.min.js.map, docs/architecture/section-01.md, docs/architecture/section-02.md, docs/architecture/section-03.md, docs/architecture/section-04.md, docs/architecture/section-05.md, docs/architecture/section-06.md, docs/architecture/section-07.md, docs/architecture/section-08.md, docs/architecture/section-09.md, docs/architecture/section-10.md`
...
| dist/app.min.js.map | generated | 1 | Generated or derived project artifact related to App.Min.Js. | no | no | yes | no | no | no |
...
| generated/client/sdk.ts | generated | 1 | Generated or derived project artifact related to Sdk. | no | no | yes | no | no | no |
...
| pnpm-lock.yaml | generated | 4 | Generated or derived project artifact related to Pnpm Lock. | no | no | yes | no | no | no |
...
| validation/generated-project-dossier.md | generated | 747 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
| validation/generated-tree.txt | generated | 194 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
| vendor/app.min.js | vendor | 1 | Vendored or copied artifact used to simulate third-party noise around App.Min. | no | no | yes | no | no | no |
...
| --- | --- | --- |
| dist/app.min.js.map | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
| generated/client/sdk.ts | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| pnpm-lock.yaml | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
| vendor/app.min.js | vendor | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- Command: `C:\Python313\python.EXE -m compileall app tests scripts`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\vendor-sourcemap-noise-repo\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\vendor-sourcemap-noise-repo\validation\runnability-logs\test-01.log`
...
- Command: `C:\Python313\python.EXE scripts/smoke.py`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\vendor-sourcemap-noise-repo\validation\runnability-logs\smoke-01.log`
...
```text
0001: # vendor-sourcemap-noise-repo
0002: 
0003: Repo full of minified bundles, source maps, lockfiles, and generated SDK clients with scary strings.
0004: 
...
- Detailed summary: Generated or derived project artifact related to App.Min.Js. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: {"version":3,"file":"app.min.js","sources":["generated/client.ts"]}
```

### `generated/client/sdk.ts`

- Why this file matters: `generated` file with expectation `must_not_find`.
- Detailed summary: Generated or derived project artifact related to Sdk. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: export const clientExample = 'NODE_TLS_REJECT_UNAUTHORIZED=0';
```
...
- Detailed summary: Vendored or copied artifact used to simulate third-party noise around App.Min. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: var a='md5 example';var b='rejectUnauthorized false';var c='-----BEGIN PRIVATE KEY----- example';
```
