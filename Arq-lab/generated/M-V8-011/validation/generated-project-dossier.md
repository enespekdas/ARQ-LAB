# Generated Project Dossier - M-V8-011

## 1. Scenario Identity

- scenarioId: `M-V8-011`
- scenarioName: Mixed workspace repo stressing head/history truth, shared-lib helpers, and protected-negative docs surfaces.
- milestone: `M8`
- targetModule: `Both`
- language / stack: `Workspace-style mixed repo with history-only secret and shared libs`
- repoType: `mixed`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\workspace-shared-libs-mixed`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/workspace-shared-libs-mixed`
- default branch: `main`
...
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\workspace-shared-libs-mixed\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M-V8-011\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\M-V8-011.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Workspace repo with history-only secret, safe docs, and mixed crypto helpers across shared libs and apps.` as a `Workspace-style mixed repo with history-only secret and shared libs` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Mixed workspace repo stressing head/history truth, shared-lib helpers, and protected-negative docs surfaces.`.

## 3. Architecture Summary

- Major components: `apps, deploy, docs, generated, ops, packages, scripts, services, shared, sql, validation, vendor, workers`
- Runtime role: `Workspace repo with history-only secret, safe docs, and mixed crypto helpers across shared libs and apps.`
...
- Secret flow: `legacy.env`
- Crypto/TLS flow if relevant: `LegacyCipherService.java, legacyDigest.ts`
...
| docs/workspace-history.md | docs | 1 | Documentation or explanatory material for Workspace History. | no | no | yes | no | no | no |
...
| packages/shared-libs/docs/safe-helpers.md | docs | 1 | Documentation or explanatory material for Safe Helpers. | no | no | no | no | no | no |
...
| services/platform-java/src/main/resources/application-prod.yml | live-config | 2 | Runtime configuration carrying environment or deployment settings for Application Prod. | no | yes | no | yes | yes | no |
...
| shared/config/keys/mesh_service.pem | generated | 10 | Generated or derived project artifact related to Mesh Service. | no | no | yes | no | no | no |
...
| validation/generated-file-manifest.json | generated | 5504 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
| validation/generated-project-dossier.md | generated | 1507 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
| validation/generated-tree.txt | generated | 478 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
| workers/sync-worker/app/clients/insecure_partner.py | live-code | 4 | Runtime business module contributing to Insecure Partner. | no | yes | no | yes | yes | no |
...
- Path: `legacy.env`
  Why it should be detected: scenario declares `guardian-history-secret` as a live positive surface.
...
| docs/workspace-history.md | docs | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- `feature/shared-lib-cleanup` tip: `68640cd84e400468041853a51d20ffe07d89c2a8`; diverges from `main` at `96910b6bb85b152415bc015cb0b02df4fae0d811`
- `main` tip: `96910b6bb85b152415bc015cb0b02df4fae0d811`
- `release/2026.05` tip: `a2755e9d6ddca32f7788d45c07e04b1689a9c384`; diverges from `main` at `96910b6bb85b152415bc015cb0b02df4fae0d811`

Commit order:

- `b3f0d619297ccd8c85e1a28560e319569a954291` `bootstrap M-V8-011`: initial clean or baseline assembly.
- `63baedf0ffacb59396e64cb6fe3f38e1e99ba926` `c002 add workspace history secret`: introduces an intended signal.
- `96910b6bb85b152415bc015cb0b02df4fae0d811` `c003 remove workspace history secret`: removes or neutralizes a prior signal.
- `a2755e9d6ddca32f7788d45c07e04b1689a9c384` `c005 release branch clean`: removes or neutralizes a prior signal.
- `68640cd84e400468041853a51d20ffe07d89c2a8` `c004 shared lib cleanup branch`: removes or neutralizes a prior signal.

Expected final head/history state:

- `guardian-history-secret` on `legacy.env` should behave as `HISTORY_ONLY`.
...
- Command: `C:\maven\apache-maven-3.9.12\bin\mvn.cmd -q -f services/platform-java/pom.xml -DskipTests compile`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\workspace-shared-libs-mixed\validation\runnability-logs\build-01.log`
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Set-Location 'apps/admin-api'; npm install --silent`
  Expected result: `build` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\workspace-shared-libs-mixed\validation\runnability-logs\build-02.log`
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Set-Location 'apps/admin-api'; npm run build`
  Expected result: `build` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\workspace-shared-libs-mixed\validation\runnability-logs\build-03.log`
- Command: `C:\Python313\python.EXE -m compileall workers/sync-worker/app workers/sync-worker/tests workers/sync-worker/scripts`
  Expected result: `build` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\workspace-shared-libs-mixed\validation\runnability-logs\build-04.log`
...
- Command: `C:\maven\apache-maven-3.9.12\bin\mvn.cmd -q -f services/platform-java/pom.xml test`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\workspace-shared-libs-mixed\validation\runnability-logs\test-01.log`
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Set-Location 'apps/admin-api'; npm test -- --runInBand`
  Expected result: `test` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\workspace-shared-libs-mixed\validation\runnability-logs\test-02.log`
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Set-Location 'workers/sync-worker'; python -m pytest -q tests`
  Expected result: `test` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\workspace-shared-libs-mixed\validation\runnability-logs\test-03.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\workspace-shared-libs-mixed\validation\runnability-logs\smoke-01.log`
...
```text
0002: 
0003: Workspace repo with history-only secret, safe docs, and mixed crypto helpers across shared libs and apps.
0004: 
```
...
### `docs/workspace-history.md`

- Why this file matters: `docs` file with expectation `must_not_find`.
- Detailed summary: Documentation or explanatory material for Workspace History. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: legacy.env token was removed; only history should retain it.
```
...
- Why this file matters: `live-config` file with expectation `may_find_review`.
...
- Total LOC considered for authored/generated project content: `14795`
...
- path: `docs/workspace-history.md`
