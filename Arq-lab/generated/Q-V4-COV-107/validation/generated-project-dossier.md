...
| validation/generated-project-dossier.md | generated | 1294 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
| workers/quantum-coverage-python-d-03/app/legacy/rule_001.py | live-code | 17 | Runtime business module contributing to Rule 001. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-03/app/legacy/rule_002.py | live-code | 17 | Runtime business module contributing to Rule 002. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-03/app/legacy/rule_003.py | live-code | 17 | Runtime business module contributing to Rule 003. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-03/app/legacy/rule_004.py | live-code | 17 | Runtime business module contributing to Rule 004. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-03/app/legacy/rule_005.py | live-code | 17 | Runtime business module contributing to Rule 005. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-03/app/legacy/rule_006.py | live-code | 17 | Runtime business module contributing to Rule 006. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-03/app/legacy/rule_007.py | live-code | 17 | Runtime business module contributing to Rule 007. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-03/app/legacy/rule_008.py | live-code | 20 | Runtime business module contributing to Rule 008. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-03/app/legacy/rule_009.py | live-code | 17 | Runtime business module contributing to Rule 009. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-03/app/legacy/rule_010.py | live-code | 17 | Runtime business module contributing to Rule 010. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-03/app/legacy/rule_011.py | live-code | 17 | Runtime business module contributing to Rule 011. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-03/app/legacy/rule_012.py | live-code | 17 | Runtime business module contributing to Rule 012. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-03/app/legacy/rule_013.py | live-code | 17 | Runtime business module contributing to Rule 013. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-03/app/legacy/rule_014.py | live-code | 17 | Runtime business module contributing to Rule 014. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-03/app/legacy/rule_015.py | live-code | 17 | Runtime business module contributing to Rule 015. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-03/app/legacy/rule_016.py | live-code | 17 | Runtime business module contributing to Rule 016. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-03/app/legacy/rule_017.py | live-code | 17 | Runtime business module contributing to Rule 017. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-03/app/legacy/rule_018.py | live-code | 17 | Runtime business module contributing to Rule 018. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-03/app/legacy/rule_019.py | live-code | 17 | Runtime business module contributing to Rule 019. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-03/app/legacy/rule_020.py | live-code | 17 | Runtime business module contributing to Rule 020. | yes | yes | no | yes | yes | no |
...
- `workers/quantum-coverage-python-d-03/app/legacy/rule_001.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-03/app/legacy/rule_002.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-03/app/legacy/rule_003.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-03/app/legacy/rule_004.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-03/app/legacy/rule_005.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-03/app/legacy/rule_006.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-03/app/legacy/rule_007.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-03/app/legacy/rule_008.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-03/app/legacy/rule_009.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-03/app/legacy/rule_010.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-03/app/legacy/rule_011.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-03/app/legacy/rule_012.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-03/app/legacy/rule_013.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-03/app/legacy/rule_014.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-03/app/legacy/rule_015.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-03/app/legacy/rule_016.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-03/app/legacy/rule_017.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-03/app/legacy/rule_018.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-03/app/legacy/rule_019.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-coverage-python-d-03/app/legacy/rule_020.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0324-python
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0325-python
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0331-python
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0332-python
0011:     # evidence_anchor: hashlib.blake2b, hashlib.blake2s
```
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0333-python
0011:     # evidence_anchor: AESGCM, ChaCha20Poly1305
```
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0334-python
0011:     # evidence_anchor: rsa.generate_private_key, ec.generate_private_key
```
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0337-python
0011:     # evidence_anchor: HKDF, HKDFExpand
```
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0339-python
0011:     # evidence_anchor: algorithm='RS256', algorithm='ES256'
0014:     import jwt
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0343-python
0011:     # evidence_anchor: import ssl
```
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0344-python
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0345-python
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0346-python
0011:     # evidence_anchor: oqs.KeyEncapsulation, Kyber768, ML-KEM-768
```
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0347-python
0011:     # evidence_anchor: oqs.Signature, Dilithium3, ML-DSA-65
```
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0348-python
0011:     # evidence_anchor: oqs.Signature, SPHINCS+, SLH-DSA
```
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0349-python
0011:     # evidence_anchor: oqs.KeyEncapsulation, FrodoKEM
```
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0350-python
0011:     # evidence_anchor: Kyber768, X25519PrivateKey, HKDF
```
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0354-python
0011:     # evidence_anchor: hashlib.sha3_256, hashlib.shake_256, hashlib.blake2b
```
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0355-python
0011:     # evidence_anchor: rsa.generate_private_key, ec.generate_private_key
```
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0357-python
0011:     # evidence_anchor: AESGCM, ChaCha20Poly1305
```
...
```text
0009: def execute():
0010:     # rule_key: quantum.arq-q-0358-python
0011:     # evidence_anchor: HKDF, HKDFExpand
```
