...
| validation/generated-project-dossier.md | generated | 896 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
| workers/quantum-coverage-python-d-02/app/legacy/rule_001.py | live-code | 10 | Runtime business module contributing to Rule 001. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-02/app/legacy/rule_002.py | live-code | 11 | Runtime business module contributing to Rule 002. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-02/app/legacy/rule_003.py | live-code | 11 | Runtime business module contributing to Rule 003. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-02/app/legacy/rule_004.py | live-code | 10 | Runtime business module contributing to Rule 004. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-02/app/legacy/rule_005.py | live-code | 11 | Runtime business module contributing to Rule 005. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-02/app/legacy/rule_006.py | live-code | 10 | Runtime business module contributing to Rule 006. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-02/app/legacy/rule_007.py | live-code | 11 | Runtime business module contributing to Rule 007. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-02/app/legacy/rule_008.py | live-code | 11 | Runtime business module contributing to Rule 008. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-02/app/legacy/rule_009.py | live-code | 10 | Runtime business module contributing to Rule 009. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-02/app/legacy/rule_010.py | live-code | 11 | Runtime business module contributing to Rule 010. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-02/app/legacy/rule_011.py | live-code | 10 | Runtime business module contributing to Rule 011. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-02/app/legacy/rule_012.py | live-code | 10 | Runtime business module contributing to Rule 012. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-02/app/legacy/rule_013.py | live-code | 10 | Runtime business module contributing to Rule 013. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-02/app/legacy/rule_014.py | live-code | 10 | Runtime business module contributing to Rule 014. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-02/app/legacy/rule_015.py | live-code | 11 | Runtime business module contributing to Rule 015. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-02/app/legacy/rule_016.py | live-code | 11 | Runtime business module contributing to Rule 016. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-02/app/legacy/rule_017.py | live-code | 10 | Runtime business module contributing to Rule 017. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-02/app/legacy/rule_018.py | live-code | 10 | Runtime business module contributing to Rule 018. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-02/app/legacy/rule_019.py | live-code | 10 | Runtime business module contributing to Rule 019. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-02/app/legacy/rule_020.py | live-code | 14 | Runtime business module contributing to Rule 020. | yes | no | no | yes | yes | no |
...
```text
0002: def execute():
0003:     # rule_key: quantum.arq-q-0266-python
0004:     # evidence_anchor: from Crypto import, from Crypto.Cipher, from Crypto.Hash
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0267-python
0005:     # evidence_anchor: import hashlib
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0293-python
0005:     # evidence_anchor: ec.generate_private_key, ec.SECP256R1
```
...
```text
0002: def execute():
0003:     # rule_key: quantum.arq-q-0296-python
0004:     # evidence_anchor: import secrets, secrets.token_bytes
0005:     # regex_sample: secrets.token_urlsafe
0006:     # keywords: import secrets | secrets.token_bytes | secrets.token_hex | secrets.token_urlsafe
0007:     import secrets, secrets.token_bytes
0008: 
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0299-python
0005:     # evidence_anchor: import ssl
```
...
```text
0002: def execute():
0003:     # rule_key: quantum.arq-q-0300-python
...
```text
0002: def execute():
0003:     # rule_key: quantum.arq-q-0311-python
0004:     # evidence_anchor: Ed25519PrivateKey, Ed448PrivateKey
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0312-python
0005:     # evidence_anchor: rsa.generate_private_key
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0314-python
0005:     # evidence_anchor: ec.SECP256R1, ec.SECP384R1, ec.SECP521R1
```
...
```text
0002: def execute():
0003:     # rule_key: quantum.arq-q-0315-python
0004:     # evidence_anchor: HKDF, cryptography.hazmat.primitives.kdf.hkdf
```
...
```text
0002: def execute():
0003:     # rule_key: quantum.arq-q-0316-python
0004:     # evidence_anchor: bcrypt.hashpw, bcrypt.gensalt
```
...
```text
0002: def execute():
0003:     # rule_key: quantum.arq-q-0317-python
0004:     # evidence_anchor: PasswordHasher, argon2
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0320-python
0005:     # evidence_anchor: algorithm='RS256', algorithm='ES256', algorithm='RS384'
0008:     import jwt
...
- Total LOC considered for authored/generated project content: `1581`
- Synthetic filler / inflation LOC: `990`
- Synthetic filler ratio: `62.62%`

| category | LOC |
| --- | ---: |
| live business code | 212 |
| live config | 11 |
| tests | 3 |
| docs | 16 |
| scripts | 2 |
