# Generated Project Dossier - N-V7-DOCS-006

## 1. Scenario Identity

- scenarioId: `N-V7-DOCS-006`
- scenarioName: Certificate chains and CSRs without private keys should remain clean.
- milestone: `M7`
- targetModule: `Both`
- language / stack: `Docs / PKI samples`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\certificate-chain-repo`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/certificate-chain-repo`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\certificate-chain-repo\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\N-V7-DOCS-006\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\N-V7-DOCS-006.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `PKI documentation repo with public cert chains, CSRs, and safe explanatory PEM material.` as a `Docs / PKI samples` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Certificate chains and CSRs without private keys should remain clean.`.

## 3. Architecture Summary

- Major components: `app, docs, examples, ops, scripts, sql, tests, validation`
- Runtime role: `PKI documentation repo with public cert chains, CSRs, and safe explanatory PEM material.`
...
| docs/pki/rotation.md | docs | 1 | Documentation or explanatory material for Rotation. | no | no | yes | no | no | no |
| examples/csr/service.csr | docs | 10 | Documentation or explanatory material for Service. | no | no | yes | no | no | no |
...
| validation/generated-project-dossier.md | generated | 760 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
| docs/pki/rotation.md | docs | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| examples/csr/service.csr | docs | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- Command: `C:\Python313\python.EXE -m compileall app tests scripts`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\certificate-chain-repo\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\certificate-chain-repo\validation\runnability-logs\test-01.log`
...
- Command: `C:\Python313\python.EXE scripts/smoke.py`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\certificate-chain-repo\validation\runnability-logs\smoke-01.log`
...
```text
0001: # certificate-chain-repo
0002: 
0003: PKI documentation repo with public cert chains, CSRs, and safe explanatory PEM material.
0004: 
...
### `docs/pki/rotation.md`

- Why this file matters: `docs` file with expectation `must_not_find`.
- Detailed summary: Documentation or explanatory material for Rotation. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: Public chain and CSR examples live here; no private key material is shipped.
```

### `examples/csr/service.csr`

- Why this file matters: `docs` file with expectation `must_not_find`.
- Detailed summary: Documentation or explanatory material for Service. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:
