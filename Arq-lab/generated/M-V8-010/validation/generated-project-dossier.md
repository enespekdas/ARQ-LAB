# Generated Project Dossier - M-V8-010

## 1. Scenario Identity

- scenarioId: `M-V8-010`
- scenarioName: Mixed infra control repo stressing branch-only Guardian exposure and live Quantum TLS config amid dormant overlays.
- milestone: `M8`
- targetModule: `Both`
- language / stack: `App + infra + helm + kustomize + terraform + CI`
- repoType: `mixed`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\control-repo-discovery`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/control-repo-discovery`
- default branch: `main`
...
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\control-repo-discovery\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M-V8-010\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\M-V8-010.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Infra-heavy control repo with branch-only secret, live TLS config, dormant overlays, and generated manifests.` as a `App + infra + helm + kustomize + terraform + CI` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Mixed infra control repo stressing branch-only Guardian exposure and live Quantum TLS config amid dormant overlays.`.

## 3. Architecture Summary

- Major components: `.github, app, deploy, docs, generated, helm, kustomize, ops, scripts, sql, terraform, tests, validation`
- Runtime role: `Infra-heavy control repo with branch-only secret, live TLS config, dormant overlays, and generated manifests.`
...
- Crypto/TLS flow if relevant: `deploy/envoy.yaml`
...
| docs/infra/discovery-wave.md | docs | 1 | Documentation or explanatory material for Discovery Wave. | no | no | yes | no | no | no |
| generated/manifests/envoy-example.yaml | generated | 1 | Generated or derived project artifact related to Envoy Example. | no | no | yes | no | no | no |
...
| kustomize/overlays/prod/kustomization.yaml | generated | 2 | Generated or derived project artifact related to Kustomization. | no | no | yes | no | no | no |
...
| ops/console/src/modules/security/legacyDigest.ts | live-code | 2 | Runtime business module contributing to Legacy Digest. | no | yes | no | yes | yes | no |
...
| validation/generated-project-dossier.md | generated | 1303 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
| docs/infra/discovery-wave.md | docs | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| generated/manifests/envoy-example.yaml | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
| kustomize/overlays/prod/kustomization.yaml | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- `feature/charts-cleanup` tip: `5f4503d03aa337b471fe177159ebee40e3cb9145`; diverges from `main` at `7c12188613e7fab9d5224c021214736725daf8e2`
- `feature/hotfix-ssl` tip: `0e12701c5332d34bf7d54bf8c3c0479fb1eb04d2`; diverges from `main` at `7c12188613e7fab9d5224c021214736725daf8e2`
- `main` tip: `7c12188613e7fab9d5224c021214736725daf8e2`
- `release/2026.04` tip: `2ffa7edd47d2d32e0e3bef786ebf8aa8f9043738`; diverges from `main` at `7c12188613e7fab9d5224c021214736725daf8e2`

Commit order:

- `7c12188613e7fab9d5224c021214736725daf8e2` `c001 bootstrap mixed repo`: initial clean or baseline assembly.
- `0e12701c5332d34bf7d54bf8c3c0479fb1eb04d2` `c002 temporary hotfix secret`: introduces an intended signal.
- `2ffa7edd47d2d32e0e3bef786ebf8aa8f9043738` `c003 release branch clean`: removes or neutralizes a prior signal.
- `5f4503d03aa337b471fe177159ebee40e3cb9145` `c004 charts cleanup branch`: removes or neutralizes a prior signal.
...
- Command: `C:\Python313\python.EXE -m compileall app tests scripts`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\control-repo-discovery\validation\runnability-logs\build-01.log`
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Set-Location 'ops/console'; npm install --silent`
  Expected result: `build` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\control-repo-discovery\validation\runnability-logs\build-02.log`
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Set-Location 'ops/console'; npm run build`
  Expected result: `build` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\control-repo-discovery\validation\runnability-logs\build-03.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q tests`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\control-repo-discovery\validation\runnability-logs\test-01.log`
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Set-Location 'ops/console'; npm test -- --runInBand`
  Expected result: `test` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\control-repo-discovery\validation\runnability-logs\test-02.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\control-repo-discovery\validation\runnability-logs\smoke-01.log`
...
```text
0002: 
0003: Infra-heavy control repo with branch-only secret, live TLS config, dormant overlays, and generated manifests.
0004: 
```
...
### `generated/manifests/envoy-example.yaml`

- Why this file matters: `generated` file with expectation `must_not_find`.
- Detailed summary: Generated or derived project artifact related to Envoy Example. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: trust_chain_verification: ACCEPT_UNTRUSTED # generated example only
```
