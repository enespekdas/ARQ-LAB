# Generated Project Dossier - N-V7-TESTS-015

## 1. Scenario Identity

- scenarioId: `N-V7-TESTS-015`
- scenarioName: Nested fixtures, mocks, and fake cert material should remain clean.
- milestone: `M7`
- targetModule: `Both`
- language / stack: `Tests / fixtures / mocks`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\fixtures-mocks-noise-repo`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/fixtures-mocks-noise-repo`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\fixtures-mocks-noise-repo\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\N-V7-TESTS-015\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\N-V7-TESTS-015.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Test-heavy repo with deeply nested fixtures, fake certs, fake tokens, and high-entropy placeholders.` as a `Tests / fixtures / mocks` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Nested fixtures, mocks, and fake cert material should remain clean.`.

## 3. Architecture Summary

- Major components: `app, docs, fixtures, mocks, ops, scripts, sql, tests, validation`
- Runtime role: `Test-heavy repo with deeply nested fixtures, fake certs, fake tokens, and high-entropy placeholders.`
...
- Test surfaces: `tests/fixtures/nested/certs/fixture.pem, tests/fixtures/nested/tokens.env, tests/test_audit_service.py, tests/test_delivery_service.py, tests/test_dispatch_service.py, tests/test_metrics_service.py, tests/test_preferences_service.py, tests/test_retry_service.py, tests/test_routing_service.py, tests/test_templates_service.py`
...
| fixtures/tokens.json | fixture | 1 | Non-production fixture or mock data used to exercise Tokens paths. | no | no | yes | no | yes | no |
| mocks/certificates/mock.pem | fixture | 2 | Non-production fixture or mock data used to exercise Mock paths. | no | no | yes | no | yes | no |
| mocks/nested/responses/payload.json | fixture | 1 | Non-production fixture or mock data used to exercise Payload paths. | no | no | yes | no | yes | no |
...
| tests/fixtures/nested/certs/fixture.pem | test | 2 | Automated test surface covering Fixture behavior. | no | no | yes | yes | yes | no |
| tests/fixtures/nested/tokens.env | test | 1 | Automated test surface covering Tokens behavior. | no | no | yes | yes | yes | no |
...
| validation/generated-project-dossier.md | generated | 770 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
| validation/generated-tree.txt | generated | 199 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
| validation/runnability-logs/build-01.log | generated | 43 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
| fixtures/tokens.json | fixture | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| mocks/certificates/mock.pem | fixture | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| mocks/nested/responses/payload.json | fixture | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
| tests/fixtures/nested/certs/fixture.pem | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| tests/fixtures/nested/tokens.env | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- Command: `C:\Python313\python.EXE -m compileall app tests scripts`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\fixtures-mocks-noise-repo\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\fixtures-mocks-noise-repo\validation\runnability-logs\test-01.log`
...
- Command: `C:\Python313\python.EXE scripts/smoke.py`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\fixtures-mocks-noise-repo\validation\runnability-logs\smoke-01.log`
...
```text
0002: 
0003: Test-heavy repo with deeply nested fixtures, fake certs, fake tokens, and high-entropy placeholders.
0004: 
```
...
- Why this file matters: `fixture` file with expectation `must_not_find`.
- Detailed summary: Non-production fixture or mock data used to exercise Tokens paths. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: {"token":"example-value","certificate":"-----BEGIN PRIVATE KEY----- example"}
```

### `mocks/certificates/mock.pem`

- Why this file matters: `fixture` file with expectation `must_not_find`.
- Detailed summary: Non-production fixture or mock data used to exercise Mock paths. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:
...
### `mocks/nested/responses/payload.json`

- Why this file matters: `fixture` file with expectation `must_not_find`.
- Detailed summary: Non-production fixture or mock data used to exercise Payload paths. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: {"jwt":"eyJhbGciOiJIUzI1NiJ9.example.signature"}
```
...
### `tests/fixtures/nested/certs/fixture.pem`

- Why this file matters: `test` file with expectation `must_not_find`.
- Detailed summary: Automated test surface covering Fixture behavior. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:
...
### `tests/fixtures/nested/tokens.env`

- Why this file matters: `test` file with expectation `must_not_find`.
- Detailed summary: Automated test surface covering Tokens behavior. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: SERVICE_TOKEN=example-only-placeholder
```

## 12. Line Composition and Filler Disclosure

- Total LOC considered for authored/generated project content: `5004`
- Synthetic filler / inflation LOC: `4730`
- Synthetic filler ratio: `94.52%`

| category | LOC |
| --- | ---: |
| live business code | 85 |
| live config | 0 |
| tests | 35 |
| docs | 11 |
| scripts | 1 |
| fixtures | 4 |
| vendor/generated | 123 |
...
- False positives are most likely on mock PEM or fixture files that contain inventory-looking text but are not live code.
