# Generated Project Dossier - Q-V3-JAVA-006

## 1. Scenario Identity

- scenarioId: `Q-V3-JAVA-006`
- scenarioName: Quantum should catch real ECB usage while keeping secure scary wrappers clean.
- milestone: `M3`
- targetModule: `Quantum`
- language / stack: `Java / Spring Boot`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\safe-wrapper-java`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/safe-wrapper-java`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\safe-wrapper-java\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\Q-V3-JAVA-006\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\Q-V3-JAVA-006.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Java crypto helper repo with scary naming and one real legacy cipher path.` as a `Java / Spring Boot` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Quantum should catch real ECB usage while keeping secure scary wrappers clean.`.

## 3. Architecture Summary

- Major components: `docs, ops, scripts, sql, src, validation`
- Runtime role: `Java crypto helper repo with scary naming and one real legacy cipher path.`
- Config flow: `src/main/resources/application.yml`
- Secret flow: `No Guardian must-find secret path in this scenario.`
- Crypto/TLS flow if relevant: `LegacyEnvelopeCipher.java`
- Test surfaces: `src/test/java/com/arq/safewrapperjava/service/BalanceServiceTest.java, src/test/java/com/arq/safewrapperjava/service/DisputeServiceTest.java, src/test/java/com/arq/safewrapperjava/service/InvoiceServiceTest.java, src/test/java/com/arq/safewrapperjava/service/LedgerServiceTest.java, src/test/java/com/arq/safewrapperjava/service/PartnerServiceTest.java, src/test/java/com/arq/safewrapperjava/service/PayoutServiceTest.java, src/test/java/com/arq/safewrapperjava/service/RefundServiceTest.java, src/test/java/com/arq/safewrapperjava/service/SettlementServiceTest.java`
...
|   |   |               |   |-- SecureBuilderAdapter.java
|   |   |               |   `-- SecureButScaryHasher.java
|   |   |               |-- service
|   |   |               |   |-- BalanceService.java
|   |   |               |   |-- DisputeService.java
|   |   |               |   |-- InvoiceService.java
...
|   |   |               `-- SafewrapperjavaApplication.java
|   |   `-- resources
|   |       `-- application.yml
|   `-- test
|       `-- java
...
| docs/crypto-facade.md | docs | 1 | Documentation or explanatory material for Crypto Facade. | no | no | yes | no | no | no |
...
| src/main/java/com/arq/safewrapperjava/SafewrapperjavaApplication.java | live-code | 11 | Runtime process bootstrap and application entrypoint. | no | no | no | yes | yes | yes |
| src/main/java/com/arq/safewrapperjava/domain/BalanceRecord.java | live-code | 33 | Runtime business module contributing to Balance Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/domain/DisputeRecord.java | live-code | 33 | Runtime business module contributing to Dispute Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/domain/InvoiceRecord.java | live-code | 33 | Runtime business module contributing to Invoice Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/domain/LedgerRecord.java | live-code | 33 | Runtime business module contributing to Ledger Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/domain/PartnerRecord.java | live-code | 33 | Runtime business module contributing to Partner Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/domain/PayoutRecord.java | live-code | 33 | Runtime business module contributing to Payout Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/domain/RefundRecord.java | live-code | 33 | Runtime business module contributing to Refund Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/domain/SettlementRecord.java | live-code | 33 | Runtime business module contributing to Settlement Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/dto/BalanceRequest.java | live-code | 28 | Runtime business module contributing to Balance Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/dto/BalanceResponse.java | live-code | 25 | Runtime business module contributing to Balance Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/dto/DisputeRequest.java | live-code | 28 | Runtime business module contributing to Dispute Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/dto/DisputeResponse.java | live-code | 25 | Runtime business module contributing to Dispute Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/dto/InvoiceRequest.java | live-code | 28 | Runtime business module contributing to Invoice Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/dto/InvoiceResponse.java | live-code | 25 | Runtime business module contributing to Invoice Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/dto/LedgerRequest.java | live-code | 28 | Runtime business module contributing to Ledger Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/dto/LedgerResponse.java | live-code | 25 | Runtime business module contributing to Ledger Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/dto/PartnerRequest.java | live-code | 28 | Runtime business module contributing to Partner Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/dto/PartnerResponse.java | live-code | 25 | Runtime business module contributing to Partner Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/dto/PayoutRequest.java | live-code | 28 | Runtime business module contributing to Payout Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/dto/PayoutResponse.java | live-code | 25 | Runtime business module contributing to Payout Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/dto/RefundRequest.java | live-code | 28 | Runtime business module contributing to Refund Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/dto/RefundResponse.java | live-code | 25 | Runtime business module contributing to Refund Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/dto/SettlementRequest.java | live-code | 28 | Runtime business module contributing to Settlement Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/dto/SettlementResponse.java | live-code | 25 | Runtime business module contributing to Settlement Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/repository/BalanceRepository.java | live-code | 21 | Persistence or data-access helper for Balance Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/repository/DisputeRepository.java | live-code | 21 | Persistence or data-access helper for Dispute Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/repository/InvoiceRepository.java | live-code | 21 | Persistence or data-access helper for Invoice Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/repository/LedgerRepository.java | live-code | 21 | Persistence or data-access helper for Ledger Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/repository/PartnerRepository.java | live-code | 21 | Persistence or data-access helper for Partner Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/repository/PayoutRepository.java | live-code | 21 | Persistence or data-access helper for Payout Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/repository/RefundRepository.java | live-code | 21 | Persistence or data-access helper for Refund Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/repository/SettlementRepository.java | live-code | 21 | Persistence or data-access helper for Settlement Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/security/LegacyEnvelopeCipher.java | live-code | 3 | Runtime business module contributing to Legacy Envelope Cipher. | yes | yes | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/security/SecureBuilderAdapter.java | live-code | 2 | Runtime business module contributing to Secure Builder Adapter. | no | yes | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/security/SecureButScaryHasher.java | live-code | 3 | Runtime business module contributing to Secure But Scary Hasher. | no | yes | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/service/BalanceService.java | live-code | 19 | Runtime business service implementing Balance Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/service/DisputeService.java | live-code | 19 | Runtime business service implementing Dispute Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/service/InvoiceService.java | live-code | 19 | Runtime business service implementing Invoice Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/service/LedgerService.java | live-code | 19 | Runtime business service implementing Ledger Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/service/PartnerService.java | live-code | 19 | Runtime business service implementing Partner Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/service/PayoutService.java | live-code | 19 | Runtime business service implementing Payout Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/service/RefundService.java | live-code | 19 | Runtime business service implementing Refund Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/service/SettlementService.java | live-code | 19 | Runtime business service implementing Settlement Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/web/BalanceController.java | live-code | 23 | Runtime HTTP/controller surface for Balance Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/web/DisputeController.java | live-code | 23 | Runtime HTTP/controller surface for Dispute Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/web/InvoiceController.java | live-code | 23 | Runtime HTTP/controller surface for Invoice Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/web/LedgerController.java | live-code | 23 | Runtime HTTP/controller surface for Ledger Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/web/PartnerController.java | live-code | 23 | Runtime HTTP/controller surface for Partner Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/web/PayoutController.java | live-code | 23 | Runtime HTTP/controller surface for Payout Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/web/RefundController.java | live-code | 23 | Runtime HTTP/controller surface for Refund Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/safewrapperjava/web/SettlementController.java | live-code | 23 | Runtime HTTP/controller surface for Settlement Controller. | no | no | no | yes | yes | no |
...
| src/test/java/com/arq/safewrapperjava/service/BalanceServiceTest.java | test | 13 | Automated test surface covering Balance Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/safewrapperjava/service/DisputeServiceTest.java | test | 13 | Automated test surface covering Dispute Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/safewrapperjava/service/InvoiceServiceTest.java | test | 13 | Automated test surface covering Invoice Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/safewrapperjava/service/LedgerServiceTest.java | test | 13 | Automated test surface covering Ledger Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/safewrapperjava/service/PartnerServiceTest.java | test | 13 | Automated test surface covering Partner Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/safewrapperjava/service/PayoutServiceTest.java | test | 13 | Automated test surface covering Payout Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/safewrapperjava/service/RefundServiceTest.java | test | 13 | Automated test surface covering Refund Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/safewrapperjava/service/SettlementServiceTest.java | test | 13 | Automated test surface covering Settlement Service Test behavior. | no | no | yes | no | yes | no |
...
| validation/generated-project-dossier.md | generated | 778 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `src/main/java/com/arq/safewrapperjava/security/LegacyEnvelopeCipher.java`
  Why it should be detected: scenario declares `legacy-ecb` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `AES/ECB/PKCS5Padding`
  Head/history behavior: `head-only`
  Explainability expectation: resolvedValue~AES/ECB/PKCS5Padding

## 7. Near-Real Negative Surfaces

- `src/main/java/com/arq/safewrapperjava/security/LegacyEnvelopeCipher.java`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `src/main/java/com/arq/safewrapperjava/security/SecureBuilderAdapter.java`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `src/main/java/com/arq/safewrapperjava/security/SecureButScaryHasher.java`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
...
| docs/crypto-facade.md | docs | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
| src/test/java/com/arq/safewrapperjava/service/BalanceServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/safewrapperjava/service/DisputeServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/safewrapperjava/service/InvoiceServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/safewrapperjava/service/LedgerServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/safewrapperjava/service/PartnerServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/safewrapperjava/service/PayoutServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/safewrapperjava/service/RefundServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/safewrapperjava/service/SettlementServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- Command: `C:\maven\apache-maven-3.9.12\bin\mvn.cmd -q -DskipTests compile`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\safe-wrapper-java\validation\runnability-logs\build-01.log`
...
- Command: `C:\maven\apache-maven-3.9.12\bin\mvn.cmd -q test`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\safe-wrapper-java\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\safe-wrapper-java\validation\runnability-logs\smoke-01.log`
...
```text
0001: # safe-wrapper-java
0002: 
0003: Java crypto helper repo with scary naming and one real legacy cipher path.
0004: 
...
### `docs/crypto-facade.md`

- Why this file matters: `docs` file with expectation `must_not_find`.
- Detailed summary: Documentation or explanatory material for Crypto Facade. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: Secure wrapper inventory only; no live weak crypto in docs.
```
...
0011:   <artifactId>safe-wrapper-java</artifactId>
...
### `src/main/java/com/arq/safewrapperjava/SafewrapperjavaApplication.java`
...
```text
0001: package com.arq.safewrapperjava;
0002: 
...
0007: public class SafewrapperjavaApplication {
0008:     public static void main(String[] args) {
0009:         SpringApplication.run(SafewrapperjavaApplication.class, args);
0010:     }
0011: }
```

### `src/main/java/com/arq/safewrapperjava/security/LegacyEnvelopeCipher.java`
...
0003: public class LegacyEnvelopeCipher { public Cipher cipher() throws Exception { return Cipher.getInstance("AES/ECB/PKCS5Padding"); } }
```

### `src/main/java/com/arq/safewrapperjava/security/SecureBuilderAdapter.java`

- Why this file matters: `live-code` file with expectation `must_not_find`.
- Detailed summary: Runtime business module contributing to Secure Builder Adapter. It is executable/live in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`True`; protected=`False`.
- Representative excerpt:

```text
0001: package com.arq.safewrapperjava.security;
0002: public class SecureBuilderAdapter { public boolean enabled() { return true; } }
```

### `src/main/java/com/arq/safewrapperjava/security/SecureButScaryHasher.java`

- Why this file matters: `live-code` file with expectation `must_not_find`.
- Detailed summary: Runtime business module contributing to Secure But Scary Hasher. It is executable/live in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`True`; protected=`False`.
- Representative excerpt:
...
0003: public class SecureButScaryHasher { public byte[] digest(byte[] value) throws Exception { return MessageDigest.getInstance("SHA-256").digest(value); } }
```
...
- path: `LegacyEnvelopeCipher.java`
  ...
  expected explainability behavior: resolvedValue~AES/ECB/PKCS5Padding

### must_not_find

- path: `SecureButScaryHasher.java`
...
- path: `SecureBuilderAdapter.java`
  why finding must not appear: scenario declares this path clean despite adversarial content or naming.
  negative type: `near-real negative`
- path: `docs/crypto-facade.md`
  why finding must not appear: scenario declares this path clean despite adversarial content or naming.
...
- `LegacyEnvelopeCipher.java`: resolvedValue~`AES/ECB/PKCS5Padding`
