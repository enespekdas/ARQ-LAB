# Generated Project Dossier - M-V8-012

## 1. Scenario Identity

- scenarioId: `M-V8-012`
- scenarioName: Mixed monorepo stressing live Python TLS misuse and Java weak crypto beside safe TS wrappers and generated noise.
- milestone: `M8`
- targetModule: `Both`
- language / stack: `Java + Node + Python mixed monorepo`
- repoType: `mixed`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\verify-mesh-monorepo`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/verify-mesh-monorepo`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\verify-mesh-monorepo\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\M-V8-012\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\M-V8-012.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Mixed monorepo with Python verify=False, Java weak crypto, TS safe wrappers, and heavy vendor/generated surfaces.` as a `Java + Node + Python mixed monorepo` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Mixed monorepo stressing live Python TLS misuse and Java weak crypto beside safe TS wrappers and generated noise.`.

## 3. Architecture Summary

- Major components: `apps, deploy, docs, generated, ops, packages, scripts, services, shared, sql, validation, vendor, workers`
- Runtime role: `Mixed monorepo with Python verify=False, Java weak crypto, TS safe wrappers, and heavy vendor/generated surfaces.`
...
- Secret flow: `application-prod.yml`
- Crypto/TLS flow if relevant: `LegacyCipherService.java, insecure_partner.py`
...
| apps/admin-api/dist/src/modules/security/secureTlsWrapper.js | live-code | 4 | Runtime business module contributing to Secure Tls Wrapper. | no | no | no | yes | yes | no |
...
| apps/admin-api/src/modules/security/legacyDigest.ts | live-code | 2 | Runtime business module contributing to Legacy Digest. | no | yes | no | yes | yes | no |
| apps/admin-api/src/modules/security/secureTlsWrapper.ts | live-code | 1 | Runtime business module contributing to Secure Tls Wrapper. | no | yes | no | yes | yes | no |
...
| generated/openapi/verify-client.ts | generated | 1 | Generated or derived project artifact related to Verify Client. | no | no | yes | no | no | no |
...
| validation/generated-project-dossier.md | generated | 1523 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
| validation/generated-tree.txt | generated | 476 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
| vendor/sdk/verify-sdk.js | vendor | 1 | Vendored or copied artifact used to simulate third-party noise around Verify Sdk. | no | no | yes | no | no | no |
...
- `apps/admin-api/src/modules/security/secureTlsWrapper.ts`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
...
| generated/openapi/verify-client.ts | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
| vendor/sdk/verify-sdk.js | vendor | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- `main` tip: `3f8e66c4dab98e9401ed15218613717980e8678f`

Commit order:

- `3f8e66c4dab98e9401ed15218613717980e8678f` `bootstrap M-V8-012`: initial clean or baseline assembly.
...
- Command: `C:\maven\apache-maven-3.9.12\bin\mvn.cmd -q -f services/platform-java/pom.xml -DskipTests compile`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\verify-mesh-monorepo\validation\runnability-logs\build-01.log`
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Set-Location 'apps/admin-api'; npm install --silent`
  Expected result: `build` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\verify-mesh-monorepo\validation\runnability-logs\build-02.log`
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Set-Location 'apps/admin-api'; npm run build`
  Expected result: `build` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\verify-mesh-monorepo\validation\runnability-logs\build-03.log`
- Command: `C:\Python313\python.EXE -m compileall workers/sync-worker/app workers/sync-worker/tests workers/sync-worker/scripts`
  Expected result: `build` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\verify-mesh-monorepo\validation\runnability-logs\build-04.log`
...
- Command: `C:\maven\apache-maven-3.9.12\bin\mvn.cmd -q -f services/platform-java/pom.xml test`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\verify-mesh-monorepo\validation\runnability-logs\test-01.log`
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Set-Location 'apps/admin-api'; npm test -- --runInBand`
  Expected result: `test` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\verify-mesh-monorepo\validation\runnability-logs\test-02.log`
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Set-Location 'workers/sync-worker'; python -m pytest -q tests`
  Expected result: `test` step completes successfully.
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\verify-mesh-monorepo\validation\runnability-logs\test-03.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\verify-mesh-monorepo\validation\runnability-logs\smoke-01.log`
...
```text
0002: 
0003: Mixed monorepo with Python verify=False, Java weak crypto, TS safe wrappers, and heavy vendor/generated surfaces.
0004: 
```
...
### `apps/admin-api/src/modules/security/secureTlsWrapper.ts`

- Why this file matters: `live-code` file with expectation `must_not_find`.
- Detailed summary: Runtime business module contributing to Secure Tls Wrapper. It is executable/live in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`True`; protected=`False`.
- Representative excerpt:

```text
0001: export function secureTlsWrapper() { return { rejectUnauthorized: true }; }
```
...
### `generated/openapi/verify-client.ts`

- Why this file matters: `generated` file with expectation `must_not_find`.
- Detailed summary: Generated or derived project artifact related to Verify Client. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: export const generatedVerifyExample = 'verify=false';
```
...
### `vendor/sdk/verify-sdk.js`

- Why this file matters: `vendor` file with expectation `must_not_find`.
- Detailed summary: Vendored or copied artifact used to simulate third-party noise around Verify Sdk. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:
...
- Total LOC considered for authored/generated project content: `14765`
- Synthetic filler / inflation LOC: `8030`
- Synthetic filler ratio: `54.39%`

| category | LOC |
| --- | ---: |
| live business code | 1557 |
| live config | 7 |
| tests | 0 |
| docs | 47 |
| scripts | 1 |
| fixtures | 0 |
| vendor/generated | 334 |
