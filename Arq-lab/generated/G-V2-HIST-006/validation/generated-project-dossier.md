# Generated Project Dossier - G-V2-HIST-006

## 1. Scenario Identity

- scenarioId: `G-V2-HIST-006`
- scenarioName: Guardian history handling for moved and reverted secret lineage on main.
- milestone: `M2`
- targetModule: `Guardian`
- language / stack: `Java / Spring Boot`
- repoType: `history`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\partner-relocation-lineage`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/partner-relocation-lineage`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT, REF_HISTORY`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\partner-relocation-lineage\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\G-V2-HIST-006\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\G-V2-HIST-006.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Partner bootstrap repo with file relocation, rename, and revert history around a transient secret.` as a `Java / Spring Boot` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Guardian history handling for moved and reverted secret lineage on main.`.

## 3. Architecture Summary

- Major components: `docs, ops, scripts, sql, src, validation`
- Runtime role: `Partner bootstrap repo with file relocation, rename, and revert history around a transient secret.`
- Config flow: `src/main/resources/application.yml`
- Secret flow: `PartnerTokenRelocationArchive.java`
- Crypto/TLS flow if relevant: `Not a Quantum-positive scenario.`
- Test surfaces: `src/test/java/com/arq/partnerrelocationlineage/service/BalanceServiceTest.java, src/test/java/com/arq/partnerrelocationlineage/service/DisputeServiceTest.java, src/test/java/com/arq/partnerrelocationlineage/service/InvoiceServiceTest.java, src/test/java/com/arq/partnerrelocationlineage/service/LedgerServiceTest.java, src/test/java/com/arq/partnerrelocationlineage/service/PartnerServiceTest.java, src/test/java/com/arq/partnerrelocationlineage/service/PayoutServiceTest.java, src/test/java/com/arq/partnerrelocationlineage/service/RefundServiceTest.java, src/test/java/com/arq/partnerrelocationlineage/service/SettlementServiceTest.java`
...
|   |   |               |   |-- PayoutService.java
|   |   |               |   |-- RefundService.java
|   |   |               |   |-- RelocationCleanup.java
|   |   |               |   |-- RelocationMetrics.java
...
|   |   |               `-- PartnerrelocationlineageApplication.java
|   |   `-- resources
|   |       `-- application.yml
|   `-- test
|       `-- java
...
| docs/relocation-plan.md | docs | 1 | Documentation or explanatory material for Relocation Plan. | no | no | yes | no | no | no |
...
| src/main/java/com/arq/partnerrelocationlineage/PartnerrelocationlineageApplication.java | live-code | 11 | Runtime process bootstrap and application entrypoint. | no | no | no | yes | yes | yes |
| src/main/java/com/arq/partnerrelocationlineage/domain/BalanceRecord.java | live-code | 33 | Runtime business module contributing to Balance Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/domain/DisputeRecord.java | live-code | 33 | Runtime business module contributing to Dispute Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/domain/InvoiceRecord.java | live-code | 33 | Runtime business module contributing to Invoice Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/domain/LedgerRecord.java | live-code | 33 | Runtime business module contributing to Ledger Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/domain/PartnerRecord.java | live-code | 33 | Runtime business module contributing to Partner Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/domain/PayoutRecord.java | live-code | 33 | Runtime business module contributing to Payout Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/domain/RefundRecord.java | live-code | 33 | Runtime business module contributing to Refund Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/domain/SettlementRecord.java | live-code | 33 | Runtime business module contributing to Settlement Record. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/dto/BalanceRequest.java | live-code | 28 | Runtime business module contributing to Balance Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/dto/BalanceResponse.java | live-code | 25 | Runtime business module contributing to Balance Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/dto/DisputeRequest.java | live-code | 28 | Runtime business module contributing to Dispute Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/dto/DisputeResponse.java | live-code | 25 | Runtime business module contributing to Dispute Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/dto/InvoiceRequest.java | live-code | 28 | Runtime business module contributing to Invoice Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/dto/InvoiceResponse.java | live-code | 25 | Runtime business module contributing to Invoice Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/dto/LedgerRequest.java | live-code | 28 | Runtime business module contributing to Ledger Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/dto/LedgerResponse.java | live-code | 25 | Runtime business module contributing to Ledger Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/dto/PartnerRequest.java | live-code | 28 | Runtime business module contributing to Partner Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/dto/PartnerResponse.java | live-code | 25 | Runtime business module contributing to Partner Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/dto/PayoutRequest.java | live-code | 28 | Runtime business module contributing to Payout Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/dto/PayoutResponse.java | live-code | 25 | Runtime business module contributing to Payout Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/dto/RefundRequest.java | live-code | 28 | Runtime business module contributing to Refund Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/dto/RefundResponse.java | live-code | 25 | Runtime business module contributing to Refund Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/dto/SettlementRequest.java | live-code | 28 | Runtime business module contributing to Settlement Request. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/dto/SettlementResponse.java | live-code | 25 | Runtime business module contributing to Settlement Response. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/history/relocation/PartnerTokenRelocationArchive.java | live-code | 2 | Runtime business module contributing to Partner Token Relocation Archive. | yes | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/repository/BalanceRepository.java | live-code | 21 | Persistence or data-access helper for Balance Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/repository/DisputeRepository.java | live-code | 21 | Persistence or data-access helper for Dispute Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/repository/InvoiceRepository.java | live-code | 21 | Persistence or data-access helper for Invoice Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/repository/LedgerRepository.java | live-code | 21 | Persistence or data-access helper for Ledger Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/repository/PartnerRepository.java | live-code | 21 | Persistence or data-access helper for Partner Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/repository/PayoutRepository.java | live-code | 21 | Persistence or data-access helper for Payout Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/repository/RefundRepository.java | live-code | 21 | Persistence or data-access helper for Refund Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/repository/SettlementRepository.java | live-code | 21 | Persistence or data-access helper for Settlement Repository. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/service/BalanceService.java | live-code | 19 | Runtime business service implementing Balance Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/service/DisputeService.java | live-code | 19 | Runtime business service implementing Dispute Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/service/InvoiceService.java | live-code | 19 | Runtime business service implementing Invoice Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/service/LedgerService.java | live-code | 19 | Runtime business service implementing Ledger Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/service/PartnerService.java | live-code | 19 | Runtime business service implementing Partner Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/service/PayoutService.java | live-code | 19 | Runtime business service implementing Payout Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/service/RefundService.java | live-code | 19 | Runtime business service implementing Refund Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/service/RelocationCleanup.java | live-code | 2 | Runtime business module contributing to Relocation Cleanup. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/service/RelocationMetrics.java | live-code | 2 | Runtime business module contributing to Relocation Metrics. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/service/SettlementService.java | live-code | 19 | Runtime business service implementing Settlement Service logic. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/web/BalanceController.java | live-code | 23 | Runtime HTTP/controller surface for Balance Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/web/DisputeController.java | live-code | 23 | Runtime HTTP/controller surface for Dispute Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/web/InvoiceController.java | live-code | 23 | Runtime HTTP/controller surface for Invoice Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/web/LedgerController.java | live-code | 23 | Runtime HTTP/controller surface for Ledger Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/web/PartnerController.java | live-code | 23 | Runtime HTTP/controller surface for Partner Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/web/PayoutController.java | live-code | 23 | Runtime HTTP/controller surface for Payout Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/web/RefundController.java | live-code | 23 | Runtime HTTP/controller surface for Refund Controller. | no | no | no | yes | yes | no |
| src/main/java/com/arq/partnerrelocationlineage/web/SettlementController.java | live-code | 23 | Runtime HTTP/controller surface for Settlement Controller. | no | no | no | yes | yes | no |
...
| src/test/java/com/arq/partnerrelocationlineage/service/BalanceServiceTest.java | test | 13 | Automated test surface covering Balance Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/partnerrelocationlineage/service/DisputeServiceTest.java | test | 13 | Automated test surface covering Dispute Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/partnerrelocationlineage/service/InvoiceServiceTest.java | test | 13 | Automated test surface covering Invoice Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/partnerrelocationlineage/service/LedgerServiceTest.java | test | 13 | Automated test surface covering Ledger Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/partnerrelocationlineage/service/PartnerServiceTest.java | test | 13 | Automated test surface covering Partner Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/partnerrelocationlineage/service/PayoutServiceTest.java | test | 13 | Automated test surface covering Payout Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/partnerrelocationlineage/service/RefundServiceTest.java | test | 13 | Automated test surface covering Refund Service Test behavior. | no | no | yes | no | yes | no |
| src/test/java/com/arq/partnerrelocationlineage/service/SettlementServiceTest.java | test | 13 | Automated test surface covering Settlement Service Test behavior. | no | no | yes | no | yes | no |
...
| validation/generated-project-dossier.md | generated | 677 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
| validation/repo-metadata.json | generated | 65 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `src/main/java/com/arq/partnerrelocationlineage/history/relocation/PartnerTokenRelocationArchive.java`
  Why it should be detected: scenario declares `history-relocated-secret` as a live positive surface.
...
| docs/relocation-plan.md | docs | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
| src/test/java/com/arq/partnerrelocationlineage/service/BalanceServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/partnerrelocationlineage/service/DisputeServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/partnerrelocationlineage/service/InvoiceServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/partnerrelocationlineage/service/LedgerServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/partnerrelocationlineage/service/PartnerServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/partnerrelocationlineage/service/PayoutServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/partnerrelocationlineage/service/RefundServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
| src/test/java/com/arq/partnerrelocationlineage/service/SettlementServiceTest.java | test | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- `main` tip: `332fb17e113d7fd020a6fdee5bbb3dd4939ef501`

Commit order:

- `555ea7946c3d8b0baac7eddceb354e66e9e76074` `c001 bootstrap repo`: initial clean or baseline assembly.
- `3b6f05d0e61a619713359ad013c1fce42a7ba5fb` `c002 add transient relocation token`: introduces an intended signal.
- `4b5009dc291be6a10318d73f0913f98111de3ecd` `c003 move token into relocation archive`: scenario state change.
- `08dac63c2207d484e9ff08193b11888c4b5e327c` `c004 add relocation plan noise`: introduces an intended signal.
- `cfa8b997d596aa8bbe23b86360aa8da4b23fa64c` `c005 remove relocation token from head`: removes or neutralizes a prior signal.
- `b9c98ab52cd161f1cb9a06d092b3b027f4dcf012` `c006 unrelated relocation cleanup`: removes or neutralizes a prior signal.
- `332fb17e113d7fd020a6fdee5bbb3dd4939ef501` `c007 add safe metrics`: introduces an intended signal.

Expected final head/history state:

- `history-relocated-secret` on `PartnerTokenRelocationArchive.java` should behave as `HISTORY_ONLY`.
...
- Command: `C:\maven\apache-maven-3.9.12\bin\mvn.cmd -q -DskipTests compile`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\partner-relocation-lineage\validation\runnability-logs\build-01.log`
...
- Command: `C:\maven\apache-maven-3.9.12\bin\mvn.cmd -q test`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\partner-relocation-lineage\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\partner-relocation-lineage\validation\runnability-logs\smoke-01.log`
...
```text
0002: 
0003: Partner bootstrap repo with file relocation, rename, and revert history around a transient secret.
0004: 
```

### `docs/relocation-plan.md`

- Why this file matters: `docs` file with expectation `must_not_find`.
- Detailed summary: Documentation or explanatory material for Relocation Plan. It is non-live or protected in the assembled repository.
- Key constructs: negative or realism-supporting surface; near-real=`False`; protected=`True`.
- Representative excerpt:

```text
0001: masked_partner_token=****
```
...
0011:   <artifactId>partner-relocation-lineage</artifactId>
...
### `src/main/java/com/arq/partnerrelocationlineage/PartnerrelocationlineageApplication.java`
...
```text
0001: package com.arq.partnerrelocationlineage;
0002: 
...
0007: public class PartnerrelocationlineageApplication {
0008:     public static void main(String[] args) {
0009:         SpringApplication.run(PartnerrelocationlineageApplication.class, args);
0010:     }
0011: }
```

### `src/main/java/com/arq/partnerrelocationlineage/history/relocation/PartnerTokenRelocationArchive.java`

- Why this file matters: `live-code` file with expectation `must_find`.
- Detailed summary: Runtime business module contributing to Partner Token Relocation Archive. It is executable/live in the assembled repository.
- Key constructs: positive surface; near-real=`False`; protected=`False`.
- Representative excerpt:

```text
0001: package com.arq.partnerrelocationlineage.history.relocation;
0002: public class PartnerTokenRelocationArchive { private static final String PARTNER_TOKEN = "safe-reference"; public String current() { return PARTNER_TOKEN; } }
```

## 12. Line Composition and Filler Disclosure

- Total LOC considered for authored/generated project content: `4139`
- Synthetic filler / inflation LOC: `2640`
- Synthetic filler ratio: `63.78%`
...
- path: `PartnerTokenRelocationArchive.java`
  module: `Guardian`
