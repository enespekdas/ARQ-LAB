...
| validation/generated-project-dossier.md | generated | 894 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
| workers/quantum-coverage-python-d-01/app/legacy/rule_001.py | live-code | 12 | Runtime business module contributing to Rule 001. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-01/app/legacy/rule_002.py | live-code | 11 | Runtime business module contributing to Rule 002. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-01/app/legacy/rule_003.py | live-code | 11 | Runtime business module contributing to Rule 003. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-01/app/legacy/rule_004.py | live-code | 11 | Runtime business module contributing to Rule 004. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-01/app/legacy/rule_005.py | live-code | 11 | Runtime business module contributing to Rule 005. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-01/app/legacy/rule_006.py | live-code | 11 | Runtime business module contributing to Rule 006. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-01/app/legacy/rule_007.py | live-code | 11 | Runtime business module contributing to Rule 007. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-01/app/legacy/rule_008.py | live-code | 11 | Runtime business module contributing to Rule 008. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-01/app/legacy/rule_009.py | live-code | 11 | Runtime business module contributing to Rule 009. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-01/app/legacy/rule_010.py | live-code | 11 | Runtime business module contributing to Rule 010. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-01/app/legacy/rule_011.py | live-code | 11 | Runtime business module contributing to Rule 011. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-01/app/legacy/rule_012.py | live-code | 11 | Runtime business module contributing to Rule 012. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-01/app/legacy/rule_013.py | live-code | 11 | Runtime business module contributing to Rule 013. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-01/app/legacy/rule_014.py | live-code | 11 | Runtime business module contributing to Rule 014. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-01/app/legacy/rule_015.py | live-code | 11 | Runtime business module contributing to Rule 015. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-01/app/legacy/rule_016.py | live-code | 11 | Runtime business module contributing to Rule 016. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-01/app/legacy/rule_017.py | live-code | 11 | Runtime business module contributing to Rule 017. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-01/app/legacy/rule_018.py | live-code | 11 | Runtime business module contributing to Rule 018. | yes | yes | no | yes | yes | no |
| workers/quantum-coverage-python-d-01/app/legacy/rule_019.py | live-code | 11 | Runtime business module contributing to Rule 019. | yes | no | no | yes | yes | no |
| workers/quantum-coverage-python-d-01/app/legacy/rule_020.py | live-code | 11 | Runtime business module contributing to Rule 020. | yes | no | no | yes | yes | no |
...
```text
0004: def execute():
0005:     # rule_key: quantum.arq-q-0374-python
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0378-python
0005:     # evidence_anchor: OpenSSL.SSL.VERIFY_NONE, Context.set_verify
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0379-python
0005:     # evidence_anchor: OpenSSL.SSL.VERIFY_NONE, Context.set_verify
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0380-python
0005:     # evidence_anchor: OpenSSL.SSL.VERIFY_NONE, Context.set_verify
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0383-python
0005:     # evidence_anchor: paramiko.AutoAddPolicy, set_missing_host_key_policy
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0384-python
0005:     # evidence_anchor: paramiko.AutoAddPolicy, set_missing_host_key_policy
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0385-python
0005:     # evidence_anchor: paramiko.AutoAddPolicy, set_missing_host_key_policy
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0393-python
0005:     # evidence_anchor: rsa.newkeys, key size literal
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0395-python
0005:     # evidence_anchor: rsa.newkeys, key size literal
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0397-python
0005:     # evidence_anchor: rsa.newkeys, key size literal
```
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0265-python
0005:     # evidence_anchor: import ssl
```

## 12. Line Composition and Filler Disclosure

- Total LOC considered for authored/generated project content: `1480`
- Synthetic filler / inflation LOC: `880`
- Synthetic filler ratio: `59.46%`

| category | LOC |
| --- | ---: |
| live business code | 221 |
| live config | 11 |
| tests | 3 |
| docs | 16 |
| scripts | 2 |
