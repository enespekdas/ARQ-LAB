# Generated Project Dossier - Q-V3-COV-112

## 1. Scenario Identity

- scenarioId: `Q-V3-COV-112`
...
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-csharp-d-01`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/quantum-coverage-csharp-d-01`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-csharp-d-01\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\Q-V3-COV-112\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\Q-V3-COV-112.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `C# crypto and TLS late-slice coverage pack wave 01` as a `C# / hybrid coverage pack` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.
...
- Runtime role: `C# crypto and TLS late-slice coverage pack wave 01`
...
- Crypto/TLS flow if relevant: `services/quantum-coverage-csharp-d-01/src/legacy/Rule001.cs, services/quantum-coverage-csharp-d-01/src/legacy/Rule002.cs, services/quantum-coverage-csharp-d-01/src/legacy/Rule003.cs, services/quantum-coverage-csharp-d-01/src/legacy/Rule004.cs, services/quantum-coverage-csharp-d-01/src/legacy/Rule005.cs, services/quantum-coverage-csharp-d-01/src/legacy/Rule006.cs, services/quantum-coverage-csharp-d-01/src/legacy/Rule007.cs, services/quantum-coverage-csharp-d-01/src/legacy/Rule008.cs, services/quantum-coverage-csharp-d-01/src/legacy/Rule009.cs, services/quantum-coverage-csharp-d-01/src/legacy/Rule010.cs, services/quantum-coverage-csharp-d-01/src/legacy/Rule011.cs, services/quantum-coverage-csharp-d-01/src/legacy/Rule012.cs, services/quantum-coverage-csharp-d-01/src/legacy/Rule013.cs, services/quantum-coverage-csharp-d-01/src/legacy/Rule014.cs, services/quantum-coverage-csharp-d-01/src/legacy/Rule015.cs, services/quantum-coverage-csharp-d-01/src/legacy/Rule016.cs, services/quantum-coverage-csharp-d-01/src/legacy/Rule017.cs, services/quantum-coverage-csharp-d-01/src/legacy/Rule018.cs, services/quantum-coverage-csharp-d-01/src/legacy/Rule019.cs, services/quantum-coverage-csharp-d-01/src/legacy/Rule020.cs`
...
| services/quantum-coverage-csharp-d-01/src/legacy/Rule001.cs | live-code | 15 | Runtime business module contributing to Rule001. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule002.cs | live-code | 15 | Runtime business module contributing to Rule002. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule003.cs | live-code | 15 | Runtime business module contributing to Rule003. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule004.cs | live-code | 15 | Runtime business module contributing to Rule004. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule005.cs | live-code | 15 | Runtime business module contributing to Rule005. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule006.cs | live-code | 15 | Runtime business module contributing to Rule006. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule007.cs | live-code | 15 | Runtime business module contributing to Rule007. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule008.cs | live-code | 15 | Runtime business module contributing to Rule008. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule009.cs | live-code | 15 | Runtime business module contributing to Rule009. | yes | yes | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule010.cs | live-code | 15 | Runtime business module contributing to Rule010. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule011.cs | live-code | 15 | Runtime business module contributing to Rule011. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule012.cs | live-code | 15 | Runtime business module contributing to Rule012. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule013.cs | live-code | 15 | Runtime business module contributing to Rule013. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule014.cs | live-code | 15 | Runtime business module contributing to Rule014. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule015.cs | live-code | 15 | Runtime business module contributing to Rule015. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule016.cs | live-code | 15 | Runtime business module contributing to Rule016. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule017.cs | live-code | 15 | Runtime business module contributing to Rule017. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule018.cs | live-code | 15 | Runtime business module contributing to Rule018. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule019.cs | live-code | 15 | Runtime business module contributing to Rule019. | yes | no | no | yes | yes | no |
| services/quantum-coverage-csharp-d-01/src/legacy/Rule020.cs | live-code | 15 | Runtime business module contributing to Rule020. | yes | no | no | yes | yes | no |
...
- Path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule001.cs`
  Why it should be detected: scenario declares `rule-001` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0447-csharp`
...
- Path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule002.cs`
  Why it should be detected: scenario declares `rule-002` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0455-csharp`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule003.cs`
  Why it should be detected: scenario declares `rule-003` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0457-csharp`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule004.cs`
  Why it should be detected: scenario declares `rule-004` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0463-csharp`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule005.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule006.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule007.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule008.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule009.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule010.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule011.cs`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule012.cs`
  Why it should be detected: scenario declares `rule-012` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0485-csharp`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule013.cs`
  Why it should be detected: scenario declares `rule-013` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0489-csharp`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule014.cs`
  Why it should be detected: scenario declares `rule-014` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0491-csharp`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule015.cs`
  Why it should be detected: scenario declares `rule-015` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0492-csharp`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule016.cs`
  Why it should be detected: scenario declares `rule-016` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0493-csharp`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule017.cs`
  Why it should be detected: scenario declares `rule-017` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0494-csharp`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule018.cs`
  Why it should be detected: scenario declares `rule-018` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0495-csharp`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule019.cs`
  Why it should be detected: scenario declares `rule-019` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0500-csharp`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule020.cs`
  Why it should be detected: scenario declares `rule-020` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0501-csharp`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.

## 7. Near-Real Negative Surfaces

- `services/quantum-coverage-csharp-d-01/src/legacy/Rule009.cs`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
...
- Command: `C:\Python313\python.EXE scripts/validate_repo.py`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-csharp-d-01\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-csharp-d-01\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-coverage-csharp-d-01\validation\runnability-logs\smoke-01.log`
...
```text
0001: # quantum-coverage-csharp-d-01
0002: 
0003: C# crypto and TLS late-slice coverage pack wave 01
0004: 
...
### `services/quantum-coverage-csharp-d-01/src/legacy/Rule001.cs`
...
0009:         // rule_key: quantum.arq-q-0447-csharp
0010:         // evidence_anchor: using System.Security.Cryptography.X509Certificates
```

### `services/quantum-coverage-csharp-d-01/src/legacy/Rule002.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0455-csharp
0010:         // evidence_anchor: RSA.Create, RSACng, RSACryptoServiceProvider
```

### `services/quantum-coverage-csharp-d-01/src/legacy/Rule003.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0457-csharp
0010:         // evidence_anchor: ECDsa.Create, ECDsaCng
```

### `services/quantum-coverage-csharp-d-01/src/legacy/Rule004.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0463-csharp
0010:         // evidence_anchor: using System.Security.Cryptography
```

### `services/quantum-coverage-csharp-d-01/src/legacy/Rule005.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0471-csharp
0010:         // evidence_anchor: AesGcm
```

### `services/quantum-coverage-csharp-d-01/src/legacy/Rule006.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0472-csharp
0010:         // evidence_anchor: ChaCha20Poly1305
```

### `services/quantum-coverage-csharp-d-01/src/legacy/Rule007.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0474-csharp
0010:         // evidence_anchor: RSA.Create, RSACng, RSAOpenSsl
```

### `services/quantum-coverage-csharp-d-01/src/legacy/Rule008.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0476-csharp
0010:         // evidence_anchor: ECDsa.Create, ECDsaCng, ECDsaOpenSsl
```

### `services/quantum-coverage-csharp-d-01/src/legacy/Rule009.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0480-csharp
0010:         // evidence_anchor: RandomNumberGenerator.GetBytes, RandomNumberGenerator.Fill
```

### `services/quantum-coverage-csharp-d-01/src/legacy/Rule010.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0483-csharp
0010:         // evidence_anchor: using System.Security.Cryptography
```

### `services/quantum-coverage-csharp-d-01/src/legacy/Rule011.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0484-csharp
0010:         // evidence_anchor: using System.Net.Http
```

### `services/quantum-coverage-csharp-d-01/src/legacy/Rule012.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0485-csharp
0010:         // evidence_anchor: Microsoft.AspNetCore.DataProtection
```

### `services/quantum-coverage-csharp-d-01/src/legacy/Rule013.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0489-csharp
0010:         // evidence_anchor: SHA3_256, SHA3_384, SHA3_512
```

### `services/quantum-coverage-csharp-d-01/src/legacy/Rule014.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0491-csharp
0010:         // evidence_anchor: AesGcm
```

### `services/quantum-coverage-csharp-d-01/src/legacy/Rule015.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0492-csharp
0010:         // evidence_anchor: ChaCha20Poly1305
```

### `services/quantum-coverage-csharp-d-01/src/legacy/Rule016.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0493-csharp
0010:         // evidence_anchor: HKDF.Extract, HKDF.Expand, HKDF.DeriveKey
```

### `services/quantum-coverage-csharp-d-01/src/legacy/Rule017.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0494-csharp
0010:         // evidence_anchor: RSA.Create
```

### `services/quantum-coverage-csharp-d-01/src/legacy/Rule018.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0495-csharp
0010:         // evidence_anchor: ECDsa.Create
```

### `services/quantum-coverage-csharp-d-01/src/legacy/Rule019.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0500-csharp
0010:         // evidence_anchor: ImportFromPem, CreateFromPem
```

### `services/quantum-coverage-csharp-d-01/src/legacy/Rule020.cs`
...
```text
0008:     public static void Execute() {
0009:         // rule_key: quantum.arq-q-0501-csharp
0010:         // evidence_anchor: using System.Security.Cryptography
```

## 12. Line Composition and Filler Disclosure

- Total LOC considered for authored/generated project content: `7165`
- Synthetic filler / inflation LOC: `6490`
- Synthetic filler ratio: `90.58%`

| category | LOC |
| --- | ---: |
| live business code | 300 |
| live config | 11 |
| tests | 3 |
| docs | 16 |
| scripts | 2 |
...
- path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule001.cs`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0447-csharp`
...
- path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule002.cs`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0455-csharp`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule003.cs`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0457-csharp`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule004.cs`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0463-csharp`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule005.cs`
  module: `Quantum`
...
- path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule012.cs`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0485-csharp`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule013.cs`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0489-csharp`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule014.cs`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0491-csharp`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule015.cs`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0492-csharp`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule016.cs`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0493-csharp`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule017.cs`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0494-csharp`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule018.cs`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0495-csharp`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule019.cs`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0500-csharp`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `services/quantum-coverage-csharp-d-01/src/legacy/Rule020.cs`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0501-csharp`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
