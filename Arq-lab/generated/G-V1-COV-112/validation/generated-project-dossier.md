# Generated Project Dossier - G-V1-COV-112

## 1. Scenario Identity

- scenarioId: `G-V1-COV-112`
- scenarioName: Guardian provider coverage bundle exercising 4 distinct secret families.
- milestone: `M1`
- targetModule: `Guardian`
- language / stack: `Config / IaC / CI credential coverage bundle`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\guardian-coverage-long-tail`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/guardian-coverage-long-tail`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\guardian-coverage-long-tail\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\G-V1-COV-112\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\G-V1-COV-112.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `Long-tail provider credential corpus covering the remaining active Guardian families needed for truthful coverage.` as a `Config / IaC / CI credential coverage bundle` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Guardian provider coverage bundle exercising 4 distinct secret families.`.

## 3. Architecture Summary

- Major components: `.github, config, deploy, docs, integrations, ops, scripts, sql, terraform, tests, validation, vendor`
- Runtime role: `Long-tail provider credential corpus covering the remaining active Guardian families needed for truthful coverage.`
- Config flow: `.github/workflows/deploy.yml, config/runtime/baseline.yaml, deploy/guardian-coverage-long-tail/provider_003.properties, deploy/prod/service.properties, integrations/guardian-coverage-long-tail/config/provider_002.yaml, integrations/guardian-coverage-long-tail/runtime/provider_001.env, terraform/guardian-coverage-long-tail/provider_004.tfvars`
- Secret flow: `deploy/guardian-coverage-long-tail/provider_003.properties, integrations/guardian-coverage-long-tail/config/provider_002.yaml, integrations/guardian-coverage-long-tail/runtime/provider_001.env, terraform/guardian-coverage-long-tail/provider_004.tfvars`
...
| deploy/guardian-coverage-long-tail/provider_003.properties | live-config | 3 | Runtime configuration carrying environment or deployment settings for Provider 003. | yes | no | no | yes | yes | no |
...
| integrations/guardian-coverage-long-tail/config/provider_002.yaml | live-config | 3 | Runtime configuration carrying environment or deployment settings for Provider 002. | yes | no | no | yes | yes | no |
| integrations/guardian-coverage-long-tail/runtime/provider_001.env | live-config | 3 | Runtime configuration carrying environment or deployment settings for Provider 001. | yes | no | no | yes | yes | no |
...
| terraform/guardian-coverage-long-tail/provider_004.tfvars | live-config | 3 | Runtime configuration carrying environment or deployment settings for Provider 004. | yes | no | no | yes | yes | no |
...
| validation/generated-file-manifest.json | generated | 2620 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
| validation/generated-tree.txt | generated | 213 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
- Path: `integrations/guardian-coverage-long-tail/runtime/provider_001.env`
...
- Path: `integrations/guardian-coverage-long-tail/config/provider_002.yaml`
  Why it should be detected: scenario declares `rule-002` as a live positive surface.
  Target module: `Guardian`
  Finding family / rule family expectation: `guardian.aws-secret-key`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `deploy/guardian-coverage-long-tail/provider_003.properties`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `terraform/guardian-coverage-long-tail/provider_004.tfvars`
...
- Command: `C:\Python313\python.EXE scripts/validate_repo.py`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\guardian-coverage-long-tail\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\guardian-coverage-long-tail\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\guardian-coverage-long-tail\validation\runnability-logs\smoke-01.log`
...
```text
0001: # guardian-coverage-long-tail
0002: 
0003: Long-tail provider credential corpus covering the remaining active Guardian families needed for truthful coverage.
0004: 
...
### `deploy/guardian-coverage-long-tail/provider_003.properties`
...
0003: sk_live_AAAAAAAAAAAAAAAAAAAAAAAA
```

### `integrations/guardian-coverage-long-tail/config/provider_002.yaml`
...
```text
0001: # coverage campaign entry
0002: # rule_key: guardian.aws-secret-key
0003: aws_secret="ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789abcd"
```

### `integrations/guardian-coverage-long-tail/runtime/provider_001.env`
...
### `terraform/guardian-coverage-long-tail/provider_004.tfvars`
...
0003: secret_key = "abcdefghijklmnop"
```

## 12. Line Composition and Filler Disclosure

- Total LOC considered for authored/generated project content: `6009`
- Synthetic filler / inflation LOC: `5830`
- Synthetic filler ratio: `97.02%`
...
| synthetic filler / inflation content | 5830 |
...
- path: `integrations/guardian-coverage-long-tail/config/provider_002.yaml`
  module: `Guardian`
  expected rule/finding family: `guardian.aws-secret-key`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `deploy/guardian-coverage-long-tail/provider_003.properties`
  module: `Guardian`
