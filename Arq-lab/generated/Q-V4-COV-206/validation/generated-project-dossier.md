# Generated Project Dossier - Q-V4-COV-206

## 1. Scenario Identity

- scenarioId: `Q-V4-COV-206`
- scenarioName: Quantum precision coverage bundle exercising 17 python rule candidates within the 3-to-3.3 applicability slice.
- milestone: `M4`
- targetModule: `Quantum`
- language / stack: `Python / precision coverage pack`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-python-3-to-3-3-01`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/quantum-precision-python-3-to-3-3-01`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-python-3-to-3-3-01\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\Q-V4-COV-206\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\Q-V4-COV-206.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `python version-sliced precision coverage pack (3-to-3.3) wave 01` as a `Python / precision coverage pack` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Quantum precision coverage bundle exercising 17 python rule candidates within the 3-to-3.3 applicability slice.`.

## 3. Architecture Summary

- Major components: `.github, config, deploy, docs, ops, scripts, sql, tests, validation, vendor, workers`
- Runtime role: `python version-sliced precision coverage pack (3-to-3.3) wave 01`
...
- Crypto/TLS flow if relevant: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_001.py, workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_002.py, workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_003.py, workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_004.py, workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_005.py, workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_006.py, workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_007.py, workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_008.py, workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_009.py, workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_010.py, workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_011.py, workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_012.py, workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_013.py, workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_014.py, workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_015.py, workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_016.py, workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_017.py`
...
```text
quantum-precision-python-3-to-3-3-01
|-- .github
|   `-- workflows
|       `-- deploy.yml
|-- config
...
| validation/expected-findings.json | generated | 223 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
| validation/expected-report.md | generated | 8 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
| validation/generated-file-manifest.json | generated | 842 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
| validation/generated-project-dossier.md | generated | 815 | Machine-readable validation contract or generated audit artifact for this scenario. | no | no | yes | no | no | no |
...
| workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_001.py | live-code | 12 | Runtime business module contributing to Rule 001. | yes | yes | no | yes | yes | no |
| workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_002.py | live-code | 11 | Runtime business module contributing to Rule 002. | yes | yes | no | yes | yes | no |
| workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_003.py | live-code | 11 | Runtime business module contributing to Rule 003. | yes | yes | no | yes | yes | no |
| workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_004.py | live-code | 11 | Runtime business module contributing to Rule 004. | yes | yes | no | yes | yes | no |
| workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_005.py | live-code | 11 | Runtime business module contributing to Rule 005. | yes | yes | no | yes | yes | no |
| workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_006.py | live-code | 11 | Runtime business module contributing to Rule 006. | yes | yes | no | yes | yes | no |
| workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_007.py | live-code | 11 | Runtime business module contributing to Rule 007. | yes | yes | no | yes | yes | no |
| workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_008.py | live-code | 12 | Runtime business module contributing to Rule 008. | yes | yes | no | yes | yes | no |
| workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_009.py | live-code | 12 | Runtime business module contributing to Rule 009. | yes | yes | no | yes | yes | no |
| workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_010.py | live-code | 11 | Runtime business module contributing to Rule 010. | yes | yes | no | yes | yes | no |
| workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_011.py | live-code | 10 | Runtime business module contributing to Rule 011. | yes | no | no | yes | yes | no |
| workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_012.py | live-code | 12 | Runtime business module contributing to Rule 012. | yes | yes | no | yes | yes | no |
| workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_013.py | live-code | 11 | Runtime business module contributing to Rule 013. | yes | yes | no | yes | yes | no |
| workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_014.py | live-code | 11 | Runtime business module contributing to Rule 014. | yes | yes | no | yes | yes | no |
| workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_015.py | live-code | 11 | Runtime business module contributing to Rule 015. | yes | no | no | yes | yes | no |
| workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_016.py | live-code | 10 | Runtime business module contributing to Rule 016. | yes | no | no | yes | yes | no |
| workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_017.py | live-code | 11 | Runtime business module contributing to Rule 017. | yes | yes | no | yes | yes | no |

## 6. Positive Surfaces

- Path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_001.py`
  Why it should be detected: scenario declares `rule-001` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0268-python`
...
- Path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_002.py`
  Why it should be detected: scenario declares `rule-002` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0269-python`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_003.py`
  Why it should be detected: scenario declares `rule-003` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0270-python`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_004.py`
  Why it should be detected: scenario declares `rule-004` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0271-python`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_005.py`
  Why it should be detected: scenario declares `rule-005` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0273-python`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_006.py`
  Why it should be detected: scenario declares `rule-006` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0274-python`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_007.py`
  Why it should be detected: scenario declares `rule-007` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0275-python`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_008.py`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_009.py`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_010.py`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_011.py`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_012.py`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_013.py`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_014.py`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_015.py`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_016.py`
  ...
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.
- Path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_017.py`
  Why it should be detected: scenario declares `rule-017` as a live positive surface.
  Target module: `Quantum`
  Finding family / rule family expectation: `quantum.arq-q-0388-python`
  Head/history behavior: `head-only`
  Explainability expectation: No strict scenario-specific explainability contract beyond normal detail capture.

## 7. Near-Real Negative Surfaces

- `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_001.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_002.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_003.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_004.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_005.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_006.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_007.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_008.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_009.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_010.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_012.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_013.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_014.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
- `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_017.py`: Path is intentionally near-real but is expected to stay clean because it is placeholder, example, masked, or otherwise non-live.
...
- Command: `C:\Python313\python.EXE scripts/validate_repo.py`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-python-3-to-3-3-01\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-python-3-to-3-3-01\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-python-3-to-3-3-01\validation\runnability-logs\smoke-01.log`
...
```text
0001: # quantum-precision-python-3-to-3-3-01
0002: 
0003: python version-sliced precision coverage pack (3-to-3.3) wave 01
0004: 
...
### `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_001.py`
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0268-python
0005:     # evidence_anchor: ssl.CERT_NONE
```

### `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_002.py`
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0269-python
0005:     # evidence_anchor: ssl._create_unverified_context
0006:     # regex_sample: ssl._create_unverified_context        (
0007:     # keywords: ssl._create_unverified_context | _create_unverified_context
0008:     ssl._create_unverified_context()
0009: 
```

### `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_003.py`
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0270-python
0005:     # evidence_anchor: ssl.SSLContext, ssl.PROTOCOL_SSLv3, ssl.PROTOCOL_TLSv1
```

### `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_004.py`
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0271-python
...
### `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_005.py`
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0273-python
0005:     # evidence_anchor: AES.MODE_ECB
```

### `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_006.py`
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0274-python
0005:     # evidence_anchor: DES.new, DES3.new
```

### `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_007.py`
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0275-python
0005:     # evidence_anchor: ARC4.new
```

### `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_008.py`
...
### `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_009.py`
...
### `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_010.py`
...
### `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_011.py`
...
### `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_012.py`
...
### `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_013.py`
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0376-python
0005:     # evidence_anchor: OpenSSL.SSL.VERIFY_NONE, Context.set_verify
```

### `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_014.py`
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0389-python
0005:     # evidence_anchor: rsa.newkeys, key size literal
```

### `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_015.py`
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0280-python
0005:     # evidence_anchor: import ssl
```

### `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_016.py`
...
```text
0002: def execute():
0003:     # rule_key: quantum.arq-q-0281-python
0004:     # evidence_anchor: from Crypto.Cipher, from Crypto.Hash
```

### `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_017.py`
...
```text
0003: def execute():
0004:     # rule_key: quantum.arq-q-0388-python
0005:     # evidence_anchor: import rsa, rsa.encrypt, rsa.sign, rsa.newkeys
```

## 12. Line Composition and Filler Disclosure

- Total LOC considered for authored/generated project content: `1189`
- Synthetic filler / inflation LOC: `660`
- Synthetic filler ratio: `55.51%`

| category | LOC |
| --- | ---: |
| live business code | 189 |
| live config | 11 |
| tests | 3 |
| docs | 16 |
| scripts | 2 |
...
- path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_001.py`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0268-python`
...
- path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_002.py`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0269-python`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_003.py`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0270-python`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_004.py`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0271-python`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_005.py`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0273-python`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_006.py`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0274-python`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_007.py`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0275-python`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
- path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_008.py`
  module: `Quantum`
...
- path: `workers/quantum-precision-python-3-to-3-3-01/app/legacy/rule_017.py`
  module: `Quantum`
  expected rule/finding family: `quantum.arq-q-0388-python`
  expected branch/ref behavior: `head-only`
  expected explainability behavior: No strict scenario-specific explainability contract beyond normal detail capture.
