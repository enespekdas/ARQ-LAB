# Generated Project Dossier - Q-V3-COV-229

## 1. Scenario Identity

- scenarioId: `Q-V3-COV-229`
- scenarioName: Quantum precision coverage bundle exercising 2 kotlin rule candidates within the 1-to-2.1 applicability slice.
- milestone: `M3`
- targetModule: `Quantum`
- language / stack: `JVM language precision coverage pack`
- repoType: `snapshot`
- repo local path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-kotlin-1-to-2-1-02`
- repo remote provider: `github`
- repo remote URL: `https://github.com/ARQ-Sec/quantum-precision-kotlin-1-to-2-1-02`
- default branch: `main`
- scan modes intended for this scenario: `HEAD_SNAPSHOT`
- branch scopes intended for this scenario: `SINGLE_BRANCH`
- project-local dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-kotlin-1-to-2-1-02\validation\generated-project-dossier.md`
- required alias dossier path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\generated\Q-V3-COV-229\validation\generated-project-dossier.md`
- central dossier report path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\reports\generated-project-dossiers\Q-V3-COV-229.md`

## 2. Business Context and Why This Repo Is Realistic

This scenario models `kotlin version-sliced precision coverage pack (1-to-2.1) wave 02` as a `JVM language precision coverage pack` repository. The repo is shaped to look like something an enterprise team would actually maintain so that ARQ validation is exercised against realistic layout, runtime config, supporting docs, and test collateral rather than an isolated toy snippet.

A real customer could plausibly own this repository because it bundles the operational surfaces that usually travel with the business function: runtime code, deploy/config material, tests, scripts, and enough written collateral to resemble an actively maintained internal service or support repository. The scenario goal is `Quantum precision coverage bundle exercising 2 kotlin rule candidates within the 1-to-2.1 applicability slice.`.

## 3. Architecture Summary

- Major components: `.github, config, deploy, docs, native, ops, scripts, services, sql, tests, validation, vendor`
- Runtime role: `kotlin version-sliced precision coverage pack (1-to-2.1) wave 02`
...
- Crypto/TLS flow if relevant: `native/quantum-precision-kotlin-1-to-2-1-02/kotlin/rule_002.kt, services/quantum-precision-kotlin-1-to-2-1-02/module-001/build.gradle.kts`
...
```text
quantum-precision-kotlin-1-to-2-1-02
|-- .github
|   `-- workflows
|       `-- deploy.yml
|-- config
...
| native/quantum-precision-kotlin-1-to-2-1-02/kotlin/rule_002.kt | live-code | 14 | Runtime business module contributing to Rule 002. | yes | no | no | yes | yes | no |
...
| services/quantum-precision-kotlin-1-to-2-1-02/module-001/build.gradle.kts | generated | 4 | Generated or derived project artifact related to Build.Gradle. | yes | no | yes | no | no | no |
...
- Path: `services/quantum-precision-kotlin-1-to-2-1-02/module-001/build.gradle.kts`
...
- Path: `native/quantum-precision-kotlin-1-to-2-1-02/kotlin/rule_002.kt`
...
| services/quantum-precision-kotlin-1-to-2-1-02/module-001/build.gradle.kts | generated | Path lives in a protected negative zone and should stay clean even if the content looks suspicious. |
...
- Command: `C:\Python313\python.EXE scripts/validate_repo.py`
  ...
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-kotlin-1-to-2-1-02\validation\runnability-logs\build-01.log`
...
- Command: `C:\Python313\python.EXE -m pytest -q`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-kotlin-1-to-2-1-02\validation\runnability-logs\test-01.log`
...
- Command: `C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File scripts/smoke.ps1`
  ...
  Actual result: returncode=`0`; stage state=`passed`
  Log file: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\quantum-precision-kotlin-1-to-2-1-02\validation\runnability-logs\smoke-01.log`
...
```text
0001: # quantum-precision-kotlin-1-to-2-1-02
0002: 
0003: kotlin version-sliced precision coverage pack (1-to-2.1) wave 02
0004: 
...
### `native/quantum-precision-kotlin-1-to-2-1-02/kotlin/rule_002.kt`
...
### `services/quantum-precision-kotlin-1-to-2-1-02/module-001/build.gradle.kts`
...
- Total LOC considered for authored/generated project content: `1051`
- Synthetic filler / inflation LOC: `880`
- Synthetic filler ratio: `83.73%`
...
- What this scenario is proving: `Quantum precision coverage bundle exercising 2 kotlin rule candidates within the 1-to-2.1 applicability slice.`
