...
- Persisted logs path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\notification-signer-python\validation\runnability-logs`
...
- refStateFailures: `0`
- noiseCount: `9`
- noiseBreakdown: `sameSurfaceExtraFindings=9, unexpectedRegexOnlyFindings=9`
- finalVerdict: `PASS_WITH_NOISE`
- finalVerdictReason: 9 unexpected/noisy finding(s) remained after matching (same-surface-extra=9, regex-only=9)
