...
- unexpectedFindings: `17`
- sameSurfaceExtraFindings: `0`
- sameFileDifferentSignalFindings: `17`
- unexpectedRegexOnlyFindings: `6`
- mayFindReview: `0`
- explainabilityFailures: `0`
- refStateFailures: `0`
- noiseCount: `17`
- noiseBreakdown: `sameFileDifferentSignalFindings=17, unexpectedRegexOnlyFindings=6`
- finalVerdict: `FAIL_FN`
- finalVerdictReason: 25 expected finding(s) were not detected at all; 17 unexpected/noisy finding(s) remained after matching (same-file-different-signal=17, regex-only=6)
