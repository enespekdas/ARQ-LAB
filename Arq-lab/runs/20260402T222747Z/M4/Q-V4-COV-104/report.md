...
- unexpectedRegexOnlyFindings: `18`
- mayFindReview: `0`
- explainabilityFailures: `0`
- refStateFailures: `0`
- noiseCount: `19`
- noiseBreakdown: `sameFileDifferentSignalFindings=19, unexpectedRegexOnlyFindings=18`
- finalVerdict: `FAIL_FN`
- finalVerdictReason: 29 expected finding(s) were not detected at all; 19 unexpected/noisy finding(s) remained after matching (same-file-different-signal=19, regex-only=18)
