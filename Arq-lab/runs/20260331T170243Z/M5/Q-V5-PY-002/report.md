...
- Persisted logs path: `C:\Users\EnesPekdas\Desktop\ARQV2\LAB\Arq-lab\repositories\data-sync-python\validation\runnability-logs`
...
- refStateFailures: `0`
- noiseCount: `6`
- noiseBreakdown: `sameSurfaceExtraFindings=6, unexpectedRegexOnlyFindings=1`
- finalVerdict: `PASS_WITH_NOISE`
- finalVerdictReason: 6 unexpected/noisy finding(s) remained after matching (same-surface-extra=6, regex-only=1)
