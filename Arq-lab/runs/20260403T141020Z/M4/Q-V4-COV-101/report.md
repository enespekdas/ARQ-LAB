...
- unexpectedFindings: `81`
- sameSurfaceExtraFindings: `0`
- sameFileDifferentSignalFindings: `81`
- unexpectedRegexOnlyFindings: `67`
- mayFindReview: `0`
- explainabilityFailures: `0`
- refStateFailures: `0`
- noiseCount: `81`
- noiseBreakdown: `sameFileDifferentSignalFindings=81, unexpectedRegexOnlyFindings=67`
- finalVerdict: `FAIL_FN`
- finalVerdictReason: 11 expected finding(s) were not detected at all; 81 unexpected/noisy finding(s) remained after matching (same-file-different-signal=81, regex-only=67)

## Normalization
- rawFindings: `90`
- normalizedFindings: `90`
