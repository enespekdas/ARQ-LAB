...
- unexpectedFindings: `155`
- sameSurfaceExtraFindings: `0`
- sameFileDifferentSignalFindings: `155`
- unexpectedRegexOnlyFindings: `138`
- mayFindReview: `0`
- explainabilityFailures: `0`
- refStateFailures: `0`
- noiseCount: `155`
- noiseBreakdown: `sameFileDifferentSignalFindings=155, unexpectedRegexOnlyFindings=138`
- finalVerdict: `FAIL_FN`
- finalVerdictReason: 29 expected finding(s) were not detected at all; 155 unexpected/noisy finding(s) remained after matching (same-file-different-signal=155, regex-only=138)
